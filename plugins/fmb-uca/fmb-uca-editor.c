...
static const gchar   *fmb_uca_editor_get_icon_name   (const FmbUcaEditor  *uca_editor);
static void           fmb_uca_editor_set_icon_name   (FmbUcaEditor        *uca_editor,
                                                         const gchar            *icon_name);
static FmbUcaTypes fmb_uca_editor_get_types       (const FmbUcaEditor  *uca_editor);
static void           fmb_uca_editor_set_types       (FmbUcaEditor        *uca_editor,
                                                         FmbUcaTypes          types);
static void           fmb_uca_editor_command_clicked (FmbUcaEditor        *uca_editor);
static void           fmb_uca_editor_icon_clicked    (FmbUcaEditor        *uca_editor);



struct _FmbUcaEditorClass
{
  GtkDialogClass __parent__;
};

struct _FmbUcaEditor
{
...
FMBX_DEFINE_TYPE (FmbUcaEditor, fmb_uca_editor, GTK_TYPE_DIALOG);



static void
fmb_uca_editor_class_init (FmbUcaEditorClass *klass)
{
}
...
static void
fmb_uca_editor_init (FmbUcaEditor *uca_editor)
{
  ...
  g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (fmb_uca_editor_command_clicked), uca_editor);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_editor->icon_button), "clicked", G_CALLBACK (fmb_uca_editor_icon_clicked), uca_editor);
...
static void
fmb_uca_editor_command_clicked (FmbUcaEditor *uca_editor)
{
  ...
  g_return_if_fail (FMB_UCA_IS_EDITOR (uca_editor));
...
static void
fmb_uca_editor_icon_clicked (FmbUcaEditor *uca_editor)
{
  const gchar *name;
  GtkWidget   *chooser;
  gchar       *title;
  ...
  chooser = blxo_icon_chooser_dialog_new (title, GTK_WINDOW (uca_editor),
                                         GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL,
  ...
  icon = g_object_get_data (G_OBJECT (uca_editor->icon_button), "fmb-uca-icon-name");
  if (G_LIKELY (icon != NULL && *icon != '\0'))
    blxo_icon_chooser_dialog_set_icon (BLXO_ICON_CHOOSER_DIALOG (chooser), icon);
  ...
  if (gtk_dialog_run (GTK_DIALOG (chooser)) == GTK_RESPONSE_ACCEPT)
    {
      ...
      fmb_uca_editor_set_icon_name (uca_editor, icon);
      g_free (icon);
    }
...
static const gchar*
fmb_uca_editor_get_icon_name (const FmbUcaEditor *uca_editor)
{
  g_return_val_if_fail (FMB_UCA_IS_EDITOR (uca_editor), NULL);
  return g_object_get_data (G_OBJECT (uca_editor->icon_button), "fmb-uca-icon-name");
}



static void
fmb_uca_editor_set_icon_name (FmbUcaEditor *uca_editor,
                                 const gchar     *icon_name)
{
  GIcon     *icon = NULL;
  GtkWidget *image;
  ...
  if (G_LIKELY (icon != NULL))
    {
      ...
      g_object_set_data_full (G_OBJECT (uca_editor->icon_button), "fmb-uca-icon-name", g_strdup (icon_name), g_free);
  ...
  else
    {
      ...
      g_object_set_data (G_OBJECT (uca_editor->icon_button), "fmb-uca-icon-name", NULL);
...
static void
fmb_uca_editor_set_types (FmbUcaEditor *uca_editor,
                             FmbUcaTypes   types)
{
  g_return_if_fail (FMB_UCA_IS_EDITOR (uca_editor));

  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->directories_button), (types & FMB_UCA_TYPE_DIRECTORIES));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->audio_files_button), (types & FMB_UCA_TYPE_AUDIO_FILES));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->image_files_button), (types & FMB_UCA_TYPE_IMAGE_FILES));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->text_files_button),  (types & FMB_UCA_TYPE_TEXT_FILES));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->video_files_button), (types & FMB_UCA_TYPE_VIDEO_FILES));
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (uca_editor->other_files_button), (types & FMB_UCA_TYPE_OTHER_FILES));
}
 ...
 **/
void
fmb_uca_editor_load (FmbUcaEditor *uca_editor,
                        ...
                        GtkTreeIter     *iter)
{
  ...
  gtk_tree_model_get (GTK_TREE_MODEL (uca_model), iter,
                      FMB_UCA_MODEL_COLUMN_DESCRIPTION, &description,
                      FMB_UCA_MODEL_COLUMN_PATTERNS, &patterns,
                      FMB_UCA_MODEL_COLUMN_COMMAND, &command,
                      FMB_UCA_MODEL_COLUMN_TYPES, &types,
                      FMB_UCA_MODEL_COLUMN_ICON_NAME, &icon_name,
                      FMB_UCA_MODEL_COLUMN_NAME, &name,
                      FMB_UCA_MODEL_COLUMN_STARTUP_NOTIFY, &startup_notify,
                      -1);

  /* setup the new selection */
  fmb_uca_editor_set_types (uca_editor, types);

  /* setup the new icon */
  fmb_uca_editor_set_icon_name (uca_editor, icon_name);
 ...
 **/
void
fmb_uca_editor_save (FmbUcaEditor *uca_editor,
                        FmbUcaModel  *uca_model,
                        GtkTreeIter     *iter)
{
  g_return_if_fail (FMB_UCA_IS_EDITOR (uca_editor));
  ...
  fmb_uca_model_update (uca_model, iter,
                           ...
                           fmb_uca_editor_get_icon_name (uca_editor),
                           ...
                           fmb_uca_editor_get_types (uca_editor));
}
