...
static gboolean fmb_uca_chooser_key_press_event    (GtkWidget              *widget,
                                                       GdkEventKey            *event);
static void     fmb_uca_chooser_response           (GtkDialog              *dialog,
                                                       gint                    response);
static void     fmb_uca_chooser_exchange           (FmbUcaChooser       *uca_chooser,
                                                       GtkTreeSelection       *selection,
                                                       GtkTreeModel           *model,
                                                       GtkTreeIter            *iter_a,
                                                       GtkTreeIter            *iter_b);
static void     fmb_uca_chooser_open_editor        (FmbUcaChooser       *uca_chooser,
                                                       gboolean                edit);
static void     fmb_uca_chooser_save               (FmbUcaChooser       *uca_chooser,
                                                       FmbUcaModel         *uca_model);
static void     fmb_uca_chooser_selection_changed  (FmbUcaChooser       *uca_chooser,
                                                       GtkTreeSelection       *selection);
static void     fmb_uca_chooser_add_clicked        (FmbUcaChooser       *uca_chooser);
static void     fmb_uca_chooser_edit_clicked       (FmbUcaChooser       *uca_chooser);
static void     fmb_uca_chooser_delete_clicked     (FmbUcaChooser       *uca_chooser);
static void     fmb_uca_chooser_up_clicked         (FmbUcaChooser       *uca_chooser);
static void     fmb_uca_chooser_down_clicked       (FmbUcaChooser       *uca_chooser);



struct _FmbUcaChooserClass
{
  GtkDialogClass __parent__;
};

struct _FmbUcaChooser
{
...
FMBX_DEFINE_TYPE (FmbUcaChooser, fmb_uca_chooser, GTK_TYPE_DIALOG);



static void
fmb_uca_chooser_class_init (FmbUcaChooserClass *klass)
{
  GtkDialogClass *gtkdialog_class;
  GtkWidgetClass *gtkwidget_class;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->key_press_event = fmb_uca_chooser_key_press_event;

  gtkdialog_class = GTK_DIALOG_CLASS (klass);
  gtkdialog_class->response = fmb_uca_chooser_response;
}



static void
fmb_uca_chooser_init (FmbUcaChooser *uca_chooser)
{
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->treeview), "row-activated", G_CALLBACK (fmb_uca_chooser_edit_clicked), uca_chooser);
  gtk_widget_show (uca_chooser->treeview);

  uca_model = fmb_uca_model_get_default ();
  ...
  gtk_tree_view_column_set_attributes (column, renderer, "gicon", FMB_UCA_MODEL_COLUMN_GICON, NULL);

  renderer = gtk_cell_renderer_text_new ();
  gtk_tree_view_column_pack_start (column, renderer, TRUE);
  gtk_tree_view_column_set_attributes (column, renderer, "markup", FMB_UCA_MODEL_COLUMN_STOCK_LABEL, NULL);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->add_button), "clicked", G_CALLBACK (fmb_uca_chooser_add_clicked), uca_chooser);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->edit_button), "clicked", G_CALLBACK (fmb_uca_chooser_edit_clicked), uca_chooser);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->delete_button), "clicked", G_CALLBACK (fmb_uca_chooser_delete_clicked), uca_chooser);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->up_button), "clicked", G_CALLBACK (fmb_uca_chooser_up_clicked), uca_chooser);
  ...
  g_signal_connect_swapped (G_OBJECT (uca_chooser->down_button), "clicked", G_CALLBACK (fmb_uca_chooser_down_clicked), uca_chooser);
  ...
  g_signal_connect_swapped (G_OBJECT (selection), "changed", G_CALLBACK (fmb_uca_chooser_selection_changed), uca_chooser);
  fmb_uca_chooser_selection_changed (uca_chooser, selection);
}



static gboolean
fmb_uca_chooser_key_press_event (GtkWidget   *widget,
                                    GdkEventKey *event)
{
  ...
  return (*GTK_WIDGET_CLASS (fmb_uca_chooser_parent_class)->key_press_event) (widget, event);
}



static void
fmb_uca_chooser_response (GtkDialog *dialog,
                             gint       response)
{
  ...
  else if (GTK_DIALOG_CLASS (fmb_uca_chooser_parent_class)->response != NULL)
    {
      (*GTK_DIALOG_CLASS (fmb_uca_chooser_parent_class)->response) (dialog, response);
    }
}
...
static void
fmb_uca_chooser_selection_changed (FmbUcaChooser *uca_chooser,
                                      GtkTreeSelection *selection)
{
  GtkTreeModel *model;
  ...
  g_return_if_fail (FMB_UCA_IS_CHOOSER (uca_chooser));
...
static void
fmb_uca_chooser_exchange (FmbUcaChooser *uca_chooser,
                             GtkTreeSelection *selection,
                             GtkTreeModel     *model,
                             GtkTreeIter      *iter_a,
                             GtkTreeIter      *iter_b)
{
  ...
  /* perform the move */
  fmb_uca_model_exchange (FMB_UCA_MODEL (model), iter_a, iter_b);

  /* tell the chooser that the selection may have changed */
  fmb_uca_chooser_selection_changed (uca_chooser, selection);

  /* sync the model to persistent storage */
  fmb_uca_chooser_save (uca_chooser, FMB_UCA_MODEL (model));
}



static void
fmb_uca_chooser_open_editor (FmbUcaChooser *uca_chooser,
                                gboolean          edit)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  ...
  editor = g_object_new (FMB_UCA_TYPE_EDITOR, NULL);
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter) && edit)
    fmb_uca_editor_load (FMB_UCA_EDITOR (editor), FMB_UCA_MODEL (model), &iter);
  ...
  if (gtk_dialog_run (GTK_DIALOG (editor)) == GTK_RESPONSE_OK)
    {
      ...
      if (G_UNLIKELY (!edit))
        fmb_uca_model_append (FMB_UCA_MODEL (model), &iter);

      /* save the editor values to the model */
      fmb_uca_editor_save (FMB_UCA_EDITOR (editor), FMB_UCA_MODEL (model), &iter);
...
static void
fmb_uca_chooser_save (FmbUcaChooser *uca_chooser,
                         FmbUcaModel   *uca_model)
{
  GtkWidget *dialog;
  GError    *error = NULL;
  ...
  /* sync the model to persistent storage */
  if (!fmb_uca_model_save (uca_model, &error))
    {
...
static void
fmb_uca_chooser_add_clicked (FmbUcaChooser *uca_chooser)
{
  g_return_if_fail (FMB_UCA_IS_CHOOSER (uca_chooser));
  fmb_uca_chooser_open_editor (uca_chooser, FALSE);
}



static void
fmb_uca_chooser_edit_clicked (FmbUcaChooser *uca_chooser)
{
  g_return_if_fail (FMB_UCA_IS_CHOOSER (uca_chooser));
  fmb_uca_chooser_open_editor (uca_chooser, TRUE);
}



static void
fmb_uca_chooser_delete_clicked (FmbUcaChooser *uca_chooser)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      gtk_tree_model_get (model, &iter, FMB_UCA_MODEL_COLUMN_NAME, &name, -1);
      dialog = gtk_message_dialog_new (GTK_WINDOW (uca_chooser),
                                       GTK_DIALOG_DESTROY_WITH_PARENT
                                       | GTK_DIALOG_MODAL,
      ...
      if (response == GTK_RESPONSE_YES)
        {
          ...
          fmb_uca_model_remove (FMB_UCA_MODEL (model), &iter);
...
static void
fmb_uca_chooser_up_clicked (FmbUcaChooser *uca_chooser)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreePath      *path;
      ...
      if (gtk_tree_path_prev (path))
        {
          ...
          fmb_uca_chooser_exchange (uca_chooser, selection, model, &iter_a, &iter_b);
        }
...
static void
fmb_uca_chooser_down_clicked (FmbUcaChooser *uca_chooser)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter_a;
