...
static void     fmb_apr_desktop_page_finalize        (GObject                    *object);
static void     fmb_apr_desktop_page_file_changed    (FmbAprAbstractPage      *abstract_page,
                                                         FmbxFileInfo            *file);
static void     fmb_apr_desktop_page_save            (FmbAprDesktopPage       *desktop_page,
                                                         GtkWidget                  *widget);
static void     fmb_apr_desktop_page_save_widget     (FmbAprDesktopPage       *desktop_page,
                                                         GtkWidget                  *widget,
                                                         GKeyFile                   *key_file);
static void     fmb_apr_desktop_page_activated       (GtkWidget                  *entry,
                                                         FmbAprDesktopPage       *desktop_page);
static gboolean fmb_apr_desktop_page_focus_out_event (GtkWidget                  *entry,
                                                         GdkEventFocus              *event,
                                                         FmbAprDesktopPage       *desktop_page);
static void     fmb_apr_desktop_page_toggled         (GtkWidget                  *button,
                                                         FmbAprDesktopPage       *desktop_page);



struct _FmbAprDesktopPageClass
{
  FmbAprAbstractPageClass __parent__;
};

struct _FmbAprDesktopPage
{
  FmbAprAbstractPage __parent__;
...
FMBX_DEFINE_TYPE (FmbAprDesktopPage,
                     fmb_apr_desktop_page,
                     FMB_APR_TYPE_ABSTRACT_PAGE);



static void
fmb_apr_desktop_page_class_init (FmbAprDesktopPageClass *klass)
{
  FmbAprAbstractPageClass *fmbapr_abstract_page_class;
  GObjectClass               *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = fmb_apr_desktop_page_finalize;

  fmbapr_abstract_page_class = FMB_APR_ABSTRACT_PAGE_CLASS (klass);
  fmbapr_abstract_page_class->file_changed = fmb_apr_desktop_page_file_changed;
}
...
static void
fmb_apr_desktop_page_init (FmbAprDesktopPage *desktop_page)
{
  ...
  gtk_widget_set_tooltip_text (desktop_page->description_entry, _("The generic name of the entry, for example \"Web Browser\" "
                                                                  "in case of Firefox."));
  g_signal_connect (G_OBJECT (desktop_page->description_entry), "activate", G_CALLBACK (fmb_apr_desktop_page_activated), desktop_page);
  g_signal_connect (G_OBJECT (desktop_page->description_entry), "focus-out-event", G_CALLBACK (fmb_apr_desktop_page_focus_out_event), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->description_entry), "visible", G_OBJECT (label), "visible");
  ...
  g_signal_connect (G_OBJECT (desktop_page->command_entry), "activate", G_CALLBACK (fmb_apr_desktop_page_activated), desktop_page);
  g_signal_connect (G_OBJECT (desktop_page->command_entry), "focus-out-event", G_CALLBACK (fmb_apr_desktop_page_focus_out_event), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->command_entry), "visible", G_OBJECT (label), "visible");
  ...
  g_signal_connect (G_OBJECT (desktop_page->path_entry), "activate", G_CALLBACK (fmb_apr_desktop_page_activated), desktop_page);
  g_signal_connect (G_OBJECT (desktop_page->path_entry), "focus-out-event", G_CALLBACK (fmb_apr_desktop_page_focus_out_event), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->path_entry), "visible", G_OBJECT (label), "visible");
  ...
  g_signal_connect (G_OBJECT (desktop_page->url_entry), "activate", G_CALLBACK (fmb_apr_desktop_page_activated), desktop_page);
  g_signal_connect (G_OBJECT (desktop_page->url_entry), "focus-out-event", G_CALLBACK (fmb_apr_desktop_page_focus_out_event), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->url_entry), "visible", G_OBJECT (label), "visible");
  ...
  gtk_widget_set_tooltip_text (desktop_page->comment_entry, _("Tooltip for the entry, for example \"View sites on the Internet\" "
                                                              ...
                                                              "description."));
  g_signal_connect (G_OBJECT (desktop_page->comment_entry), "activate", G_CALLBACK (fmb_apr_desktop_page_activated), desktop_page);
  g_signal_connect (G_OBJECT (desktop_page->comment_entry), "focus-out-event", G_CALLBACK (fmb_apr_desktop_page_focus_out_event), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->comment_entry), "visible", G_OBJECT (label), "visible");
  ...
  g_signal_connect (G_OBJECT (desktop_page->snotify_button), "toggled", G_CALLBACK (fmb_apr_desktop_page_toggled), desktop_page);
  ...
  g_signal_connect (G_OBJECT (desktop_page->terminal_button), "toggled", G_CALLBACK (fmb_apr_desktop_page_toggled), desktop_page);
  ...
  blxo_binding_new (G_OBJECT (desktop_page->snotify_button), "visible", G_OBJECT (label), "visible");
...
static void
fmb_apr_desktop_page_finalize (GObject *object)
{
  FmbAprDesktopPage *desktop_page = FMB_APR_DESKTOP_PAGE (object);
  ...
  (*G_OBJECT_CLASS (fmb_apr_desktop_page_parent_class)->finalize) (object);
}



static void
fmb_apr_desktop_page_file_changed (FmbAprAbstractPage *abstract_page,
                                      FmbxFileInfo       *file)
{
  FmbAprDesktopPage *desktop_page = FMB_APR_DESKTOP_PAGE (abstract_page);
  GKeyFile             *key_file;
  gboolean              writable;
  gboolean              enabled;
  GError               *error = NULL;
  ...
  if (filename != NULL && g_key_file_load_from_file (key_file, filename, G_KEY_FILE_NONE, NULL))
    {
      ...
      if (strcmp (type, "Application") == 0)
        fmbx_property_page_set_label (FMBX_PROPERTY_PAGE (desktop_page), _("Launcher"));
      else if (strcmp (type, "Link") == 0)
        fmbx_property_page_set_label (FMBX_PROPERTY_PAGE (desktop_page), _("Link"));
      else
        fmbx_property_page_set_label (FMBX_PROPERTY_PAGE (desktop_page), type);

      /* update the "Description" entry */
      value = g_key_file_get_locale_string (key_file, G_KEY_FILE_DESKTOP_GROUP, "GenericName", NULL, NULL);
      if (!blxo_str_is_equal (value, desktop_page->description_text))
        {
          /* update the entry */
      ...
      if (!blxo_str_is_equal (value, desktop_page->comment_text))
        {
          /* update the entry */
      ...
      if (strcmp (type, "Application") == 0)
        {
          ...
          if (!blxo_str_is_equal (value, desktop_page->command_text))
            {
              /* update the entry */
          ...
          if (!blxo_str_is_equal (value, desktop_page->path_text))
            {
              /* update the entry */
          ...
          g_signal_handlers_block_by_func (G_OBJECT (desktop_page->snotify_button), fmb_apr_desktop_page_toggled, desktop_page);
          gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (desktop_page->snotify_button), (error == NULL && enabled));
          g_signal_handlers_unblock_by_func (G_OBJECT (desktop_page->snotify_button), fmb_apr_desktop_page_toggled, desktop_page);
          g_clear_error (&error);

          /* update the "Run in terminal" button */
          enabled = g_key_file_get_boolean (key_file, G_KEY_FILE_DESKTOP_GROUP, "Terminal", &error);
          g_signal_handlers_block_by_func (G_OBJECT (desktop_page->terminal_button), fmb_apr_desktop_page_toggled, desktop_page);
          gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (desktop_page->terminal_button), (error == NULL && enabled));
          g_signal_handlers_unblock_by_func (G_OBJECT (desktop_page->terminal_button), fmb_apr_desktop_page_toggled, desktop_page);
          g_clear_error (&error);
      ...
      else if (strcmp (type, "Link") == 0)
        {
          ...
          if (!blxo_str_is_equal (value, desktop_page->url_text))
            {
              /* update the entry */
    ...
    {
      /* reset page title */
      fmbx_property_page_set_label (FMBX_PROPERTY_PAGE (desktop_page), _("Unknown"));
...
static void
fmb_apr_desktop_page_save (FmbAprDesktopPage *desktop_page,
                              GtkWidget            *widget)
{
  GtkWidget *toplevel;
  GtkWidget *message;
  ...
  if (FMB_APR_ABSTRACT_PAGE (desktop_page)->file == NULL)
    return;

  /* determine the local path to the file */
  uri = fmbx_file_info_get_uri (FMB_APR_ABSTRACT_PAGE (desktop_page)->file);
  filename = g_filename_from_uri (uri, NULL, NULL);
  g_free (uri);
  ...
  if (g_key_file_load_from_file (key_file, filename, G_KEY_FILE_KEEP_COMMENTS | G_KEY_FILE_KEEP_TRANSLATIONS, &error))
    {
      ...
      fmb_apr_desktop_page_save_widget (desktop_page, widget, key_file);
...
static void
fmb_apr_desktop_page_set_string (GKeyFile    *key_file,
                                    const gchar *key,
                                    const gchar *value)
{
...
static void
fmb_apr_desktop_page_save_widget (FmbAprDesktopPage *desktop_page,
                                     GtkWidget            *widget,
                                     GKeyFile             *key_file)
{
  ...
  if (widget == desktop_page->description_entry)
    {
      ...
      for (locale = g_get_language_names (); *locale != NULL; ++locale)
        {
          ...
          if (g_key_file_has_key (key_file, G_KEY_FILE_DESKTOP_GROUP, key, NULL))
            {
              fmb_apr_desktop_page_set_string (key_file, key, desktop_page->description_text);
              g_free (key);
              break;
            }
          g_free (key);
      ...
      if (G_UNLIKELY (*locale == NULL))
        {
          fmb_apr_desktop_page_set_string (key_file,
      ...
      for (locale = g_get_language_names (); *locale != NULL; ++locale)
        {
          ...
          if (g_key_file_has_key (key_file, G_KEY_FILE_DESKTOP_GROUP, key, NULL))
            {
              fmb_apr_desktop_page_set_string (key_file, key, desktop_page->comment_text);
              g_free (key);
              break;
            }
          g_free (key);
...
static void
fmb_apr_desktop_page_activated (GtkWidget            *entry,
                                   FmbAprDesktopPage *desktop_page)
{
  g_return_if_fail (GTK_IS_ENTRY (entry));
  g_return_if_fail (FMB_APR_IS_DESKTOP_PAGE (desktop_page));

  /* check if the entry is editable, and if so, save the file */
  if (gtk_editable_get_editable (GTK_EDITABLE (entry)))
    fmb_apr_desktop_page_save (desktop_page, entry);
}



static gboolean
fmb_apr_desktop_page_focus_out_event (GtkWidget            *entry,
                                         GdkEventFocus        *event,
                                         FmbAprDesktopPage *desktop_page)
{
  g_return_val_if_fail (GTK_IS_ENTRY (entry), FALSE);
  g_return_val_if_fail (FMB_APR_IS_DESKTOP_PAGE (desktop_page), FALSE);
...
static void
fmb_apr_desktop_page_toggled (GtkWidget            *button,
                                 FmbAprDesktopPage *desktop_page)
{
  ...
  /* save the file */
  fmb_apr_desktop_page_save (desktop_page, button);
}
