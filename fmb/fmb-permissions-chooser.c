...
enum
{
  FMB_PERMISSIONS_STORE_COLUMN_NAME,
  FMB_PERMISSIONS_STORE_COLUMN_GID,
  FMB_PERMISSIONS_STORE_N_COLUMNS,
};



static void                 fmb_permissions_chooser_finalize         (GObject                        *object);
static void                 fmb_permissions_chooser_get_property     (GObject                        *object,
                                                                         guint                           prop_id,
                                                                         GValue                         *value,
                                                                         GParamSpec                     *pspec);
static void                 fmb_permissions_chooser_set_property     (GObject                        *object,
                                                                         guint                           prop_id,
                                                                         const GValue                   *value,
                                                                         GParamSpec                     *pspec);
static gint                 fmb_permissions_chooser_ask_recursive    (FmbPermissionsChooser       *chooser);
static void                 fmb_permissions_chooser_change_group     (FmbPermissionsChooser       *chooser,
                                                                         guint32                         gid);
static gboolean             fmb_permissions_chooser_change_mode      (FmbPermissionsChooser       *chooser,
                                                                         FmbFileMode                  dir_mask,
                                                                         FmbFileMode                  dir_mode,
                                                                         FmbFileMode                  file_mask,
                                                                         FmbFileMode                  file_mode);
static void                 fmb_permissions_chooser_access_changed   (FmbPermissionsChooser       *chooser,
                                                                         GtkWidget                      *combo);
static void                 fmb_permissions_chooser_file_changed     (FmbPermissionsChooser       *chooser);
static void                 fmb_permissions_chooser_group_changed    (FmbPermissionsChooser       *chooser,
                                                                         GtkWidget                      *combo);
static void                 fmb_permissions_chooser_program_toggled  (FmbPermissionsChooser       *chooser,
                                                                         GtkWidget                      *button);
static void                 fmb_permissions_chooser_fixperm_clicked  (FmbPermissionsChooser       *chooser,
                                                                         GtkWidget                      *button);
static FmbJobResponse    fmb_permissions_chooser_job_ask          (FmbPermissionsChooser       *chooser,
                                                                         const gchar                    *message,
                                                                         FmbJobResponse               choices,
                                                                         FmbJob                      *job);
static void                 fmb_permissions_chooser_job_cancel       (FmbPermissionsChooser       *chooser);
static void                 fmb_permissions_chooser_job_error        (FmbPermissionsChooser       *chooser,
                                                                         GError                         *error,
                                                                         FmbJob                      *job);
static void                 fmb_permissions_chooser_job_finished     (FmbPermissionsChooser       *chooser,
                                                                         FmbJob                      *job);
static void                 fmb_permissions_chooser_job_percent      (FmbPermissionsChooser       *chooser,
                                                                         gdouble                         percent,
                                                                         FmbJob                      *job);
static void                 fmb_permissions_chooser_job_start        (FmbPermissionsChooser       *chooser,
                                                                         FmbJob                      *job,
                                                                         gboolean                        recursive);
static gboolean             fmb_permissions_chooser_row_separator    (GtkTreeModel                   *model,
                                                                         GtkTreeIter                    *iter,
                                                                         gpointer                        data);
static GList               *fmb_permissions_chooser_get_files        (FmbPermissionsChooser       *chooser);
static void                 fmb_permissions_chooser_set_files        (FmbPermissionsChooser       *chooser,
                                                                         GList                          *files);


struct _FmbPermissionsChooserClass
{
  GtkVBoxClass __parent__;
};

struct _FmbPermissionsChooser
{
  GtkVBox     __parent__;
...
G_DEFINE_TYPE (FmbPermissionsChooser, fmb_permissions_chooser, GTK_TYPE_VBOX)



static void
fmb_permissions_chooser_class_init (FmbPermissionsChooserClass *klass)
{
  GObjectClass *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = fmb_permissions_chooser_finalize;
  gobject_class->get_property = fmb_permissions_chooser_get_property;
  gobject_class->set_property = fmb_permissions_chooser_set_property;

  /**
   * FmbPermissionsChooser:file:
   *
   * The #FmbFile whose permissions will be edited/viewed.
   **/
  ...
  /**
   * FmbPermissionsChooser:mutable:
   *
   * Whether the current #FmbFile<!---->s permissions are
   * mutable.
   **/
  g_object_class_install_property (gobject_class,
                                   PROP_MUTABLE,
...
static void
fmb_permissions_chooser_init (FmbPermissionsChooser *chooser)
{
  ...
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->user_label);
  ...
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[2]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[2]), "changed", G_CALLBACK (fmb_permissions_chooser_access_changed), chooser);
  gtk_table_attach (GTK_TABLE (chooser->table), chooser->access_combos[2], 1, 2, row, row + 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[2]);
  ...
  gtk_cell_layout_add_attribute (GTK_CELL_LAYOUT (chooser->group_combo), renderer_text, "text", FMB_PERMISSIONS_STORE_COLUMN_NAME);
  gtk_combo_box_set_row_separator_func (GTK_COMBO_BOX (chooser->group_combo), fmb_permissions_chooser_row_separator, NULL, NULL);
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->group_combo), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->group_combo), "changed", G_CALLBACK (fmb_permissions_chooser_group_changed), chooser);
  gtk_table_attach (GTK_TABLE (chooser->table), chooser->group_combo, 1, 2, row, row + 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->group_combo);
  ...
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[1]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[1]), "changed", G_CALLBACK (fmb_permissions_chooser_access_changed), chooser);
  gtk_table_attach (GTK_TABLE (chooser->table), chooser->access_combos[1], 1, 2, row, row + 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[1]);
  ...
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->access_combos[0]), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->access_combos[0]), "changed", G_CALLBACK (fmb_permissions_chooser_access_changed), chooser);
  gtk_table_attach (GTK_TABLE (chooser->table), chooser->access_combos[0], 1, 2, row, row + 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->access_combos[0]);
  ...
  blxo_binding_new (G_OBJECT (chooser->program_button), "visible", G_OBJECT (label), "visible");
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (chooser->program_button), "sensitive");
  g_signal_connect_swapped (G_OBJECT (chooser->program_button), "toggled", G_CALLBACK (fmb_permissions_chooser_program_toggled), chooser);
  gtk_table_attach (GTK_TABLE (chooser->table), chooser->program_button, 1, 2, row, row + 1, GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), chooser->program_button);
  gtk_widget_show (chooser->program_button);

  row += 1;

  hbox = gtk_hbox_new (FALSE, 6);
  blxo_binding_new (G_OBJECT (chooser), "mutable", G_OBJECT (hbox), "sensitive");
  blxo_binding_new (G_OBJECT (chooser->program_button), "visible", G_OBJECT (hbox), "visible");
  ...
  gtk_label_set_attributes (GTK_LABEL (label), fmb_pango_attr_list_small_italic ());
  ...
  gtk_label_set_attributes (GTK_LABEL (chooser->fixperm_label), fmb_pango_attr_list_small_italic ());
  blxo_binding_new (G_OBJECT (chooser->fixperm_label), "visible", G_OBJECT (hbox), "visible");
  ...
  g_signal_connect_swapped (G_OBJECT (chooser->fixperm_button), "clicked", G_CALLBACK (fmb_permissions_chooser_fixperm_clicked), chooser);
  blxo_binding_new (G_OBJECT (chooser->fixperm_button), "visible", G_OBJECT (hbox), "visible");
  ...
  blxo_binding_new (G_OBJECT (chooser->job_progress), "visible", G_OBJECT (hbox), "visible");
  ...
  g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (fmb_permissions_chooser_job_cancel), chooser);
...
static void
fmb_permissions_chooser_finalize (GObject *object)
{
  FmbPermissionsChooser *chooser = FMB_PERMISSIONS_CHOOSER (object);

  /* cancel any pending job */
  if (G_UNLIKELY (chooser->job != NULL))
    {
      /* cancel the job (if not already done) */
      blxo_job_cancel (BLXO_JOB (chooser->job));
  ...
  fmb_permissions_chooser_set_files (chooser, NULL);

  (*G_OBJECT_CLASS (fmb_permissions_chooser_parent_class)->finalize) (object);
}



static void
fmb_permissions_chooser_get_property (GObject    *object,
                                         guint       prop_id,
                                         GValue     *value,
                                         GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FILES:
      g_value_set_boxed (value, fmb_permissions_chooser_get_files (chooser));
      break;

    case PROP_MUTABLE:
      for (lp = chooser->files; lp != NULL; lp = lp->next)
        if (!fmb_file_is_chmodable (FMB_FILE (lp->data)))
          break;
...
static void
fmb_permissions_chooser_set_property (GObject      *object,
                                         guint         prop_id,
                                         const GValue *value,
                                         GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_FILES:
      fmb_permissions_chooser_set_files (chooser, g_value_get_boxed (value));
      break;
...
static gboolean
fmb_permissions_chooser_ask_recursive (FmbPermissionsChooser *chooser)
{
  FmbRecursivePermissionsMode mode;
  ...
  if (G_UNLIKELY (mode == FMB_RECURSIVE_PERMISSIONS_ASK))
    {
      ...
      switch (response)
        ...
        case GTK_RESPONSE_YES:
          if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (button)))
            g_object_set (G_OBJECT (preferences), "misc-recursive-permissions", FMB_RECURSIVE_PERMISSIONS_ALWAYS, NULL);
          break;

        case GTK_RESPONSE_NO:
          if (gtk_toggle_button_get_active (GTK_TOGGLE_BUTTON (button)))
            g_object_set (G_OBJECT (preferences), "misc-recursive-permissions", FMB_RECURSIVE_PERMISSIONS_NEVER, NULL);
          break;
  ...
  else if (mode == FMB_RECURSIVE_PERMISSIONS_ALWAYS)
    {
...
static gboolean
fmb_permissions_chooser_has_directory (FmbPermissionsChooser *chooser)
{
  GList *lp;

  for (lp = chooser->files; lp != NULL; lp = lp->next)
    if (fmb_file_is_directory (FMB_FILE (lp->data)))
      return TRUE;
...
static gboolean
fmb_permissions_chooser_is_fixable_directory (FmbFile *file)
{
  FmbFileMode mode;
...
static gboolean
fmb_permissions_chooser_has_fixable_directory (FmbPermissionsChooser *chooser)
{
  GList *lp;

  for (lp = chooser->files; lp != NULL; lp = lp->next)
    if (fmb_permissions_chooser_is_fixable_directory (FMB_FILE (lp->data)))
      return TRUE;
...
static GList *
fmb_permissions_chooser_get_file_list (FmbPermissionsChooser *chooser)
{
...
static void
fmb_permissions_chooser_change_group (FmbPermissionsChooser *chooser,
                                         guint32                   gid)
{
  FmbJob *job;
  ...
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (chooser->files != NULL);

  /* check if we should operate recursively */
  if (fmb_permissions_chooser_has_directory (chooser))
    {
      response = fmb_permissions_chooser_ask_recursive (chooser);
      switch (response)
        {
        case GTK_RESPONSE_YES:
          recursive = TRUE;
        ...
        default:  /* cancelled by the user */
          fmb_permissions_chooser_file_changed (chooser);
          return;
        }
    }

  /* try to allocate the new job */
  file_list = fmb_permissions_chooser_get_file_list (chooser);
  job = fmb_io_jobs_change_group (file_list, gid, recursive);
  fmb_permissions_chooser_job_start (chooser, job, recursive);
...
static gboolean
fmb_permissions_chooser_change_mode (FmbPermissionsChooser *chooser,
                                        FmbFileMode            dir_mask,
                                        FmbFileMode            dir_mode,
                                        FmbFileMode            file_mask,
                                        FmbFileMode            file_mode)
{
  ...
  _fmb_return_val_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser), FALSE);
  _fmb_return_val_if_fail (chooser->files != NULL, FALSE);
  ...
  /* try to allocate the new job */
  file_list = fmb_permissions_chooser_get_file_list (chooser);
  job = fmb_io_jobs_change_mode (file_list, dir_mask, dir_mode, file_mask, file_mode, recursive);
  fmb_permissions_chooser_job_start (chooser, job, recursive);
  g_list_free_full (file_list, g_object_unref);
  g_object_unref (job);
...
static void
fmb_permissions_chooser_access_changed (FmbPermissionsChooser *chooser,
                                           GtkWidget                *combo)
{
  FmbFileMode  file_mask;
  FmbFileMode  file_mode;
  ...
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (GTK_IS_COMBO_BOX (combo));
  ...
  if (fmb_permissions_chooser_change_mode (chooser, dir_mask, dir_mode, file_mask, file_mode))
    {
               ...
               gpointer      group_primary)
{
  ...
  guint32 group_a_id = fmb_group_get_id (FMB_GROUP (group_a));
  guint32 group_b_id = fmb_group_get_id (FMB_GROUP (group_b));
  ...
  if (group_primary != NULL)
    {
      group_primary_id = fmb_group_get_id (FMB_GROUP (group_primary));
  ...
  return g_ascii_strcasecmp (fmb_group_get_name (FMB_GROUP (group_a)),
                             fmb_group_get_name (FMB_GROUP (group_b)));
}



static void
fmb_permissions_chooser_file_changed (FmbPermissionsChooser *chooser)
{
  FmbFile        *file;
  FmbUserManager *user_manager;
  FmbFileMode     mode = 0;
  FmbGroup       *group = NULL;
  FmbUser        *user = NULL;
  GtkListStore      *store;
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      if (n_files == 0)
      ...
      else
        {
          ...
          if (user != NULL && user != fmb_file_get_user (file))
            user = NULL;

          if (group != NULL && group != fmb_file_get_group (file))
            group = NULL;
  ...
  file = FMB_FILE (chooser->files->data);

  /* allocate a new store for the group combo box */
  g_signal_handlers_block_by_func (G_OBJECT (chooser->group_combo), fmb_permissions_chooser_group_changed, chooser);
  store = gtk_list_store_new (FMB_PERMISSIONS_STORE_N_COLUMNS, G_TYPE_STRING, G_TYPE_UINT);
  ...
  if (G_LIKELY (user != NULL))
    {
      ...
      user_name = fmb_user_get_name (user);
  ...
  if (G_UNLIKELY (geteuid () == 0))
    {
      ...
      groups = fmb_user_manager_get_all_groups (user_manager);
  ...
  else
    {
      if (G_UNLIKELY (user == NULL && n_files > 1))
        {
          ...
          user_manager = fmb_user_manager_get_default ();
          user = fmb_user_manager_get_user_by_id (user_manager, geteuid ());
          g_object_unref (G_OBJECT (user_manager));
        }
      ...
      if (G_LIKELY (user != NULL))
        {
          groups = g_list_copy (fmb_user_get_groups (user));
  ...
  for (lp = groups, n = 0; lp != NULL; lp = lp->next)
    {
      ...
      if (group != NULL
          && fmb_group_get_id (groups->data) == fmb_group_get_id (group)
          && lp != groups && n == 0)
        {
          gtk_list_store_append (store, &iter);
          n += 1;
        }
      else if (lp != groups && fmb_group_get_id (lp->data) < 100 && n == 1)
        {
          gtk_list_store_append (store, &iter);
          n += 1;
        }
      ...
      gtk_list_store_set (store, &iter,
                          FMB_PERMISSIONS_STORE_COLUMN_NAME, fmb_group_get_name (lp->data),
                          FMB_PERMISSIONS_STORE_COLUMN_GID, fmb_group_get_id (lp->data),
                          -1);
  ...
  for (n = 0; n < G_N_ELEMENTS (chooser->access_combos); ++n)
    {
      g_signal_handlers_block_by_func (G_OBJECT (chooser->access_combos[n]), fmb_permissions_chooser_access_changed, chooser);
      ...
      g_signal_handlers_unblock_by_func (G_OBJECT (chooser->access_combos[n]), fmb_permissions_chooser_access_changed, chooser);
  ...
  g_signal_handlers_block_by_func (G_OBJECT (chooser->program_button), fmb_permissions_chooser_program_toggled, chooser);
  g_object_set (G_OBJECT (chooser->program_button), "visible", fmb_file_is_regular (file)
      && (fmbx_file_info_has_mime_type (FMBX_FILE_INFO (file), "application/x-executable")
       || fmbx_file_info_has_mime_type (FMBX_FILE_INFO (file), "application/x-shellscript")
       || fmbx_file_info_has_mime_type (FMBX_FILE_INFO (file), "application/x-desktop")
       || fmbx_file_info_has_mime_type (FMBX_FILE_INFO (file), "application/x-ms-dos-executable")
       || fmbx_file_info_has_mime_type (FMBX_FILE_INFO (file), "application/x-msi")), NULL);
  gtk_toggle_button_set_active (GTK_TOGGLE_BUTTON (chooser->program_button), (mode & 0111) != 0);
  g_signal_handlers_unblock_by_func (G_OBJECT (chooser->program_button), fmb_permissions_chooser_program_toggled, chooser);

  /* update the "inconsistent folder permissions" warning and the "fix permissions" button based on the mode */
  if (fmb_permissions_chooser_has_fixable_directory (chooser))
    {
  ...
  g_signal_handlers_unblock_by_func (G_OBJECT (chooser->group_combo), fmb_permissions_chooser_group_changed, chooser);
...
static void
fmb_permissions_chooser_group_changed (FmbPermissionsChooser *chooser,
                                          GtkWidget                *combo)
{
  GtkTreeModel *model;
  GtkTreeIter   iter;
  ...
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (chooser->group_combo == combo);
  _fmb_return_if_fail (GTK_IS_COMBO_BOX (combo));
  ...
  if (gtk_combo_box_get_active_iter (GTK_COMBO_BOX (combo), &iter))
    {
      ...
      gtk_tree_model_get (model, &iter, FMB_PERMISSIONS_STORE_COLUMN_GID, &gid, -1);

      /* ...and try to change the group to the new gid */
      fmb_permissions_chooser_change_group (chooser, gid);
    }
}
...
static void
fmb_permissions_chooser_program_toggled (FmbPermissionsChooser *chooser,
                                            GtkWidget                *button)
{
  FmbFileMode mode;

  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (chooser->program_button == button);
  ...
  fmb_permissions_chooser_change_mode (chooser, 0000, 0000, 0111, mode);
}



static void
fmb_permissions_chooser_fixperm_clicked (FmbPermissionsChooser *chooser,
                                            GtkWidget                *button)
{
  FmbFileMode mode;
  GtkWidget     *dialog;
  ...
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (chooser->fixperm_button == button);
  _fmb_return_if_fail (GTK_IS_BUTTON (button));
  _fmb_return_if_fail (fmb_permissions_chooser_has_fixable_directory (chooser));
      ...
      for (lp = chooser->files; lp != NULL; lp = lp->next)
        {
          ...
          mode = fmb_file_get_mode (FMB_FILE (lp->data));

          /* determine the new mode (making sure the owner can read/enter the folder) */
          mode = (FMB_FILE_MODE_USR_READ | FMB_FILE_MODE_USR_EXEC)
               | (((mode & FMB_FILE_MODE_GRP_READ) != 0) ? FMB_FILE_MODE_GRP_EXEC : 0)
               | (((mode & FMB_FILE_MODE_OTH_READ) != 0) ? FMB_FILE_MODE_OTH_EXEC : 0);

          file_list.prev = NULL;
          file_list.data = fmb_file_get_file (FMB_FILE (lp->data));
          file_list.next = NULL;

          /* try to allocate the new job */
          job = fmb_io_jobs_change_mode (&file_list,
                                            0511, mode, 0000, 0000, FALSE);

          /* handle the job */
          fmb_permissions_chooser_job_start (chooser, job, FALSE);
          g_object_unref (job);
        }
    }
}
...
fmb_permissions_chooser_job_ask (FmbPermissionsChooser *chooser,
                                    const gchar              *message,
                                    FmbJobResponse         choices,
                                    FmbJob                *job)
{
  ...
  _fmb_return_val_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser), FMB_JOB_RESPONSE_CANCEL);
  ...
  _fmb_return_val_if_fail (chooser->job == job, FMB_JOB_RESPONSE_CANCEL);
  ...
  return fmb_dialogs_show_job_ask (GTK_WINDOW (toplevel), message, choices);
}



static void
fmb_permissions_chooser_job_cancel (FmbPermissionsChooser *chooser)
{
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
...
static void
fmb_permissions_chooser_job_error (FmbPermissionsChooser *chooser,
                                      GError                   *error,
                                      FmbJob                *job)
{
  GtkWidget *toplevel;
  ...
  _fmb_return_if_fail (chooser->job == job);
  ...
  fmb_dialogs_show_job_error (GTK_WINDOW (toplevel), error);
}



static void
fmb_permissions_chooser_job_finished (FmbPermissionsChooser *chooser,
                                         FmbJob                *job)
{
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (FMB_IS_JOB (job));
  ...
  fmb_permissions_chooser_job_cancel (chooser);
}



static void
fmb_permissions_chooser_job_percent (FmbPermissionsChooser *chooser,
                                        gdouble                   percent,
                                        FmbJob                *job)
{
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
...
static void
fmb_permissions_chooser_job_start (FmbPermissionsChooser *chooser,
                                      FmbJob                *job,
                                      gboolean                  recursive)
{
  _fmb_return_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser));
  _fmb_return_if_fail (FMB_IS_JOB (job));
  _fmb_return_if_fail (chooser->job == NULL);

  /* take a reference to the job and connect signals */
  chooser->job = g_object_ref (job);
  g_signal_connect_swapped (job, "ask", G_CALLBACK (fmb_permissions_chooser_job_ask), chooser);
  g_signal_connect_swapped (job, "error", G_CALLBACK (fmb_permissions_chooser_job_error), chooser);
  g_signal_connect_swapped (job, "finished", G_CALLBACK (fmb_permissions_chooser_job_finished), chooser);

  /* don't connect percent for single file operations */
  if (G_UNLIKELY (recursive))
    g_signal_connect_swapped (job, "percent", G_CALLBACK (fmb_permissions_chooser_job_percent), chooser);
...
static gboolean
fmb_permissions_chooser_row_separator (GtkTreeModel *model,
                                          GtkTreeIter  *iter,
                                          gpointer      data)
{
  gchar *name;
  ...
  gtk_tree_model_get (model, iter, FMB_PERMISSIONS_STORE_COLUMN_NAME, &name, -1);
...
/**
 * fmb_permissions_chooser_get_files:
 * @chooser : a #FmbPermissionsChooser.
 *
 * Returns the #FmbFile's associated with the specified @chooser.
 *
 * Return value: the file associated with @chooser.
 **/
GList*
fmb_permissions_chooser_get_files (FmbPermissionsChooser *chooser)
{
  _fmb_return_val_if_fail (FMB_IS_PERMISSIONS_CHOOSER (chooser), NULL);
...
/**
 * fmb_permissions_chooser_set_files:
 * @chooser : a #FmbPermissionsChooser.
 * @files   : a list of #FmbFiles or %NULL.
 *
 * Associates @chooser with the specified @file.
 **/
void
fmb_permissions_chooser_set_files (FmbPermissionsChooser *chooser,
                                      GList                    *files)
{
  GList *lp;
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      g_signal_handlers_disconnect_by_func (G_OBJECT (lp->data), fmb_permissions_chooser_file_changed, chooser);
  ...
  for (lp = chooser->files; lp != NULL; lp = lp->next)
    {
      ...
      g_signal_connect_swapped (G_OBJECT (lp->data), "changed", G_CALLBACK (fmb_permissions_chooser_file_changed), chooser);
    }
...
/**
 * fmb_permissions_chooser_new:
 *
 * Allocates a new #FmbPermissionsChooser instance.
 *
 * Return value: the newly allocated #FmbPermissionsChooser.
 **/
GtkWidget*
fmb_permissions_chooser_new (void)
{
  return g_object_new (FMB_TYPE_PERMISSIONS_CHOOSER, NULL);
}
