...
static void fmb_abstract_dialog_close      (GtkDialog                 *dialog);



G_DEFINE_ABSTRACT_TYPE (FmbAbstractDialog, fmb_abstract_dialog, GTK_TYPE_DIALOG)



static void
fmb_abstract_dialog_class_init (FmbAbstractDialogClass *klass)
{
  GtkDialogClass *gtkdialog_class;
  GtkBindingSet  *binding_set;

  gtkdialog_class = GTK_DIALOG_CLASS (klass);
  gtkdialog_class->close = fmb_abstract_dialog_close;
...
static void
fmb_abstract_dialog_init (FmbAbstractDialog *dialog)
{
}
...
static void
fmb_abstract_dialog_close (GtkDialog *dialog)
{
  GdkEvent *event;
