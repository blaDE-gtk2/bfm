...
#ifndef __FMB_GOBJECT_EXTENSIONS_H__
#define __FMB_GOBJECT_EXTENSIONS_H__
 ...
 * within Fmb and they will be tested during debug builds. Besides that
...
void fmb_g_initialize_transformations (void);

G_END_DECLS;

#endif /* !__FMB_GOBJECT_EXTENSIONS_H__ */
