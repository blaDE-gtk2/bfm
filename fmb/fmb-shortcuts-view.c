...
static void           fmb_shortcuts_view_finalize                     (GObject                  *object);
static gboolean       fmb_shortcuts_view_button_press_event           (GtkWidget                *widget,
                                                                          GdkEventButton           *event);
static gboolean       fmb_shortcuts_view_button_release_event         (GtkWidget                *widget,
                                                                          GdkEventButton           *event);
static gboolean       fmb_shortcuts_view_key_release_event            (GtkWidget                *widget,
                                                                          GdkEventKey              *event);
static void           fmb_shortcuts_view_drag_begin                   (GtkWidget                *widget,
                                                                          GdkDragContext           *context);
static void           fmb_shortcuts_view_drag_data_received           (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          ...
                                                                          guint                     info,
                                                                          guint                     timestamp);
static gboolean       fmb_shortcuts_view_drag_drop                    (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          guint                     timestamp);
static gboolean       fmb_shortcuts_view_drag_motion                  (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
                                                                          guint                     timestamp);
static void           fmb_shortcuts_view_drag_leave                   (GtkWidget                *widget,
                                                                          GdkDragContext           *context,
                                                                          guint                     timestamp);
static gboolean       fmb_shortcuts_view_popup_menu                   (GtkWidget                *widget);
static void           fmb_shortcuts_view_row_activated                (GtkTreeView              *tree_view,
                                                                          GtkTreePath              *path,
                                                                          GtkTreeViewColumn        *column);
static gboolean       fmb_shortcuts_view_selection_func               (GtkTreeSelection         *selection,
                                                                          GtkTreeModel             *model,
                                                                          GtkTreePath              *path,
                                                                          gboolean                  path_currently_selected,
                                                                          gpointer                  user_data);
static void           fmb_shortcuts_view_context_menu_visibility      (FmbShortcutsView      *view,
                                                                          GdkEventButton           *event,
                                                                          GtkTreeModel             *model);
static void           fmb_shortcuts_view_context_menu                 (FmbShortcutsView      *view,
                                                                          GdkEventButton           *event,
                                                                          GtkTreeModel             *model,
                                                                          GtkTreeIter              *iter);
static void           fmb_shortcuts_view_remove_activated             (GtkWidget                *item,
                                                                          GtkTreeModel             *model);
static void           fmb_shortcuts_view_editing_canceled             (GtkCellRenderer          *renderer,
                                                                          FmbShortcutsView      *view);
static void           fmb_shortcuts_view_rename_activated             (GtkWidget                *item,
                                                                          FmbShortcutsView      *view);
static void           fmb_shortcuts_view_renamed                      (GtkCellRenderer          *renderer,
                                                                          const gchar              *path_string,
                                                                          const gchar              *text,
                                                                          FmbShortcutsView      *view);
static GdkDragAction  fmb_shortcuts_view_compute_drop_actions         (FmbShortcutsView      *view,
                                                                          GdkDragContext           *context,
                                                                          gint                      x,
                                                                          gint                      y,
...
static GtkTreePath   *fmb_shortcuts_view_compute_drop_position        (FmbShortcutsView      *view,
                                                                          gint                      x,
                                                                          gint                      y);
static void           fmb_shortcuts_view_drop_uri_list                (FmbShortcutsView      *view,
                                                                          GList                    *path_list,
                                                                          GtkTreePath              *dst_path);
static void           fmb_shortcuts_view_open_clicked                 (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_open                         (FmbShortcutsView      *view,
                                                                          OpenTarget                open_in);
static void           fmb_shortcuts_view_open_in_new_window_clicked   (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_open_in_new_tab_clicked      (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_empty_trash                  (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_create_shortcut              (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_eject                        (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_mount                        (FmbShortcutsView      *view);
static void           fmb_shortcuts_view_unmount                      (FmbShortcutsView      *view);



struct _FmbShortcutsViewClass
{
  GtkTreeViewClass __parent__;
};

struct _FmbShortcutsView
{
...
G_DEFINE_TYPE_WITH_CODE (FmbShortcutsView, fmb_shortcuts_view, GTK_TYPE_TREE_VIEW,
                         G_IMPLEMENT_INTERFACE (FMB_TYPE_BROWSER, NULL))



static void
fmb_shortcuts_view_class_init (FmbShortcutsViewClass *klass)
{
  ...
  gobject_class->finalize = fmb_shortcuts_view_finalize;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->button_press_event = fmb_shortcuts_view_button_press_event;
  gtkwidget_class->button_release_event = fmb_shortcuts_view_button_release_event;
  gtkwidget_class->key_release_event = fmb_shortcuts_view_key_release_event;
  gtkwidget_class->drag_begin = fmb_shortcuts_view_drag_begin;
  gtkwidget_class->drag_data_received = fmb_shortcuts_view_drag_data_received;
  gtkwidget_class->drag_drop = fmb_shortcuts_view_drag_drop;
  gtkwidget_class->drag_motion = fmb_shortcuts_view_drag_motion;
  gtkwidget_class->drag_leave = fmb_shortcuts_view_drag_leave;
  gtkwidget_class->popup_menu = fmb_shortcuts_view_popup_menu;

  gtktree_view_class = GTK_TREE_VIEW_CLASS (klass);
  gtktree_view_class->row_activated = fmb_shortcuts_view_row_activated;

  /**
   * FmbShortcutsView:shortcut-activated:
   *
  ...
  /**
   * FmbShortcutsView:shortcut-activated-tab:
   *
...
static void
fmb_shortcuts_view_init (FmbShortcutsView *view)
{
  GtkTreeViewColumn *column;
  ...
  gtk_tree_view_set_tooltip_column (GTK_TREE_VIEW (view), FMB_SHORTCUTS_MODEL_COLUMN_TOOLTIP);
  ...
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "text", FMB_SHORTCUTS_MODEL_COLUMN_NAME,
                                       "visible", FMB_SHORTCUTS_MODEL_COLUMN_IS_HEADER,
                                       NULL);
  ...
  gtk_tree_view_column_pack_start (column, renderer, FALSE);
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", FMB_SHORTCUTS_MODEL_COLUMN_IS_ITEM,
                                       NULL);
  ...
  gtk_tree_view_column_set_attributes (column, view->icon_renderer,
                                       "gicon", FMB_SHORTCUTS_MODEL_COLUMN_GICON,
                                       "file", FMB_SHORTCUTS_MODEL_COLUMN_FILE,
                                       "device", FMB_SHORTCUTS_MODEL_COLUMN_DEVICE,
                                       "visible", FMB_SHORTCUTS_MODEL_COLUMN_IS_ITEM,
                                       NULL);
   ...
   */
  blxo_binding_new (G_OBJECT (view->preferences), "shortcuts-icon-size", G_OBJECT (view->icon_renderer), "size");
  blxo_binding_new (G_OBJECT (view->preferences), "shortcuts-icon-emblems", G_OBJECT (view->icon_renderer), "emblems");

  /* allocate the text renderer (ellipsizing as required, but "File System" must fit) */
  renderer = g_object_new (GTK_TYPE_CELL_RENDERER_TEXT,
                           "ellipsize", PANGO_ELLIPSIZE_END,
                           NULL);
  g_signal_connect (G_OBJECT (renderer), "edited", G_CALLBACK (fmb_shortcuts_view_renamed), view);
  ...
  gtk_tree_view_column_pack_start (column, renderer, FALSE);
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", FMB_SHORTCUTS_MODEL_COLUMN_BUSY,
                                       "active", FMB_SHORTCUTS_MODEL_COLUMN_BUSY,
                                       "pulse", FMB_SHORTCUTS_MODEL_COLUMN_BUSY_PULSE,
                                       NULL);
  ...
  gtk_tree_view_column_pack_start (column, renderer, FALSE);
  gtk_tree_view_column_set_attributes (column, renderer,
                                       "visible", FMB_SHORTCUTS_MODEL_COLUMN_CAN_EJECT,
                                       NULL);
  ...
  gtk_tree_selection_set_select_function (selection, fmb_shortcuts_view_selection_func, NULL, NULL);
}



static void
fmb_shortcuts_view_finalize (GObject *object)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (object);
  ...
  (*G_OBJECT_CLASS (fmb_shortcuts_view_parent_class)->finalize) (object);
}



static gboolean
fmb_shortcuts_view_button_press_event (GtkWidget      *widget,
                                          GdkEventButton *event)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  GtkTreeModel        *model;
  GtkTreePath         *path;
  GtkTreeIter          iter;
  gboolean             result;
  ...
  result = (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->button_press_event) (widget, event);
  ...
  if (gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (widget), event->x, event->y, &path, NULL, NULL, NULL))
          ...
          if (gtk_tree_model_get_iter (model, &iter, path))
            {
              ...
              fmb_shortcuts_view_context_menu (view, event, model, &iter);
          ...
          if (event->button == 1 && event->x >= column_width - icon_width - 3)
            {
              ...
              if (gtk_tree_model_get_iter (model, &iter, path))
                {
                  gtk_tree_model_get (model, &iter, FMB_SHORTCUTS_MODEL_COLUMN_CAN_EJECT, &can_eject, -1);
                  if (can_eject)
    ...
    {
      fmb_shortcuts_view_context_menu_visibility (view, event, model);
      result = TRUE;
    }
...
static gboolean
fmb_shortcuts_view_button_release_event (GtkWidget      *widget,
                                            GdkEventButton *event)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  gboolean             in_tab;
  ...
  if (G_LIKELY (view->pressed_button == (gint) event->button))
    {
      ...
      if (view->pressed_eject_button)
        {
          fmb_shortcuts_view_eject (view);
        }
      else if (G_LIKELY (event->button == 1))
        {
          /* button 1 opens in the same window */
          fmb_shortcuts_view_open (view, OPEN_IN_VIEW);
        }
      else if (G_UNLIKELY (event->button == 2))
        {
          ...
          fmb_shortcuts_view_open (view, in_tab ? OPEN_IN_TAB : OPEN_IN_WINDOW);
        }
    }
  ...
  return (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->button_release_event) (widget, event);
}



static gboolean
fmb_shortcuts_view_key_release_event (GtkWidget   *widget,
                                         GdkEventKey *event)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  ...
  /* call the parent's release event handler */
  return (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->key_release_event) (widget, event);
}



static void
fmb_shortcuts_view_drag_begin (GtkWidget      *widget,
                                  GdkDragContext *context)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  ...
  if (GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->drag_begin != NULL)
    (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->drag_begin) (widget, context);
}



static void
fmb_shortcuts_view_drag_data_received (GtkWidget        *widget,
                                          GdkDragContext   *context,
                                          gint              x,
                                          gint              y,
                                          GtkSelectionData *selection_data,
                                          ...
                                          guint             timestamp)
{
  ...
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_VIEW (view));
  ...
  if (G_UNLIKELY (view->drop_occurred))
    {
      ...
      if (G_LIKELY (info == TEXT_URI_LIST))
        {
          ...
          actions = fmb_shortcuts_view_compute_drop_actions (view, context, x, y, &path, &action, &position);
              ...
              if (position == GTK_TREE_VIEW_DROP_BEFORE || position == GTK_TREE_VIEW_DROP_AFTER)
                {
                  ...
                  fmb_shortcuts_view_drop_uri_list (view, view->drop_file_list, path);
                }
                  ...
                  if (gtk_tree_model_get_iter (model, &iter, path))
                    {
                      ...
                      gtk_tree_model_get (model, &iter, FMB_SHORTCUTS_MODEL_COLUMN_FILE, &file, -1);
                      if (G_LIKELY (file != NULL))
                        {
                          /* ask the user what to do with the drop data */
                          if (G_UNLIKELY (action == GDK_ACTION_ASK))
                            action = fmb_dnd_ask (widget, file, view->drop_file_list, timestamp, actions);

                          /* perform the requested action */
                          if (G_LIKELY (action != 0))
                            {
                              /* really perform the drop :-) */
                              succeed = fmb_dnd_perform (widget, file, view->drop_file_list, action, NULL);
                            }
      ...
      fmb_shortcuts_view_drag_leave (widget, context, timestamp);
...
static gboolean
fmb_shortcuts_view_drag_drop (GtkWidget      *widget,
                                 GdkDragContext *context,
                                 gint            x,
                                 gint            y,
                                 guint           timestamp)
{
  ...
  _fmb_return_val_if_fail (FMB_IS_SHORTCUTS_VIEW (view), FALSE);
  ...
  if (G_LIKELY (target == gdk_atom_intern_static_string ("text/uri-list")))
  ...
  else if (target == gdk_atom_intern_static_string ("GTK_TREE_MODEL_ROW"))
    {
      ...
      dst_path = fmb_shortcuts_view_compute_drop_position (view, x, y);
      ...
      if (gtk_tree_selection_get_selected (selection, &model, &iter))
        {
          ...
          /* perform the move */
          fmb_shortcuts_model_move (FMB_SHORTCUTS_MODEL (child_model), child_src_path, child_dst_path);
...
static gboolean
fmb_shortcuts_view_drag_motion (GtkWidget      *widget,
                                   GdkDragContext *context,
                                   gint            x,
                                   gint            y,
                                   guint           timestamp)
  ...
  if (target == gdk_atom_intern_static_string ("text/uri-list"))
    {
      ...
      if (G_UNLIKELY (!view->drop_data_ready))
        ...
        {
          /* compute the drop position */
          fmb_shortcuts_view_compute_drop_actions (view, context, x, y, &path, &action, &position);
        }
    }
  else if (target == gdk_atom_intern_static_string ("GTK_TREE_MODEL_ROW"))
    {
      ...
      path = fmb_shortcuts_view_compute_drop_position (view, x, y);
      if (path == NULL)
        return FALSE;
...
static void
fmb_shortcuts_view_drag_leave (GtkWidget      *widget,
                                  GdkDragContext *context,
                                  guint           timestamp)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  ...
  (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->drag_leave) (widget, context, timestamp);
}



static gboolean
fmb_shortcuts_view_popup_menu (GtkWidget *widget)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (widget);
  GtkTreeSelection    *selection;
  GtkTreeModel        *model;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      /* popup the context menu */
      fmb_shortcuts_view_context_menu (view, NULL, model, &iter);
      return TRUE;
    }
  else if (GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->popup_menu != NULL)
    {
      /* call the parent's "popup-menu" handler */
      return (*GTK_WIDGET_CLASS (fmb_shortcuts_view_parent_class)->popup_menu) (widget);
    }
...
static void
fmb_shortcuts_view_row_activated (GtkTreeView       *tree_view,
                                     GtkTreePath       *path,
                                     GtkTreeViewColumn *column)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (tree_view);

  /* call the parent's "row-activated" handler */
  if (GTK_TREE_VIEW_CLASS (fmb_shortcuts_view_parent_class)->row_activated != NULL)
    (*GTK_TREE_VIEW_CLASS (fmb_shortcuts_view_parent_class)->row_activated) (tree_view, path, column);
...
static gboolean
fmb_shortcuts_view_selection_func (GtkTreeSelection *selection,
                                      GtkTreeModel     *model,
                                      GtkTreePath      *path,
                                      gboolean          path_currently_selected,
                                      gpointer          user_data)
{
  ...
  gtk_tree_model_get (model, &iter, FMB_SHORTCUTS_MODEL_COLUMN_IS_HEADER, &is_header, -1);
  return !is_header;
}
...
static void
fmb_shortcuts_view_context_menu_visibility_toggled (GtkCheckMenuItem *item,
                                                       GtkTreeModel     *model)
{
  gboolean             hidden;
  GtkTreePath         *path;
  ...
  _fmb_return_if_fail (GTK_IS_CHECK_MENU_ITEM (item));
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_MODEL (model));

  row = g_object_get_data (G_OBJECT (item), I_("fmb-shortcuts-row"));
  path = gtk_tree_row_reference_get_path (row);
  if (G_LIKELY (path != NULL))
    {
      hidden = !gtk_check_menu_item_get_active (item);
      fmb_shortcuts_model_set_hidden (FMB_SHORTCUTS_MODEL (model), path, hidden);
      gtk_tree_path_free (path);
    }
}
...
static void
fmb_shortcuts_view_context_menu_visibility (FmbShortcutsView *view,
                                               GdkEventButton      *event,
                                               GtkTreeModel        *model)
{
  GtkTreeIter          iter;
  ...
  do
    {
      ...
      gtk_tree_model_get (GTK_TREE_MODEL (child_model), &iter,
                          FMB_SHORTCUTS_MODEL_COLUMN_GROUP, &group,
                          FMB_SHORTCUTS_MODEL_COLUMN_NAME, &label,
                          FMB_SHORTCUTS_MODEL_COLUMN_VISIBLE, &visible,
                          -1);

      if ((group & FMB_SHORTCUT_GROUP_HEADER) != 0)
        {
          /* get the mask of the group */
          if ((group & FMB_SHORTCUT_GROUP_DEVICES) != 0)
            mask = FMB_SHORTCUT_GROUP_DEVICES;
          else if ((group & FMB_SHORTCUT_GROUP_PLACES) != 0)
            mask = FMB_SHORTCUT_GROUP_PLACES;
          else if ((group & FMB_SHORTCUT_GROUP_NETWORK) != 0)
            mask = FMB_SHORTCUT_GROUP_NETWORK;
          else
      ...
      else if ((group & mask) != 0)
        {
          ...
          g_object_set_data_full (G_OBJECT (mi), I_("fmb-shortcuts-row"),
                                  gtk_tree_row_reference_new (child_model, path),
                                  (GDestroyNotify) gtk_tree_row_reference_free);
          g_signal_connect (G_OBJECT (mi), "toggled",
            G_CALLBACK (fmb_shortcuts_view_context_menu_visibility_toggled), child_model);
          gtk_widget_show (mi);
        }
  ...
  fmb_gtk_menu_run (GTK_MENU (menu), GTK_WIDGET (view), NULL, NULL,
...
static void
fmb_shortcuts_view_context_menu (FmbShortcutsView *view,
                                    GdkEventButton      *event,
                                    GtkTreeModel        *model,
                                    GtkTreeIter         *iter)
{
  ...
  gtk_tree_model_get (model, iter,
                      FMB_SHORTCUTS_MODEL_COLUMN_FILE, &file,
                      FMB_SHORTCUTS_MODEL_COLUMN_DEVICE, &device,
                      FMB_SHORTCUTS_MODEL_COLUMN_MUTABLE, &mutable,
                      FMB_SHORTCUTS_MODEL_COLUMN_GROUP, &group,
                      -1);
  ...
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_open_clicked), view);
  ...
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_open_in_new_tab_clicked), view);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);

  /* append the "Open in New Window" menu action */
  item = gtk_image_menu_item_new_with_mnemonic (_("Open in New Window"));
  g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_open_in_new_window_clicked), view);
  gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
  gtk_widget_show (item);

  switch (group)
    {
      case FMB_SHORTCUT_GROUP_DEVICES_VOLUMES:
        can_mount = fmb_device_can_mount (device);
        can_unmount = fmb_device_can_unmount (device);
        can_eject = fmb_device_can_eject (device);
        ...
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_mount), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);

        /* append the "Unmount" item */
        item = gtk_image_menu_item_new_with_mnemonic (_("_Unmount"));
        gtk_widget_set_visible (item, can_unmount);
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_unmount), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        ...
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_eject), view);
        break;

      case FMB_SHORTCUT_GROUP_NETWORK_MOUNTS:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        ...
        gtk_widget_set_sensitive (item, mount_point != NULL && !fmb_shortcuts_model_has_bookmark (FMB_SHORTCUTS_MODEL (shortcuts_model), mount_point));
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_create_shortcut), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);

        image = gtk_image_new_from_stock (FMB_STOCK_SHORTCUTS, GTK_ICON_SIZE_MENU);
        gtk_image_menu_item_set_image (GTK_IMAGE_MENU_ITEM (item), image);
      ...
      case FMB_SHORTCUT_GROUP_DEVICES_MOUNTS:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
      ...
      case FMB_SHORTCUT_GROUP_PLACES_TRASH:
        /* append a menu separator */
        item = gtk_separator_menu_item_new ();
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        ...
        g_signal_connect_swapped (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_empty_trash), view);
        gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
        gtk_widget_show (item);
        break;
  ...
  if (group == FMB_SHORTCUT_GROUP_PLACES_BOOKMARKS)
    {
      /* append a menu separator */
      item = gtk_separator_menu_item_new ();
      gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
      ...
      g_object_set_data_full (G_OBJECT (item), I_("fmb-shortcuts-row"),
                              gtk_tree_row_reference_new (model, path),
                              (GDestroyNotify) gtk_tree_row_reference_free);
      g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_remove_activated), model);
      ...
      g_object_set_data_full (G_OBJECT (item), I_("fmb-shortcuts-row"),
                              gtk_tree_row_reference_new (model, path),
                              (GDestroyNotify) gtk_tree_row_reference_free);
      g_signal_connect (G_OBJECT (item), "activate", G_CALLBACK (fmb_shortcuts_view_rename_activated), view);
      gtk_widget_set_sensitive (item, mutable);
      gtk_menu_shell_append (GTK_MENU_SHELL (menu), item);
...
static void
fmb_shortcuts_view_remove_activated (GtkWidget    *item,
                                        GtkTreeModel *model)
{
  GtkTreeRowReference *row;
  GtkTreeModel        *child_model;
  ...
  if (G_LIKELY (path != NULL))
    {
      ...
      child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
      fmb_shortcuts_model_remove (FMB_SHORTCUTS_MODEL (child_model), child_path);
...
static void
fmb_shortcuts_view_editing_canceled (GtkCellRenderer     *renderer,
                                        FmbShortcutsView *view)
{
  g_object_set (G_OBJECT (renderer), "editable", FALSE, NULL);

  g_signal_handlers_disconnect_by_func (G_OBJECT (renderer),
                                       G_CALLBACK (fmb_shortcuts_view_editing_canceled),
                                       view);
}
...
static void
fmb_shortcuts_view_rename_activated (GtkWidget           *item,
                                        FmbShortcutsView *view)
{
  GtkTreeRowReference *row;
  GtkTreeViewColumn   *column;
  ...
  if (G_LIKELY (path != NULL))
    {
      ...
      g_signal_connect (G_OBJECT (renderer), "editing-canceled",
                        G_CALLBACK (fmb_shortcuts_view_editing_canceled), view);
...
static void
fmb_shortcuts_view_renamed (GtkCellRenderer     *renderer,
                               const gchar         *path_string,
                               const gchar         *text,
                               FmbShortcutsView *view)
{
  ...
  if (gtk_tree_model_get_iter_from_string (model, &iter, path_string))
    {
      ...
      fmb_shortcuts_model_rename (FMB_SHORTCUTS_MODEL (child_model), &child_iter, text);
    }
}
...
fmb_shortcuts_view_compute_drop_actions (FmbShortcutsView     *view,
                                            GdkDragContext          *context,
                                            gint                     x,
                                            gint                     y,
                                            GtkTreePath            **path_return,
          ...
          if (G_LIKELY (file != NULL))
            {
              ...
              actions = fmb_file_accepts_drop (file, view->drop_file_list, context, action_return);
              if (G_LIKELY (actions != 0))
                {
...
static GtkTreePath*
fmb_shortcuts_view_compute_drop_position (FmbShortcutsView *view,
                                             gint                 x,
                                             gint                 y)
{
  GtkTreeViewColumn *column;
  ...
  _fmb_return_val_if_fail (gtk_tree_view_get_model (GTK_TREE_VIEW (view)) != NULL, NULL);
  _fmb_return_val_if_fail (FMB_IS_SHORTCUTS_VIEW (view), NULL);
  ...
  if (gtk_tree_view_get_path_at_pos (GTK_TREE_VIEW (view), x, y,
                                     &path, &column, &x, &y))
    {
      ...
      for (; gtk_tree_path_get_indices (path)[0] < n_rows; gtk_tree_path_next (path))
        {
          child_path = gtk_tree_model_filter_convert_path_to_child_path (GTK_TREE_MODEL_FILTER (model), path);
          result = fmb_shortcuts_model_drop_possible (FMB_SHORTCUTS_MODEL (child_model), child_path);
          gtk_tree_path_free (child_path);
          if (result)
            return path;
        }
...
static void
fmb_shortcuts_view_drop_uri_list (FmbShortcutsView *view,
                                     GList               *path_list,
                                     GtkTreePath         *dst_path)
{
  GtkTreeModel *model;
  ...
  for (lp = path_list; lp != NULL; lp = lp->next)
    {
      file = fmb_file_get (lp->data, &error);
      ...
      child_path = gtk_tree_model_filter_convert_path_to_child_path (GTK_TREE_MODEL_FILTER (model), path);
      fmb_shortcuts_model_add (FMB_SHORTCUTS_MODEL (child_model), child_path, file);
      gtk_tree_path_free (child_path);
  ...
  if (G_UNLIKELY (error != NULL))
    {
      ...
      fmb_dialogs_show_error (GTK_WIDGET (view), error, _("Failed to add new shortcut"));
...
static void
fmb_shortcuts_view_open_clicked (FmbShortcutsView *view)
{
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_VIEW (view));
  fmb_shortcuts_view_open (view, OPEN_IN_VIEW);
}
...
static void
fmb_shortcuts_view_poke_file_finish (FmbBrowser *browser,
                                        FmbFile    *file,
                                        FmbFile    *target_file,
                                        GError        *error,
                                        gpointer       user_data)
{
  ...
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_VIEW (browser));
  _fmb_return_if_fail (FMB_IS_FILE (target_file));
  ...
  if (error == NULL)
    {
      if (open_in == OPEN_IN_WINDOW)
        {
          ...
          fmb_application_open_window (application, target_file,
      ...
      else if (fmb_file_check_loaded (target_file))
        {
    ...
    {
      fmb_dialogs_show_error (GTK_WIDGET (browser), error, _("Failed to open \"%s\""),
                                 fmb_file_get_display_name (file));
    }
}
...
static void
fmb_shortcuts_view_poke_location_finish (FmbBrowser *browser,
                                            GFile         *location,
                                            FmbFile    *file,
                                            FmbFile    *target_file,
                                            GError        *error,
                                            gpointer       user_data)
{
  ...
  if (error == NULL)
    {
      fmb_shortcuts_view_poke_file_finish (browser, file, target_file, error, user_data);
    }
  else
    {
      name = fmb_g_file_get_display_name_remote (location);
      fmb_dialogs_show_error (GTK_WIDGET (browser), error, _("Failed to open \"%s\""), name);
      g_free (name);
    }
}
...
static void
fmb_shortcuts_view_poke_device_finish (FmbBrowser *browser,
                                          FmbDevice  *device,
                                          FmbFile    *mount_point,
                                          GError        *error,
                                          gpointer       user_data)
{
  ...
  if (error == NULL)
    {
      fmb_browser_poke_file (browser, mount_point, GTK_WIDGET (browser),
                                fmb_shortcuts_view_poke_file_finish,
                                user_data);
    }
  else
    {
  ...
  child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
  fmb_shortcuts_model_set_busy (FMB_SHORTCUTS_MODEL (child_model), device, FALSE);
}



static void
fmb_shortcuts_view_open (FmbShortcutsView *view,
                            OpenTarget           open_in)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      gtk_tree_model_get (model, &iter,
                          FMB_SHORTCUTS_MODEL_COLUMN_FILE, &file,
                          FMB_SHORTCUTS_MODEL_COLUMN_DEVICE, &device,
                          FMB_SHORTCUTS_MODEL_COLUMN_LOCATION, &location,
                          -1);
      ...
      if (G_LIKELY (device != NULL))
        {
          /* start the spinner */
          child_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
          fmb_shortcuts_model_set_busy (FMB_SHORTCUTS_MODEL (child_model), device, TRUE);

          fmb_browser_poke_device (FMB_BROWSER (view), device, view,
                                      fmb_shortcuts_view_poke_device_finish,
                                      GUINT_TO_POINTER (open_in));
        }
      else if (file != NULL)
        {
          fmb_browser_poke_file (FMB_BROWSER (view), file, view,
                                    fmb_shortcuts_view_poke_file_finish,
                                    GUINT_TO_POINTER (open_in));
        }
      else if (location != NULL)
        {
          fmb_browser_poke_location (FMB_BROWSER (view), location, view,
                                        fmb_shortcuts_view_poke_location_finish,
                                        GUINT_TO_POINTER (open_in));
        }
...
static void
fmb_shortcuts_view_open_in_new_window_clicked (FmbShortcutsView *view)
{
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_VIEW (view));
  fmb_shortcuts_view_open (view, OPEN_IN_WINDOW);
}



static void
fmb_shortcuts_view_open_in_new_tab_clicked (FmbShortcutsView *view)
{
  _fmb_return_if_fail (FMB_IS_SHORTCUTS_VIEW (view));
  fmb_shortcuts_view_open (view, OPEN_IN_TAB);
}



static void
fmb_shortcuts_view_empty_trash (FmbShortcutsView *view)
{
  FmbApplication *application;
...
static void
fmb_shortcuts_view_create_shortcut (FmbShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      gtk_tree_model_get (model, &iter, FMB_SHORTCUTS_MODEL_COLUMN_DEVICE, &device, -1);
      _fmb_return_if_fail (FMB_IS_DEVICE (device));
      ...
      if (mount_point != NULL)
        {
          shortcuts_model = gtk_tree_model_filter_get_model (GTK_TREE_MODEL_FILTER (model));
          fmb_shortcuts_model_add (FMB_SHORTCUTS_MODEL (shortcuts_model), NULL, mount_point);
          g_object_unref (mount_point);
        }
...
static void
fmb_shortcuts_view_eject_finish (FmbDevice *device,
                                    const GError *error,
                                    gpointer      user_data)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (user_data);
  gchar               *device_name;
  GtkTreeModel        *model;
  GtkTreeModel        *child_model;
...
static void
fmb_shortcuts_view_eject (FmbShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      fmb_device_eject (device,
                           mount_operation,
                           NULL,
                           fmb_shortcuts_view_eject_finish,
                           g_object_ref (view));
...
static void
fmb_shortcuts_view_poke_device_mount_finish (FmbBrowser *browser,
                                                FmbDevice  *device,
                                                FmbFile    *mount_point,
                                                GError        *error,
                                                gpointer       ignored)
...
static void
fmb_shortcuts_view_mount (FmbShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
      ...
      if (G_LIKELY (device != NULL))
        {
          ...
          fmb_browser_poke_device (FMB_BROWSER (view), device, view,
                                      fmb_shortcuts_view_poke_device_mount_finish,
                                      NULL);
          g_object_unref (device);
        }
    }
...
static void
fmb_shortcuts_view_unmount_finish (FmbDevice *device,
                                      const GError *error,
                                      gpointer      user_data)
{
  FmbShortcutsView *view = FMB_SHORTCUTS_VIEW (user_data);
...
static void
fmb_shortcuts_view_unmount (FmbShortcutsView *view)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  GtkTreeIter       iter;
  ...
  if (gtk_tree_selection_get_selected (selection, &model, &iter))
    {
      ...
      fmb_device_unmount (device,
                             mount_operation,
                             NULL,
                             fmb_shortcuts_view_unmount_finish,
                             g_object_ref (view));
...
/**
 * fmb_shortcuts_view_new:
 *
 * Allocates a new #FmbShortcutsView instance and associates
 * it with the default #FmbShortcutsModel instance.
 *
 * Return value: the newly allocated #FmbShortcutsView instance.
 **/
GtkWidget*
fmb_shortcuts_view_new (void)
{
  FmbShortcutsModel *model;
  GtkWidget            *view;
  GtkTreeModel         *filter_model;

  model = fmb_shortcuts_model_get_default ();
  filter_model = gtk_tree_model_filter_new (GTK_TREE_MODEL (model), NULL);
  gtk_tree_model_filter_set_visible_column (GTK_TREE_MODEL_FILTER (filter_model), FMB_SHORTCUTS_MODEL_COLUMN_VISIBLE);
  g_object_unref (G_OBJECT (model));

  view = g_object_new (FMB_TYPE_SHORTCUTS_VIEW, "model", filter_model, NULL);
...
/**
 * fmb_shortcuts_view_select_by_file:
 * @view : a #FmbShortcutsView instance.
 * @file : a #FmbFile instance.
 *
 * Looks up the first shortcut that refers to @file in @view and selects it.
 * If @file is not present in the underlying #FmbShortcutsModel, no
 * shortcut will be selected afterwards.
 **/
void
fmb_shortcuts_view_select_by_file (FmbShortcutsView *view,
                                      FmbFile          *file)
{
  GtkTreeSelection *selection;
  GtkTreeModel     *model;
  ...
  if (fmb_shortcuts_model_iter_for_file (FMB_SHORTCUTS_MODEL (child_model), file, &child_iter)
