...
#ifndef __FMB_PRIVATE_H__
#define __FMB_PRIVATE_H__
...
#ifndef NDEBUG
#define _fmb_assert(expr)                  g_assert (expr)
#define _fmb_assert_not_reached()          g_assert_not_reached ()
#define _fmb_return_if_fail(expr)          g_return_if_fail (expr)
#define _fmb_return_val_if_fail(expr, val) g_return_val_if_fail (expr, (val))
#else
#define _fmb_assert(expr)                  G_STMT_START{ (void)0; }G_STMT_END
#define _fmb_assert_not_reached()          G_STMT_START{ (void)0; }G_STMT_END
#define _fmb_return_if_fail(expr)          G_STMT_START{ (void)0; }G_STMT_END
#define _fmb_return_val_if_fail(expr, val) G_STMT_START{ (void)0; }G_STMT_END
#endif
