 ...
 **/
void
fmb_gtk_action_set_tooltip (GtkAction   *action,
                               const gchar *format,
                               ...)
{
  va_list var_args;
  ...
  _fmb_return_if_fail (g_utf8_validate (format, -1, NULL));
...
/**
 * fmb_gtk_action_group_set_action_sensitive:
 ...
 **/
void
fmb_gtk_action_group_set_action_sensitive (GtkActionGroup *action_group,
                                              const gchar    *action_name,
                                              gboolean        sensitive)
{
  GtkAction *action;

  _fmb_return_if_fail (GTK_IS_ACTION_GROUP (action_group));
  _fmb_return_if_fail (action_name != NULL && *action_name != '\0');
...
/**
 * fmb_gtk_label_set_a11y_relation:
 * @label  : a #GtkLabel.
 * @widget : a #GtkWidget.
 *
 ...
 **/
void
fmb_gtk_label_set_a11y_relation (GtkLabel  *label,
                                    GtkWidget *widget)
{
  ...
  _fmb_return_if_fail (GTK_IS_LABEL (label));
                     ...
                     guint32             activate_time)
{
  ...
  _fmb_return_if_fail (GTK_IS_MENU (menu));
...
/**
 * fmb_gtk_ui_manager_get_action_by_name:
 ...
 **/
GtkAction*
fmb_gtk_ui_manager_get_action_by_name (GtkUIManager *ui_manager,
                                          const gchar  *action_name)
{
  GtkAction *action;
  GList     *lp;

  _fmb_return_val_if_fail (GTK_IS_UI_MANAGER (ui_manager), NULL);
  _fmb_return_val_if_fail (action_name != NULL, NULL);
 ...
 **/
void
fmb_gtk_widget_set_tooltip (GtkWidget   *widget,
                               const gchar *format,
                               ...)
{
  va_list  var_args;
