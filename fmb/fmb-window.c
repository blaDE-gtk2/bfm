...
static void     fmb_window_dispose                     (GObject                *object);
static void     fmb_window_finalize                    (GObject                *object);
static void     fmb_window_get_property                (GObject                *object,
                                                           guint                   prop_id,
                                                           GValue                 *value,
                                                           GParamSpec             *pspec);
static void     fmb_window_set_property                (GObject                *object,
                                                           guint                   prop_id,
                                                           const GValue           *value,
                                                           GParamSpec             *pspec);
static gboolean fmb_window_back                        (FmbWindow           *window);
static gboolean fmb_window_reload                      (FmbWindow           *window,
                                                           gboolean                reload_info);
static gboolean fmb_window_toggle_sidepane             (FmbWindow           *window);
static gboolean fmb_window_toggle_menubar              (FmbWindow           *window);
static void     fmb_window_toggle_menubar_deactivate   (GtkWidget              *menubar,
                                                           FmbWindow           *window);
static gboolean fmb_window_zoom_in                     (FmbWindow           *window);
static gboolean fmb_window_zoom_out                    (FmbWindow           *window);
static gboolean fmb_window_zoom_reset                  (FmbWindow           *window);
static gboolean fmb_window_tab_change                  (FmbWindow           *window,
                                                           gint                    nth);
static void     fmb_window_realize                     (GtkWidget              *widget);
static void     fmb_window_unrealize                   (GtkWidget              *widget);
static gboolean fmb_window_configure_event             (GtkWidget              *widget,
                                                           GdkEventConfigure      *event);
static void     fmb_window_notebook_switch_page        (GtkWidget              *notebook,
                                                           GtkWidget              *page,
                                                           guint                   page_num,
                                                           FmbWindow           *window);
static void     fmb_window_notebook_page_added         (GtkWidget              *notebook,
                                                           GtkWidget              *page,
                                                           guint                   page_num,
                                                           FmbWindow           *window);
static void     fmb_window_notebook_page_removed       (GtkWidget              *notebook,
                                                           GtkWidget              *page,
                                                           guint                   page_num,
                                                           FmbWindow           *window);
static gboolean fmb_window_notebook_button_press_event (GtkWidget              *notebook,
                                                           GdkEventButton         *event,
                                                           FmbWindow           *window);
static gboolean fmb_window_notebook_popup_menu         (GtkWidget              *notebook,
                                                           FmbWindow           *window);
static gpointer fmb_window_notebook_create_window      (GtkWidget              *notebook,
                                                           GtkWidget              *page,
                                                           gint                    x,
                                                           gint                    y,
                                                           FmbWindow           *window);
static void     fmb_window_notebook_insert             (FmbWindow           *window,
                                                           FmbFile             *directory);
static void     fmb_window_merge_custom_preferences    (FmbWindow           *window);
static gboolean fmb_window_bookmark_merge              (gpointer                user_data);
static void     fmb_window_merge_go_actions            (FmbWindow           *window);
static void     fmb_window_install_location_bar        (FmbWindow           *window,
                                                           GType                   type);
static void     fmb_window_install_sidepane            (FmbWindow           *window,
                                                           GType                   type);
static void     fmb_window_start_open_location         (FmbWindow           *window,
                                                           const gchar            *initial_text);
static void     fmb_window_action_open_new_tab         (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_new_window      (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_empty_trash          (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_detach_tab           (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_close_all_windows    (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_close_tab            (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_close_window         (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_preferences          (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_reload               (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_pathbar_changed      (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_toolbar_changed      (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_shortcuts_changed    (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_tree_changed         (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_statusbar_changed    (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_menubar_changed      (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_zoom_in              (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_zoom_out             (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_zoom_reset           (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_view_changed         (GtkRadioAction         *action,
                                                           GtkRadioAction         *current,
                                                           FmbWindow           *window);
static void     fmb_window_action_go_up                (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_home            (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_desktop         (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_templates       (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_file_system     (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_trash           (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_network         (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_bookmark        (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_open_location        (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_contents             (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_about                (GtkAction              *action,
                                                           FmbWindow           *window);
static void     fmb_window_action_show_hidden          (GtkToggleAction        *action,
                                                           FmbWindow           *window);
static void     fmb_window_current_directory_changed   (FmbFile             *current_directory,
                                                           FmbWindow           *window);
static void     fmb_window_connect_proxy               (GtkUIManager           *manager,
                                                           GtkAction              *action,
                                                           GtkWidget              *proxy,
                                                           FmbWindow           *window);
static void     fmb_window_disconnect_proxy            (GtkUIManager           *manager,
                                                           GtkAction              *action,
                                                           GtkWidget              *proxy,
                                                           FmbWindow           *window);
static void     fmb_window_menu_item_selected          (GtkWidget              *menu_item,
                                                           FmbWindow           *window);
static void     fmb_window_menu_item_deselected        (GtkWidget              *menu_item,
                                                           FmbWindow           *window);
static void     fmb_window_update_custom_actions       (FmbView             *view,
                                                           GParamSpec             *pspec,
                                                           FmbWindow           *window);
static void     fmb_window_notify_loading              (FmbView             *view,
                                                           GParamSpec             *pspec,
                                                           FmbWindow           *window);
static void     fmb_window_device_pre_unmount          (FmbDeviceMonitor    *device_monitor,
                                                           FmbDevice           *device,
                                                           GFile                  *root_file,
                                                           FmbWindow           *window);
static void     fmb_window_device_changed              (FmbDeviceMonitor    *device_monitor,
                                                           FmbDevice           *device,
                                                           FmbWindow           *window);
static gboolean fmb_window_merge_idle                  (gpointer                user_data);
static void     fmb_window_merge_idle_destroy          (gpointer                user_data);
static gboolean fmb_window_save_paned                  (FmbWindow           *window);
static gboolean fmb_window_save_geometry_timer         (gpointer                user_data);
static void     fmb_window_save_geometry_timer_destroy (gpointer                user_data);
static void     fmb_window_set_zoom_level              (FmbWindow           *window,
                                                           FmbZoomLevel         zoom_level);



struct _FmbWindowClass
{
  GtkWindowClass __parent__;

  /* internal action signals */
  gboolean (*back)            (FmbWindow *window);
  gboolean (*reload)          (FmbWindow *window,
                               gboolean      reload_info);
  gboolean (*toggle_sidepane) (FmbWindow *window);
  gboolean (*toggle_menubar)  (FmbWindow *window);
  gboolean (*zoom_in)         (FmbWindow *window);
  gboolean (*zoom_out)        (FmbWindow *window);
  gboolean (*zoom_reset)      (FmbWindow *window);
  gboolean (*tab_change)      (FmbWindow *window,
                               gint          idx);
};
...
static GtkActionEntry action_entries[] =
{
  ...
  { "new-tab", "tab-new", N_ ("New _Tab"), "<control>T", N_ ("Open a new tab for the displayed location"), G_CALLBACK (fmb_window_action_open_new_tab), },
  { "new-window", "window-new", N_ ("New _Window"), "<control>N", N_ ("Open a new Fmb window for the displayed location"), G_CALLBACK (fmb_window_action_open_new_window), },
  { "sendto-menu", NULL, N_ ("_Send To"), NULL, },
  { "empty-trash", NULL, N_ ("_Empty Trash"), NULL, N_ ("Delete all files and folders in the Trash"), G_CALLBACK (fmb_window_action_empty_trash), },
  { "detach-tab", NULL, N_ ("Detac_h Tab"), NULL, N_ ("Open current folder in a new window"), G_CALLBACK (fmb_window_action_detach_tab), },
  { "close-all-windows", NULL, N_ ("Close _All Windows"), "<control><shift>W", N_ ("Close all Fmb windows"), G_CALLBACK (fmb_window_action_close_all_windows), },
  { "close-tab", "window-close", N_ ("C_lose Tab"), "<control>W", N_ ("Close this folder"), G_CALLBACK (fmb_window_action_close_tab), },
  { "close-window", "application-exit", N_ ("_Close Window"), "<control>Q", N_ ("Close this window"), G_CALLBACK (fmb_window_action_close_window), },
  { "edit-menu", NULL, N_ ("_Edit"), NULL, },
  { "preferences", "preferences-system", N_ ("Pr_eferences..."), NULL, N_ ("Edit Fmbs Preferences"), G_CALLBACK (fmb_window_action_preferences), },
  { "view-menu", NULL, N_ ("_View"), NULL, },
  { "reload", "view-refresh", N_ ("_Reload"), "<control>R", N_ ("Reload the current folder"), G_CALLBACK (fmb_window_action_reload), },
  { "view-location-selector-menu", NULL, N_ ("_Location Selector"), NULL, },
  { "view-side-pane-menu", NULL, N_ ("_Side Pane"), NULL, },
  { "zoom-in", "zoom-in", N_ ("Zoom I_n"), "<control>plus", N_ ("Show the contents in more detail"), G_CALLBACK (fmb_window_action_zoom_in), },
  { "zoom-out", "zoom-out", N_ ("Zoom _Out"), "<control>minus", N_ ("Show the contents in less detail"), G_CALLBACK (fmb_window_action_zoom_out), },
  { "zoom-reset", "zoom-original", N_ ("Normal Si_ze"), "<control>0", N_ ("Show the contents at the normal size"), G_CALLBACK (fmb_window_action_zoom_reset), },
  { "go-menu", NULL, N_ ("_Go"), NULL, },
  { "open-parent", "go-up", N_ ("Open _Parent"), "<alt>Up", N_ ("Open the parent folder"), G_CALLBACK (fmb_window_action_go_up), },
  { "open-home", "go-home", N_ ("_Home"), "<alt>Home", N_ ("Go to the home folder"), G_CALLBACK (fmb_window_action_open_home), },
  { "open-desktop", FMB_STOCK_DESKTOP, N_ ("Desktop"), NULL, N_ ("Go to the desktop folder"), G_CALLBACK (fmb_window_action_open_desktop), },
  { "open-file-system", "drive-harddisk", N_ ("File System"), NULL, N_ ("Browse the file system"), G_CALLBACK (fmb_window_action_open_file_system), },
  { "open-network", "network-workgroup", N_("B_rowse Network"), NULL, N_ ("Browse local network connections"), G_CALLBACK (fmb_window_action_open_network), },
  { "open-templates", FMB_STOCK_TEMPLATES, N_("T_emplates"), NULL, N_ ("Go to the templates folder"), G_CALLBACK (fmb_window_action_open_templates), },
  { "open-location", NULL, N_ ("_Open Location..."), "<control>L", N_ ("Specify a location to open"), G_CALLBACK (fmb_window_action_open_location), },
  { "help-menu", NULL, N_ ("_Help"), NULL, },
  { "contents", "help-browser", N_ ("_Contents"), "F1", N_ ("Display Fmb user manual"), G_CALLBACK (fmb_window_action_contents), },
  { "about", "help-about", N_ ("_About"), NULL, N_ ("Display information about Fmb"), G_CALLBACK (fmb_window_action_about), },
};

static const GtkToggleActionEntry toggle_action_entries[] =
{
  { "show-hidden", NULL, N_ ("Show _Hidden Files"), "<control>H", N_ ("Toggles the display of hidden files in the current window"), G_CALLBACK (fmb_window_action_show_hidden), FALSE, },
  { "view-location-selector-pathbar", NULL, N_ ("_Pathbar Style"), NULL, N_ ("Modern approach with buttons that correspond to folders"), G_CALLBACK (fmb_window_action_pathbar_changed), FALSE, },
  { "view-location-selector-toolbar", NULL, N_ ("_Toolbar Style"), NULL, N_ ("Traditional approach with location bar and navigation buttons"), G_CALLBACK (fmb_window_action_toolbar_changed), FALSE, },
  { "view-side-pane-shortcuts", NULL, N_ ("_Shortcuts"), "<control>B", N_ ("Toggles the visibility of the shortcuts pane"), G_CALLBACK (fmb_window_action_shortcuts_changed), FALSE, },
  { "view-side-pane-tree", NULL, N_ ("_Tree"), "<control>E", N_ ("Toggles the visibility of the tree pane"), G_CALLBACK (fmb_window_action_tree_changed), FALSE, },
  { "view-statusbar", NULL, N_ ("St_atusbar"), NULL, N_ ("Change the visibility of this window's statusbar"), G_CALLBACK (fmb_window_action_statusbar_changed), FALSE, },
  { "view-menubar", NULL, N_ ("_Menubar"), "<control>M", N_ ("Change the visibility of this window's menubar"), G_CALLBACK (fmb_window_action_menubar_changed), TRUE, },
};
...
G_DEFINE_TYPE_WITH_CODE (FmbWindow, fmb_window, GTK_TYPE_WINDOW,
                         G_IMPLEMENT_INTERFACE (FMB_TYPE_BROWSER, NULL))



static void
fmb_window_class_init (FmbWindowClass *klass)
{
  ...
  gobject_class->dispose = fmb_window_dispose;
  gobject_class->finalize = fmb_window_finalize;
  gobject_class->get_property = fmb_window_get_property;
  gobject_class->set_property = fmb_window_set_property;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->realize = fmb_window_realize;
  gtkwidget_class->unrealize = fmb_window_unrealize;
  gtkwidget_class->configure_event = fmb_window_configure_event;

  klass->back = fmb_window_back;
  klass->reload = fmb_window_reload;
  klass->toggle_sidepane = fmb_window_toggle_sidepane;
  klass->toggle_menubar = fmb_window_toggle_menubar;
  klass->zoom_in = fmb_window_zoom_in;
  klass->zoom_out = fmb_window_zoom_out;
  klass->zoom_reset = fmb_window_zoom_reset;
  klass->tab_change = fmb_window_tab_change;

  /**
   * FmbWindow:current-directory:
   *
   * The directory currently displayed within this #FmbWindow
   * or %NULL.
   **/
  ...
  /**
   * FmbWindow:ui-manager:
   *
   * The #GtkUIManager used for this #FmbWindow. This property
  ...
  /**
   * FmbWindow:zoom-level:
   *
   * The #FmbZoomLevel applied to the #FmbView currently
  ...
  window_signals[BACK] =
    g_signal_new (I_("back"),
                  ...
                  G_STRUCT_OFFSET (FmbWindowClass, back),
  ...
  window_signals[RELOAD] =
    g_signal_new (I_("reload"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, reload),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__BOOLEAN,
                  G_TYPE_BOOLEAN, 1,
                  G_TYPE_BOOLEAN);

  /**
   * FmbWindow::toggle-sidepane:
   * @window : a #FmbWindow instance.
   *
  ...
  window_signals[TOGGLE_SIDEPANE] =
    g_signal_new (I_("toggle-sidepane"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, toggle_sidepane),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__VOID,
                  G_TYPE_BOOLEAN, 0);

  /**
   * FmbWindow::toggle-menubar:
   * @window : a #FmbWindow instance.
   *
   * Emitted whenever the user toggles the visibility of the
  ...
  window_signals[TOGGLE_MENUBAR] =
    g_signal_new (I_("toggle-menubar"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, toggle_menubar),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__VOID,
                  G_TYPE_BOOLEAN, 0);
  ...
  window_signals[ZOOM_IN] =
    g_signal_new (I_("zoom-in"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, zoom_in),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__VOID,
                  G_TYPE_BOOLEAN, 0);
  ...
  window_signals[ZOOM_OUT] =
    g_signal_new (I_("zoom-out"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, zoom_out),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__VOID,
                  G_TYPE_BOOLEAN, 0);

  /**
   * FmbWindow::zoom-reset:
   * @window : a #FmbWindow instance.
   *
  ...
  window_signals[ZOOM_RESET] =
    g_signal_new (I_("zoom-reset"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, zoom_reset),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__VOID,
                  G_TYPE_BOOLEAN, 0);

  /**
   * FmbWindow::tab-change:
   * @window : a #FmbWindow instance.
   * @idx    : tab index,
   *
  ...
  window_signals[TAB_CHANGE] =
    g_signal_new (I_("tab-change"),
                  G_TYPE_FROM_CLASS (klass),
                  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
                  G_STRUCT_OFFSET (FmbWindowClass, tab_change),
                  g_signal_accumulator_true_handled, NULL,
                  _fmb_marshal_BOOLEAN__INT,
                  G_TYPE_BOOLEAN, 1,
                  G_TYPE_INT);
...
view_type2index (GType type)
{
  ...
  if (sizeof (GType) == sizeof (gint))
  ...
  else
    {
      ...
      if (G_LIKELY (type == FMB_TYPE_COMPACT_VIEW))
        return 0;
      else if (type == FMB_TYPE_DETAILS_VIEW)
        return 1;
      else
        return 2;
    }
...
view_index2type (gint idx)
{
  ...
  if (sizeof (GType) == sizeof (gint))
  ...
  else
    {
      ...
      switch (idx)
        {
        case 0:  return FMB_TYPE_COMPACT_VIEW;
        case 1:  return FMB_TYPE_DETAILS_VIEW;
        default: return FMB_TYPE_ICON_VIEW;
        }
    }
}
...
static void
fmb_window_init (FmbWindow *window)
{
  ...
  window->provider_factory = fmbx_provider_factory_get_default ();

  /* grab a reference on the preferences */
  window->preferences = fmb_preferences_get ();
  ...
  window->device_monitor = fmb_device_monitor_get ();
  g_signal_connect (window->device_monitor, "device-pre-unmount", G_CALLBACK (fmb_window_device_pre_unmount), window);
  g_signal_connect (window->device_monitor, "device-removed", G_CALLBACK (fmb_window_device_changed), window);
  g_signal_connect (window->device_monitor, "device-changed", G_CALLBACK (fmb_window_device_changed), window);

  /* allocate a closure for the menu_item_selected() callback */
  window->menu_item_selected_closure = g_cclosure_new_object (G_CALLBACK (fmb_window_menu_item_selected), G_OBJECT (window));
  ...
  window->menu_item_deselected_closure = g_cclosure_new_object (G_CALLBACK (fmb_window_menu_item_deselected), G_OBJECT (window));
  g_closure_ref (window->menu_item_deselected_closure);
  g_closure_sink (window->menu_item_deselected_closure);
  window->icon_factory = fmb_icon_factory_get_default ();

  /* setup the action group for this window */
  window->action_group = gtk_action_group_new ("FmbWindow");
  ...
  radio_action = gtk_radio_action_new ("view-as-icons", _("View as _Icons"), _("Display folder content in an icon view"),
                                       NULL, view_type2index (FMB_TYPE_ICON_VIEW));
  ...
  radio_action = gtk_radio_action_new ("view-as-detailed-list", _("View as _Detailed List"), _("Display folder content in a detailed list view"),
                                       NULL, view_type2index (FMB_TYPE_DETAILS_VIEW));
  ...
  radio_action = gtk_radio_action_new ("view-as-compact-list", _("View as _Compact List"), _("Display folder content in a compact list view"),
                                       NULL, view_type2index (FMB_TYPE_COMPACT_VIEW));
  ...
  g_signal_connect (G_OBJECT (window->ui_manager), "connect-proxy", G_CALLBACK (fmb_window_connect_proxy), window);
  g_signal_connect (G_OBJECT (window->ui_manager), "disconnect-proxy", G_CALLBACK (fmb_window_disconnect_proxy), window);
  gtk_ui_manager_insert_action_group (window->ui_manager, window->action_group, 0);
  gtk_ui_manager_add_ui_from_string (window->ui_manager, fmb_window_ui, fmb_window_ui_length, NULL);

  accel_group = gtk_ui_manager_get_accel_group (window->ui_manager);
  gtk_window_add_accel_group (GTK_WINDOW (window), accel_group);

  /* setup the launcher support */
  window->launcher = fmb_launcher_new ();
  fmb_launcher_set_widget (window->launcher, GTK_WIDGET (window));
  fmb_component_set_ui_manager (FMB_COMPONENT (window->launcher), window->ui_manager);
  blxo_binding_new (G_OBJECT (window), "current-directory", G_OBJECT (window->launcher), "current-directory");
  g_signal_connect_swapped (G_OBJECT (window->launcher), "change-directory", G_CALLBACK (fmb_window_set_current_directory), window);
  g_signal_connect_swapped (G_OBJECT (window->launcher), "open-new-tab", G_CALLBACK (fmb_window_notebook_insert), window);
  ...
  g_signal_connect (G_OBJECT (window->menubar), "deactivate", G_CALLBACK (fmb_window_toggle_menubar_deactivate), window);
  ...
  blxo_binding_new (G_OBJECT (window->spinner), "active",
  ...
  g_signal_connect_swapped (window->paned, "accept-position", G_CALLBACK (fmb_window_save_paned), window);
  g_signal_connect_swapped (window->paned, "button-release-event", G_CALLBACK (fmb_window_save_paned), window);
  ...
  g_signal_connect (G_OBJECT (window->notebook), "switch-page", G_CALLBACK (fmb_window_notebook_switch_page), window);
  g_signal_connect (G_OBJECT (window->notebook), "page-added", G_CALLBACK (fmb_window_notebook_page_added), window);
  g_signal_connect (G_OBJECT (window->notebook), "page-removed", G_CALLBACK (fmb_window_notebook_page_removed), window);
  g_signal_connect_after (G_OBJECT (window->notebook), "button-press-event", G_CALLBACK (fmb_window_notebook_button_press_event), window);
  g_signal_connect (G_OBJECT (window->notebook), "popup-menu", G_CALLBACK (fmb_window_notebook_popup_menu), window);
  g_signal_connect (G_OBJECT (window->notebook), "create-window", G_CALLBACK (fmb_window_notebook_create_window), window);
  ...
  gtk_notebook_set_group_name (GTK_NOTEBOOK (window->notebook), "fmb-tabs");
  ...
  if (blxo_str_is_equal (last_location_bar, g_type_name (FMB_TYPE_LOCATION_BUTTONS)))
    type = FMB_TYPE_LOCATION_BUTTONS;
  else if (blxo_str_is_equal (last_location_bar, g_type_name (FMB_TYPE_LOCATION_ENTRY)))
    type = FMB_TYPE_LOCATION_ENTRY;
  else
    type = G_TYPE_NONE;
  ...
  gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (type == FMB_TYPE_LOCATION_BUTTONS));
  action = gtk_action_group_get_action (window->action_group, "view-location-selector-toolbar");
  gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (type == FMB_TYPE_LOCATION_ENTRY));

  /* determine the selected side pane (FIXME: Should probably be last-shortcuts-visible and last-tree-visible preferences) */
  if (blxo_str_is_equal (last_side_pane, g_type_name (FMB_TYPE_SHORTCUTS_PANE)))
    type = FMB_TYPE_SHORTCUTS_PANE;
  else if (blxo_str_is_equal (last_side_pane, g_type_name (FMB_TYPE_TREE_PANE)))
    type = FMB_TYPE_TREE_PANE;
  else
    type = G_TYPE_NONE;
  ...
  gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (type == FMB_TYPE_SHORTCUTS_PANE));
  action = gtk_action_group_get_action (window->action_group, "view-side-pane-tree");
  gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (type == FMB_TYPE_TREE_PANE));
  ...
  g_signal_connect (G_OBJECT (action), "changed", G_CALLBACK (fmb_window_action_view_changed), window);

  /* schedule asynchronous menu action merging */
  window->merge_idle_id = g_idle_add_full (G_PRIORITY_LOW + 20, fmb_window_merge_idle, window, fmb_window_merge_idle_destroy);
}



static void
fmb_window_dispose (GObject *object)
{
  FmbWindow *window = FMB_WINDOW (object);
  ...
  fmb_window_set_current_directory (window, NULL);

  (*G_OBJECT_CLASS (fmb_window_parent_class)->dispose) (object);
}



static void
fmb_window_finalize (GObject *object)
{
  FmbWindow *window = FMB_WINDOW (object);
  ...
  (*G_OBJECT_CLASS (fmb_window_parent_class)->finalize) (object);
}



static void
fmb_window_get_property (GObject    *object,
                            guint       prop_id,
                            GValue     *value,
                            GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_CURRENT_DIRECTORY:
      g_value_set_object (value, fmb_window_get_current_directory (window));
      break;
...
static void
fmb_window_set_property (GObject            *object,
                            guint               prop_id,
                            const GValue       *value,
                            GParamSpec         *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_CURRENT_DIRECTORY:
      fmb_window_set_current_directory (window, g_value_get_object (value));
      break;

    case PROP_ZOOM_LEVEL:
      fmb_window_set_zoom_level (window, g_value_get_enum (value));
      break;
...
static gboolean
fmb_window_back (FmbWindow *window)
{
  GtkAction   *action;
  GdkEvent    *event;
  ...
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
  ...
  if (event != NULL
    ...
    {
      action = fmb_gtk_ui_manager_get_action_by_name (window->ui_manager, "open-parent");
  ...
  action = fmb_gtk_ui_manager_get_action_by_name (window->ui_manager, "back");
  if (G_LIKELY (action != NULL))
    {
...
static gboolean
fmb_window_reload (FmbWindow *window,
                      gboolean      reload_info)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
  ...
  if (G_LIKELY (window->view != NULL))
    {
      fmb_view_reload (FMB_VIEW (window->view), reload_info);
      return TRUE;
    }
...
static gboolean
fmb_window_toggle_sidepane (FmbWindow *window)
{
  GtkAction *action;
  gchar     *type_name;
      ...
      if (G_UNLIKELY (window->toggle_sidepane_type == G_TYPE_INVALID))
        {
          ...
          if (blxo_str_is_equal (type_name, g_type_name (FMB_TYPE_TREE_PANE)))
            window->toggle_sidepane_type = FMB_TYPE_TREE_PANE;
          else
            window->toggle_sidepane_type = FMB_TYPE_SHORTCUTS_PANE;
          g_free (type_name);
        }

      /* activate the given side pane */
      action = gtk_action_group_get_action (window->action_group, "view-side-pane-shortcuts");
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (window->toggle_sidepane_type == FMB_TYPE_SHORTCUTS_PANE));
      action = gtk_action_group_get_action (window->action_group, "view-side-pane-tree");
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (action), (window->toggle_sidepane_type == FMB_TYPE_TREE_PANE));
    }
...
static gboolean
fmb_window_toggle_menubar (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
...
static void
fmb_window_toggle_menubar_deactivate (GtkWidget    *menubar,
                                         FmbWindow *window)
{
  GtkAction *action;

  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  _fmb_return_if_fail (window->menubar == menubar);
...
static gboolean
fmb_window_zoom_in (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);

  /* check if we can still zoom in */
  if (G_LIKELY (window->zoom_level < FMB_ZOOM_N_LEVELS - 1))
    {
      fmb_window_set_zoom_level (window, window->zoom_level + 1);
      return TRUE;
    }
...
static gboolean
fmb_window_zoom_out (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
...
static gboolean
fmb_window_zoom_reset (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
  ...
  if (G_LIKELY (window->view != NULL))
    {
      fmb_view_reset_zoom_level (FMB_VIEW (window->view));
      return TRUE;
    }
...
static gboolean
fmb_window_tab_change (FmbWindow *window,
                          gint          nth)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
...
static void
fmb_window_realize (GtkWidget *widget)
{
  FmbWindow *window = FMB_WINDOW (widget);

  /* let the GtkWidget class perform the realize operation */
  (*GTK_WIDGET_CLASS (fmb_window_parent_class)->realize) (widget);
   ...
   */
  window->clipboard = fmb_clipboard_manager_get_for_display (gtk_widget_get_display (widget));
...
static void
fmb_window_unrealize (GtkWidget *widget)
{
  FmbWindow *window = FMB_WINDOW (widget);
  ...
  (*GTK_WIDGET_CLASS (fmb_window_parent_class)->unrealize) (widget);
}



static gboolean
fmb_window_configure_event (GtkWidget         *widget,
                               GdkEventConfigure *event)
{
  FmbWindow *window = FMB_WINDOW (widget);
      ...
      if (gtk_widget_get_visible (widget))
        {
          ...
          window->save_geometry_timer_id = g_timeout_add_seconds_full (G_PRIORITY_LOW, 1, fmb_window_save_geometry_timer,
                                                                       window, fmb_window_save_geometry_timer_destroy);
        }
    }

  /* let Gtk+ handle the configure event */
  return (*GTK_WIDGET_CLASS (fmb_window_parent_class)->configure_event) (widget, event);
}



static void
fmb_window_binding_destroyed (gpointer data,
                                 GObject  *binding)
{
  FmbWindow *window = FMB_WINDOW (data);
...
static void
fmb_window_binding_create (FmbWindow *window,
                              gpointer src_object,
                              ...
                              GBindingFlags flags)
{
  ...
  _fmb_return_if_fail (G_IS_OBJECT (src_object));
  _fmb_return_if_fail (G_IS_OBJECT (dst_object));

  binding = g_object_bind_property (G_OBJECT (src_object), src_prop,
                                    G_OBJECT (dst_object), dst_prop,
                                    flags);

  g_object_weak_ref (G_OBJECT (binding), fmb_window_binding_destroyed, window);
...
static void
fmb_window_notebook_switch_page (GtkWidget    *notebook,
                                    GtkWidget    *page,
                                    guint         page_num,
                                    FmbWindow *window)
{
  ...
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  _fmb_return_if_fail (GTK_IS_NOTEBOOK (notebook));
  _fmb_return_if_fail (FMB_IS_VIEW (page));
  _fmb_return_if_fail (window->notebook == notebook);
  ...
  if (G_LIKELY (window->view != NULL))
    {
      ...
      fmb_component_set_ui_manager (FMB_COMPONENT (window->view), NULL);
  ...
  current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (page));
  fmb_window_set_current_directory (window, current_directory);

  /* activate the selected view */
  action = gtk_action_group_get_action (window->action_group, "view-as-icons");
  g_signal_handlers_block_by_func (action, fmb_window_action_view_changed, window);
  gtk_radio_action_set_current_value (GTK_RADIO_ACTION (action), view_type2index (G_OBJECT_TYPE (page)));
  g_signal_handlers_unblock_by_func (action, fmb_window_action_view_changed, window);

  /* add stock bindings */
  fmb_window_binding_create (window, window, "current-directory", page, "current-directory", G_BINDING_DEFAULT);
  fmb_window_binding_create (window, window, "show-hidden", page, "show-hidden", G_BINDING_SYNC_CREATE);
  fmb_window_binding_create (window, page, "loading", window->spinner, "active", G_BINDING_SYNC_CREATE);
  fmb_window_binding_create (window, page, "selected-files", window->launcher, "selected-files", G_BINDING_SYNC_CREATE);
  fmb_window_binding_create (window, page, "zoom-level", window, "zoom-level", G_BINDING_SYNC_CREATE | G_BINDING_BIDIRECTIONAL);

  /* connect to the location bar (if any) */
  if (G_LIKELY (window->location_bar != NULL))
    {
      fmb_window_binding_create (window, page, "selected-files",
  ...
  if (G_LIKELY (window->statusbar != NULL))
    {
      fmb_window_binding_create (window, page, "statusbar-text",
  ...
  fmb_component_set_ui_manager (FMB_COMPONENT (page), window->ui_manager);

  /* update the actions */
  fmb_standard_view_selection_changed (FMB_STANDARD_VIEW (page));
...
static void
fmb_window_notebook_show_tabs (FmbWindow *window)
{
  gint       n_pages;
...
static void
fmb_window_notebook_page_added (GtkWidget    *notebook,
                                   GtkWidget    *page,
                                   guint         page_num,
                                   FmbWindow *window)
{
  ...
  /* connect signals */
  g_signal_connect (G_OBJECT (page), "notify::loading", G_CALLBACK (fmb_window_notify_loading), window);
  g_signal_connect (G_OBJECT (page), "notify::selected-files", G_CALLBACK (fmb_window_update_custom_actions), window);
  g_signal_connect_swapped (G_OBJECT (page), "start-open-location", G_CALLBACK (fmb_window_start_open_location), window);
  g_signal_connect_swapped (G_OBJECT (page), "change-directory", G_CALLBACK (fmb_window_set_current_directory), window);
  g_signal_connect_swapped (G_OBJECT (page), "open-new-tab", G_CALLBACK (fmb_window_notebook_insert), window);

  /* update tab visibility */
  fmb_window_notebook_show_tabs (window);
...
static void
fmb_window_notebook_page_removed (GtkWidget    *notebook,
                                     GtkWidget    *page,
                                     guint         page_num,
                                     FmbWindow *window)
{
  ...
  /* remove from the ui */
  fmb_component_set_ui_manager (FMB_COMPONENT (page), NULL);
...
static void
fmb_window_notebook_popup_menu_real (FmbWindow *window,
                                        guint32       timestamp,
                                        gint          button)
{
  GtkWidget *menu;
  ...
  fmb_gtk_menu_run (GTK_MENU (menu), GTK_WIDGET (window),
...
static gboolean
fmb_window_notebook_button_press_event (GtkWidget      *notebook,
                                           GdkEventButton *event,
                                           FmbWindow   *window)
{
  gint           page_num = 0;
      ...
      && event->type == GDK_BUTTON_PRESS)
    {
      ...
      if (event->button == 2)
      ...
      else if (event->button == 3)
        {
          ...
          /* show the tab menu */
          fmb_window_notebook_popup_menu_real (window, event->time, event->button);
        }
...
static gboolean
fmb_window_notebook_popup_menu (GtkWidget    *notebook,
                                   FmbWindow *window)
{
  fmb_window_notebook_popup_menu_real (window, gtk_get_current_event_time (), 0);
  return TRUE;
}
...
static gpointer
fmb_window_notebook_create_window (GtkWidget    *notebook,
                                      GtkWidget    *page,
                                      gint          x,
                                      gint          y,
                                      FmbWindow *window)
{
  ...
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), NULL);
  _fmb_return_val_if_fail (GTK_IS_NOTEBOOK (notebook), NULL);
  _fmb_return_val_if_fail (window->notebook == notebook, NULL);
  _fmb_return_val_if_fail (FMB_IS_VIEW (page), NULL);
  ...
  new_window = fmb_application_open_window (application, NULL, screen, NULL);
  ...
  return FMB_WINDOW (new_window)->notebook;
}



static void
fmb_window_notebook_insert (FmbWindow *window,
                               FmbFile   *directory)
{
  FmbHistory  *history = NULL;
  GtkWidget      *view;
  gint            page_num;
  GtkWidget      *label;
  GtkWidget      *label_box;
  ...
  _fmb_return_if_fail (window->view_type != G_TYPE_NONE);
  ...
  if (FMB_IS_STANDARD_VIEW (window->view))
    history = fmb_standard_view_copy_history (FMB_STANDARD_VIEW (window->view));
  ...
  if (history != NULL)
    fmb_standard_view_set_history (FMB_STANDARD_VIEW (view), history);

  label_box = gtk_hbox_new (FALSE, 0);

  label = gtk_label_new (NULL);
  blxo_binding_new (G_OBJECT (view), "display-name", G_OBJECT (label), "label");
  blxo_binding_new (G_OBJECT (view), "tooltip-text", G_OBJECT (label), "tooltip-text");
...
void
fmb_window_update_directories (FmbWindow *window,
                                  ...
                                  FmbFile   *new_directory)
{
  ...
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  _fmb_return_if_fail (FMB_IS_FILE (old_directory));
  _fmb_return_if_fail (FMB_IS_FILE (new_directory));
  ...
  for (n = 0; n < n_pages; n++)
    {
      ...
      if (! FMB_IS_NAVIGATOR (view))
        continue;

      /* get the directory of the view */
      directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (view));
      if (! FMB_IS_FILE (directory))
        continue;
      ...
      if (directory == old_directory)
        {
          if (n == active_page)
            fmb_navigator_change_directory (FMB_NAVIGATOR (view), new_directory);
          else
            fmb_navigator_set_current_directory (FMB_NAVIGATOR (view), new_directory);
        }
    }
}
...
static void
fmb_window_install_location_bar (FmbWindow *window,
                                    GType         type)
{
  GtkToolItem *item;
  gboolean     small_icons;

  _fmb_return_if_fail (type == G_TYPE_NONE || g_type_is_a (type, FMB_TYPE_LOCATION_BAR));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  ...
  if (G_UNLIKELY (window->location_bar != NULL))
    {
      ...
      if (!fmb_location_bar_is_standalone (FMB_LOCATION_BAR (window->location_bar)))
        {
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      blxo_binding_new (G_OBJECT (window), "current-directory", G_OBJECT (window->location_bar), "current-directory");
      g_signal_connect_swapped (G_OBJECT (window->location_bar), "change-directory", G_CALLBACK (fmb_window_set_current_directory), window);
      g_signal_connect_swapped (G_OBJECT (window->location_bar), "open-new-tab", G_CALLBACK (fmb_window_notebook_insert), window);

      /* connect the location widget to the view (if any) */
      if (G_LIKELY (window->view != NULL))
        fmb_window_binding_create (window, window->view, "selected-files", window->location_bar, "selected-files", G_BINDING_SYNC_CREATE);
...
static void
fmb_window_install_sidepane (FmbWindow *window,
                                GType         type)
{
  _fmb_return_if_fail (type == G_TYPE_NONE || g_type_is_a (type, FMB_TYPE_SIDE_PANE));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      fmb_component_set_ui_manager (FMB_COMPONENT (window->sidepane), window->ui_manager);
      blxo_binding_new (G_OBJECT (window), "show-hidden", G_OBJECT (window->sidepane), "show-hidden");
      blxo_binding_new (G_OBJECT (window), "current-directory", G_OBJECT (window->sidepane), "current-directory");
      g_signal_connect_swapped (G_OBJECT (window->sidepane), "change-directory", G_CALLBACK (fmb_window_set_current_directory), window);
      g_signal_connect_swapped (G_OBJECT (window->sidepane), "open-new-tab", G_CALLBACK (fmb_window_notebook_insert), window);
      ...
      if (G_LIKELY (window->view != NULL))
        fmb_window_binding_create (window, window->view, "selected-files", window->sidepane, "selected-files", G_BINDING_SYNC_CREATE);
    }
...
static void
fmb_window_merge_custom_preferences (FmbWindow *window)
{
  GList *providers;
  GList *actions;
  GList *ap, *pp;
  ...
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  _fmb_return_if_fail (window->custom_preferences_merge_id == 0);

  /* determine the available preferences providers */
  providers = fmbx_provider_factory_list_providers (window->provider_factory, FMBX_TYPE_PREFERENCES_PROVIDER);
      ...
      for (pp = providers; pp != NULL; pp = pp->next)
        {
          ...
          actions = fmbx_preferences_provider_get_actions (FMBX_PREFERENCES_PROVIDER (pp->data), GTK_WIDGET (window));
...
static void
fmb_window_bookmark_changed (FmbWindow *window)
{
  _fmb_return_if_fail (FMB_IS_WINDOW (window));

  if (window->bookmark_reload_idle_id == 0)
    window->bookmark_reload_idle_id = g_idle_add (fmb_window_bookmark_merge, window);
}



static void
fmb_window_bookmark_release_file (gpointer data)
{
  FmbFile *file = FMB_FILE (data);
  ...
  g_signal_handlers_disconnect_matched (file,
                                        ...
                                        0, NULL,
                                        G_CALLBACK (fmb_window_bookmark_changed),
                                        NULL);
...
static void
fmb_window_bookmark_merge_line (GFile       *file_path,
                                   const gchar *name,
                                   gint         line_num,
                                   gpointer     user_data)
{
  FmbWindow *window = FMB_WINDOW (user_data);
  ...
  if (g_file_has_uri_scheme (file_path, "file"))
      ...
      if (G_UNLIKELY (fmb_file_is_directory (file)))
        {
          ...
          icon_name = fmb_file_get_icon_name (file, FMB_FILE_ICON_STATE_DEFAULT, icon_theme);
          gtk_action_set_icon_name (action, icon_name);
          g_object_set_data_full (G_OBJECT (action), I_("fmb-file"), file,
                                  fmb_window_bookmark_release_file);

          /* watch the file */
          fmb_file_watch (file);

          g_signal_connect_swapped (G_OBJECT (file), "destroy",
                                    G_CALLBACK (fmb_window_bookmark_changed), window);
  ...
  else
    {
      if (name == NULL)
        {
          remote_name = fmb_g_file_get_display_name_remote (file_path);
          name = remote_name;
        }
  ...
  if (G_LIKELY (action != NULL))
    {
      if (gtk_action_group_get_action (window->bookmark_action_group, unique_name) == NULL)
        {
          /* connect action */
          g_signal_connect (G_OBJECT (action), "activate", G_CALLBACK (fmb_window_action_open_bookmark), window);
...
static gboolean
fmb_window_bookmark_merge (gpointer user_data)
{
  FmbWindow *window = FMB_WINDOW (user_data);
  ...
  if (window->bookmark_file == NULL)
    {
      window->bookmark_file = fmb_g_file_new_for_bookmarks ();
  ...
  window->bookmark_action_group = gtk_action_group_new ("FmbBookmarks");
  gtk_ui_manager_insert_action_group (window->ui_manager, window->bookmark_action_group, -1);

  /* collect bookmarks */
  fmb_util_load_bookmarks (window->bookmark_file,
                              fmb_window_bookmark_merge_line,
                              window);
...
static void
fmb_window_merge_go_actions (FmbWindow *window)
{
  GtkAction *action;

  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  _fmb_return_if_fail (window->go_items_actions_merge_id == 0);
  ...
  if (fmb_g_vfs_is_uri_scheme_supported ("trash"))
    {
      ...
      action = fmb_trash_action_new ();
      g_signal_connect (G_OBJECT (action), "activate", G_CALLBACK (fmb_window_action_open_trash), window);
  ...
  gtk_action_set_visible (action, fmb_g_vfs_is_uri_scheme_supported ("network"));
}



static void
fmb_window_open_or_launch (FmbWindow *window,
                              FmbFile   *file)
{
  GError *error = NULL;
  ...
  if (fmb_file_is_directory (file))
    {
      ...
      fmb_window_set_current_directory (window, file);
    }
  else
    {
      /* try to launch the selected file */
      if (!fmb_file_launch (file, window, NULL, &error))
        {
          fmb_dialogs_show_error (window, error, _("Failed to launch \"%s\""),
...
static void
fmb_window_poke_file_finish (FmbBrowser *browser,
                                FmbFile    *file,
                                FmbFile    *target_file,
                                GError        *error,
                                gpointer       ignored)
{
  _fmb_return_if_fail (FMB_IS_WINDOW (browser));
  _fmb_return_if_fail (FMB_IS_FILE (file));

  if (error == NULL)
    {
      fmb_window_open_or_launch (FMB_WINDOW (browser), target_file);
    }
  else
    {
      fmb_dialogs_show_error (GTK_WIDGET (browser), error,
                                 _("Failed to open \"%s\""),
                                 fmb_file_get_display_name (file));
    }
}
...
static void
fmb_window_start_open_location (FmbWindow *window,
                                   const gchar  *initial_text)
{
   ...
   */
  if (window->location_bar == NULL || !fmb_location_bar_accept_focus (FMB_LOCATION_BAR (window->location_bar), initial_text))
    {
      /* allocate the "Open Location" dialog */
      dialog = fmb_location_dialog_new ();
      gtk_window_set_modal (GTK_WINDOW (dialog), TRUE);
      gtk_window_set_destroy_with_parent (GTK_WINDOW (dialog), TRUE);
      gtk_window_set_transient_for (GTK_WINDOW (dialog), GTK_WINDOW (window));
      fmb_location_dialog_set_working_directory (FMB_LOCATION_DIALOG (dialog),
                                                    fmb_window_get_current_directory (window));
      fmb_location_dialog_set_selected_file (FMB_LOCATION_DIALOG (dialog),
                                                fmb_window_get_current_directory (window));
      ...
      if (G_UNLIKELY (initial_text != NULL))
        {
          ...
          gtk_widget_grab_focus (FMB_LOCATION_DIALOG (dialog)->entry);
          gtk_entry_set_text (GTK_ENTRY (FMB_LOCATION_DIALOG (dialog)->entry), initial_text);
          gtk_editable_set_position (GTK_EDITABLE (FMB_LOCATION_DIALOG (dialog)->entry), -1);
        }
      ...
      if (gtk_dialog_run (GTK_DIALOG (dialog)) == GTK_RESPONSE_ACCEPT)
        {
          ...
          selected_file = fmb_location_dialog_get_selected_file (FMB_LOCATION_DIALOG (dialog));
          if (selected_file != NULL)
            {
              fmb_browser_poke_file (FMB_BROWSER (window), selected_file, window,
                                        fmb_window_poke_file_finish, NULL);
            }
        }
...
static void
fmb_window_action_open_new_tab (GtkAction    *action,
                                   FmbWindow *window)
{
  /* insert new tab with current directory as default */
  fmb_window_notebook_insert (window, fmb_window_get_current_directory (window));
}



static void
fmb_window_action_open_new_window (GtkAction    *action,
                                      FmbWindow *window)
{
  FmbApplication *application;
  FmbHistory     *history;
  FmbWindow      *new_window;
  FmbFile        *start_file;

  /* popup a new window */
  application = fmb_application_get ();
  new_window = FMB_WINDOW (fmb_application_open_window (application, window->current_directory,
  ...
  history = fmb_standard_view_copy_history (FMB_STANDARD_VIEW (window->view));
  if (history != NULL)
    fmb_standard_view_set_history (FMB_STANDARD_VIEW (new_window->view), history);

  /* determine the first visible file in the current window */
  if (fmb_view_get_visible_range (FMB_VIEW (window->view), &start_file, NULL))
    {
      /* scroll the new window to the same file */
      fmb_window_scroll_to_file (new_window, start_file, FALSE, TRUE, 0.1f, 0.1f);
...
static void
fmb_window_action_empty_trash (GtkAction    *action,
                                  FmbWindow *window)
{
  FmbApplication *application;
  ...
  application = fmb_application_get ();
  fmb_application_empty_trash (application, GTK_WIDGET (window), NULL);
  g_object_unref (G_OBJECT (application));
}
...
static void
fmb_window_action_detach_tab (GtkAction    *action,
                                 FmbWindow *window)
{
  GtkWidget *notebook;
  GtkWidget *label;
  ...
  /* create a new window */
  notebook = fmb_window_notebook_create_window (window->notebook, view, -1, -1, window);
  if (notebook == NULL)
    return;

  /* get the current label */
  label = gtk_notebook_get_tab_label (GTK_NOTEBOOK (window->notebook), view);
  _fmb_return_if_fail (GTK_IS_WIDGET (label));
...
static void
fmb_window_action_close_all_windows (GtkAction    *action,
                                        FmbWindow *window)
{
  FmbApplication *application;
  GList             *windows;
  ...
  application = fmb_application_get ();
  windows = fmb_application_get_windows (application);
  g_object_unref (G_OBJECT (application));
...
static void
fmb_window_action_close_tab (GtkAction    *action,
                                FmbWindow *window)
{
  if (window->view != NULL)
...
static void
fmb_window_action_close_window (GtkAction    *action,
                                   FmbWindow *window)
{
  gtk_widget_destroy (GTK_WIDGET (window));
}
...
static void
fmb_window_action_preferences (GtkAction    *action,
                                  FmbWindow *window)
{
  GtkWidget         *dialog;
  FmbApplication *application;
  ...
  dialog = fmb_preferences_dialog_new (GTK_WINDOW (window));
...
static void
fmb_window_action_reload (GtkAction    *action,
                             FmbWindow *window)
{
  gboolean result;
...
static void
fmb_window_action_pathbar_changed (GtkToggleAction *action,
                                      FmbWindow    *window)
{
  GtkAction *other_action;
  GType      type;

  _fmb_return_if_fail (GTK_IS_TOGGLE_ACTION (action));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));

  /* determine the new type of location bar */
  type = gtk_toggle_action_get_active (action) ? FMB_TYPE_LOCATION_BUTTONS : G_TYPE_NONE;

  /* install the new location bar */
  fmb_window_install_location_bar (window, type);
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      g_signal_handlers_block_by_func (G_OBJECT (other_action), fmb_window_action_toolbar_changed, window);
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (other_action), FALSE);
      g_signal_handlers_unblock_by_func (G_OBJECT (other_action), fmb_window_action_toolbar_changed, window);
    }
}
...
static void
fmb_window_action_toolbar_changed (GtkToggleAction *action,
                                      FmbWindow    *window)
{
  GtkAction *other_action;
  GType      type;
  ...
  /* determine the new type of location bar */
  type = gtk_toggle_action_get_active (action) ? FMB_TYPE_LOCATION_ENTRY : G_TYPE_NONE;
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      g_signal_handlers_block_by_func (G_OBJECT (other_action), fmb_window_action_pathbar_changed, window);
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (other_action), FALSE);
      g_signal_handlers_unblock_by_func (G_OBJECT (other_action), fmb_window_action_pathbar_changed, window);
    }
}
...
static void
fmb_window_action_shortcuts_changed (GtkToggleAction *action,
                                        FmbWindow    *window)
{
  GtkAction *other_action;
  GType      type;
  ...
  type = gtk_toggle_action_get_active (action) ? FMB_TYPE_SHORTCUTS_PANE : G_TYPE_NONE;

  /* install the new sidepane */
  fmb_window_install_sidepane (window, type);
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      g_signal_handlers_block_by_func (G_OBJECT (other_action), fmb_window_action_tree_changed, window);
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (other_action), FALSE);
      g_signal_handlers_unblock_by_func (G_OBJECT (other_action), fmb_window_action_tree_changed, window);
    }
}
...
static void
fmb_window_action_tree_changed (GtkToggleAction *action,
                                   FmbWindow    *window)
{
  GtkAction *other_action;
  GType      type;
  ...
  /* determine the new type of side pane */
  type = gtk_toggle_action_get_active (action) ? FMB_TYPE_TREE_PANE : G_TYPE_NONE;
  ...
  if (G_LIKELY (type != G_TYPE_NONE))
    {
      ...
      g_signal_handlers_block_by_func (G_OBJECT (other_action), fmb_window_action_shortcuts_changed, window);
      gtk_toggle_action_set_active (GTK_TOGGLE_ACTION (other_action), FALSE);
      g_signal_handlers_unblock_by_func (G_OBJECT (other_action), fmb_window_action_shortcuts_changed, window);
    }
}
...
static void
fmb_window_action_statusbar_changed (GtkToggleAction *action,
                                        FmbWindow    *window)
{
  gboolean active;
  ...
  if (!active && window->statusbar != NULL)
  ...
  else if (active && window->statusbar == NULL)
    {
      ...
      window->statusbar = fmb_statusbar_new ();
      ...
      if (G_LIKELY (window->view != NULL))
        fmb_window_binding_create (window, window->view, "statusbar-text", window->statusbar, "text", G_BINDING_SYNC_CREATE);
    }
...
static void
fmb_window_action_menubar_changed (GtkToggleAction *action,
                                      FmbWindow    *window)
{
  gboolean active;
...
static void
fmb_window_action_zoom_in (GtkAction    *action,
                              FmbWindow *window)
{
  gboolean result;
...
static void
fmb_window_action_zoom_out (GtkAction    *action,
                               FmbWindow *window)
{
  gboolean result;
...
static void
fmb_window_action_zoom_reset (GtkAction    *action,
                                 FmbWindow *window)
{
  gboolean result;
...
static void
fmb_window_action_view_changed (GtkRadioAction *action,
                                   GtkRadioAction *current,
                                   FmbWindow   *window)
{
  FmbFile     *file = NULL;
  ...
  if (G_LIKELY (window->view != NULL))
    {
      ...
      if (!fmb_view_get_visible_range (FMB_VIEW (window->view), &file, NULL))
        file = NULL;

      /* store the active directory */
      current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (window->view));
      if (current_directory != NULL)
        g_object_ref (current_directory);

      /* remember the file selection */
      selected_files = fmb_g_file_list_copy (fmb_component_get_selected_files (FMB_COMPONENT (old_view)));
  ...
  if (G_LIKELY (window->view_type != G_TYPE_NONE))
    {
      /* create new page */
      if (current_directory != NULL)
        fmb_window_notebook_insert (window, current_directory);

      /* scroll to the previously visible file in the old view */
      if (G_UNLIKELY (file != NULL))
        fmb_view_scroll_to_file (FMB_VIEW (window->view), file, FALSE, TRUE, 0.0f, 0.0f);
    }
  else
    {
  ...
  fmb_component_set_selected_files (FMB_COMPONENT (window->view), selected_files);
...
static void
fmb_window_action_go_up (GtkAction    *action,
                            FmbWindow *window)
{
  FmbFile *parent;
  GError     *error = NULL;

  parent = fmb_file_get_parent (window->current_directory, &error);
  if (G_LIKELY (parent != NULL))
    {
      fmb_window_set_current_directory (window, parent);
      g_object_unref (G_OBJECT (parent));
    }
  else
    {
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to open parent folder"));
      g_error_free (error);
    }
}
...
static void
fmb_window_action_open_home (GtkAction    *action,
                                FmbWindow *window)
{
  GFile         *home;
  FmbFile    *home_file;
  ...
  home_file = fmb_file_get (home, &error);
  if (G_UNLIKELY (home_file == NULL))
    {
      /* display an error to the user */
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to open the home folder"));
      g_error_free (error);
    }
  else
    {
      /* open the home folder */
      fmb_window_set_current_directory (window, home_file);
...
static gboolean
fmb_window_open_user_folder (GtkAction      *action,
                                FmbWindow   *window,
                                GUserDirectory  fmb_user_dir,
                                const gchar    *default_name)
{
  FmbFile  *user_file = NULL;
  ...
  path = g_get_user_special_dir (fmb_user_dir);
  ...
  user_file = fmb_file_get (user_dir, NULL);

  /* check if the directory exists */
  if (G_UNLIKELY (user_file == NULL || !fmb_file_exists (user_file)))
    {
      ...
      if (response == GTK_RESPONSE_YES
        ...
        {
          /* try again */
          user_file = fmb_file_get (user_dir, &error);
        }
    }
  ...
  if (G_LIKELY (user_file != NULL))
    {
      /* open the folder */
      fmb_window_set_current_directory (window, user_file);
    ...
    {
      parse_name = g_file_get_parse_name (user_dir);
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to open directory \"%s\""), parse_name);
      g_free (parse_name);
      g_error_free (error);
    }
...
static void
fmb_window_action_open_desktop (GtkAction     *action,
                                   FmbWindow  *window)
{
  _fmb_return_if_fail (GTK_IS_ACTION (action));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));

  fmb_window_open_user_folder (action, window,
...
static void
fmb_window_action_open_templates (GtkAction    *action,
                                     FmbWindow *window)
{
  GtkWidget     *dialog;
  GtkWidget     *button;
  ...
  success = fmb_window_open_user_folder (action,window,
  ...
  if (G_UNLIKELY(show_about_templates && success))
    {
      ...
      label = gtk_label_new (_("If you frequently create certain kinds "
                             ...
                             "folder. Fmb will add an entry for this document in the"
      ...
      blxo_mutual_binding_new_with_negation (G_OBJECT (window->preferences), "misc-show-about-templates", G_OBJECT (button), "active");
...
static void
fmb_window_action_open_file_system (GtkAction    *action,
                                       FmbWindow *window)
{
  GFile         *root;
  FmbFile    *root_file;
  ...
  root_file = fmb_file_get (root, &error);
  if (G_UNLIKELY (root_file == NULL))
    {
      /* display an error to the user */
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to open the file system root folder"));
      g_error_free (error);
    }
  else
    {
      /* open the root folder */
      fmb_window_set_current_directory (window, root_file);
...
static void
fmb_window_action_open_trash (GtkAction    *action,
                                 FmbWindow *window)
{
  GFile      *trash_bin;
  FmbFile *trash_bin_file;
  GError     *error = NULL;
  ...
  trash_bin_file = fmb_file_get (trash_bin, &error);
  if (G_UNLIKELY (trash_bin_file == NULL))
    {
      /* display an error to the user */
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to display the contents of the trash can"));
      g_error_free (error);
    }
  else
    {
      /* open the trash folder */
      fmb_window_set_current_directory (window, trash_bin_file);
...
static void
fmb_window_action_open_network (GtkAction    *action,
                                   FmbWindow *window)
{
  FmbFile *network_file;
  GError     *error = NULL;
  GFile      *network;
  ...
  network_file = fmb_file_get (network, &error);
  if (G_UNLIKELY (network_file == NULL))
    {
      /* display an error to the user */
      fmb_dialogs_show_error (GTK_WIDGET (window), error, _("Failed to browse the network"));
      g_error_free (error);
    }
  else
    {
      /* open the network root location */
      fmb_window_set_current_directory (window, network_file);
...
static void
fmb_window_poke_location_finish (FmbBrowser *browser,
                                    GFile         *location,
                                    FmbFile    *file,
                                    FmbFile    *target_file,
                                    GError        *error,
                                    gpointer       ignored)
{
  ...
  fmb_window_poke_file_finish (browser, file, target_file, error, ignored);
}



static void
fmb_window_action_open_bookmark (GtkAction    *action,
                                    FmbWindow *window)
{
  FmbFile *local_file;
  GFile      *remote_file;
  ...
  local_file = g_object_get_data (G_OBJECT (action), I_("fmb-file"));
  if (local_file != NULL)
    {
      fmb_window_set_current_directory (window, local_file);
      return;
    }
  ...
  if (remote_file != NULL)
    {
      fmb_browser_poke_location (FMB_BROWSER (window), remote_file, window,
                                    fmb_window_poke_location_finish, NULL);
    }
}
...
static void
fmb_window_action_open_location (GtkAction    *action,
                                    FmbWindow *window)
{
  /* just use the "start-open-location" callback */
  fmb_window_start_open_location (window, NULL);
}



static void
fmb_window_action_contents (GtkAction    *action,
                               FmbWindow *window)
{
  /* display the documentation index */
  xfce_dialog_show_help (GTK_WINDOW (window), "fmb", NULL, NULL);
}



static void
fmb_window_action_about (GtkAction    *action,
                            FmbWindow *window)
{
  /* just popup the about dialog */
  fmb_dialogs_show_about (GTK_WINDOW (window), PACKAGE_NAME,
                             _("Fmb is a fast and easy to use file manager\n"
...
static void
fmb_window_action_show_hidden (GtkToggleAction *action,
                                  FmbWindow    *window)
{
  _fmb_return_if_fail (GTK_IS_TOGGLE_ACTION (action));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
...
static void
fmb_window_current_directory_changed (FmbFile   *current_directory,
                                         FmbWindow *window)
{
  GtkIconTheme *icon_theme;
  GtkAction    *action;
  ...
  _fmb_return_if_fail (window->current_directory == current_directory);

  /* update the "Empty Trash" action */
  action = gtk_action_group_get_action (window->action_group, "empty-trash");
  gtk_action_set_sensitive (action, (fmb_file_get_item_count (current_directory) > 0));
  gtk_action_set_visible (action, (fmb_file_is_root (current_directory) && fmb_file_is_trashed (current_directory)));
  ...
  if (G_UNLIKELY (show_full_path))
    name = parse_name = g_file_get_parse_name (fmb_file_get_file (current_directory));
  else
    name = fmb_file_get_display_name (current_directory);
  ...
  /* set window icon */
  icon_theme = gtk_icon_theme_get_for_screen (gtk_window_get_screen (GTK_WINDOW (window)));
  icon_name = fmb_file_get_icon_name (current_directory,
...
static void
fmb_window_connect_proxy (GtkUIManager *manager,
                             GtkAction    *action,
                             GtkWidget    *proxy,
                             FmbWindow *window)
{
...
static void
fmb_window_disconnect_proxy (GtkUIManager *manager,
                                GtkAction    *action,
                                GtkWidget    *proxy,
                                FmbWindow *window)
{
...
static void
fmb_window_menu_item_selected (GtkWidget    *menu_item,
                                  FmbWindow *window)
{
  GtkAction   *action;
  const gchar *tooltip;
...
static void
fmb_window_menu_item_deselected (GtkWidget    *menu_item,
                                    FmbWindow *window)
{
  gint id;
...
static void
fmb_window_update_custom_actions (FmbView   *view,
                                     GParamSpec   *pspec,
                                     FmbWindow *window)
{
  FmbFile *folder;
  ...
  providers = fmbx_provider_factory_list_providers (window->provider_factory,
                                                       FMBX_TYPE_MENU_PROVIDER);
  if (G_LIKELY (providers != NULL))
    {
      /* grab a reference to the current directory of the window */
      folder = fmb_window_get_current_directory (window);

      /* get a list of selected files */
      selected_files = fmb_component_get_selected_files (FMB_COMPONENT (view));
      ...
      for (lp = providers; lp != NULL; lp = lp->next)
        {
          if (G_LIKELY (selected_files != NULL))
            {
              tmp = fmbx_menu_provider_get_file_actions (lp->data,
                                                            GTK_WIDGET (window),
                                                            selected_files);
            }
          else if (G_LIKELY (folder != NULL))
            {
              tmp = fmbx_menu_provider_get_folder_actions (lp->data,
                                                              GTK_WIDGET (window),
                                                              FMBX_FILE_INFO (folder));
            }
          else
            {
              tmp = NULL;
  ...
  if (G_LIKELY (actions != NULL))
    {
      ...
      window->custom_actions = gtk_action_group_new ("FmbActions");
...
static void
fmb_window_notify_loading (FmbView   *view,
                              GParamSpec   *pspec,
                              FmbWindow *window)
{
  GdkCursor *cursor;
...
static void
fmb_window_device_pre_unmount (FmbDeviceMonitor *device_monitor,
                                  FmbDevice        *device,
                                  GFile               *root_file,
                                  FmbWindow        *window)
{
  ...
  _fmb_return_if_fail (FMB_IS_DEVICE_MONITOR (device_monitor));
  _fmb_return_if_fail (window->device_monitor == device_monitor);
  _fmb_return_if_fail (FMB_IS_DEVICE (device));
  _fmb_return_if_fail (G_IS_FILE (root_file));
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  ...
  if (fmb_file_is_gfile_ancestor (window->current_directory, root_file))
    {
...
static void
fmb_window_device_changed (FmbDeviceMonitor *device_monitor,
                              FmbDevice        *device,
                              FmbWindow        *window)
{
  GFile *root_file;
  ...
  if (root_file != NULL)
    {
      fmb_window_device_pre_unmount (device_monitor, device, root_file, window);
...
static gboolean
fmb_window_merge_idle (gpointer user_data)
{
  FmbWindow *window = FMB_WINDOW (user_data);

  /* merge custom preferences from the providers */
  GDK_THREADS_ENTER ();
  fmb_window_merge_custom_preferences (window);
  fmb_window_merge_go_actions (window);
  GDK_THREADS_LEAVE ();

  fmb_window_bookmark_merge (window);
...
static void
fmb_window_merge_idle_destroy (gpointer user_data)
{
  FMB_WINDOW (user_data)->merge_idle_id = 0;
}



static gboolean
fmb_window_save_paned (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
...
static gboolean
fmb_window_save_geometry_timer (gpointer user_data)
{
...
static void
fmb_window_save_geometry_timer_destroy (gpointer user_data)
{
  FMB_WINDOW (user_data)->save_geometry_timer_id = 0;
}



/**
 * fmb_window_set_zoom_level:
 * @window     : a #FmbWindow instance.
 ...
 **/
void
fmb_window_set_zoom_level (FmbWindow   *window,
                              FmbZoomLevel zoom_level)
{
  _fmb_return_if_fail (FMB_IS_WINDOW (window));
  ...
  fmb_gtk_action_group_set_action_sensitive (window->action_group, "zoom-in", (zoom_level < FMB_ZOOM_N_LEVELS - 1));
  fmb_gtk_action_group_set_action_sensitive (window->action_group, "zoom-out", (zoom_level > 0));
}



/**
 * fmb_window_get_current_directory:
 * @window : a #FmbWindow instance.
 *
 * Queries the #FmbFile instance, which represents the directory
 ...
 **/
FmbFile*
fmb_window_get_current_directory (FmbWindow *window)
{
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), NULL);
...
/**
 * fmb_window_set_current_directory:
 * @window            : a #FmbWindow instance.
 * @current_directory : the new directory or %NULL.
 **/
void
fmb_window_set_current_directory (FmbWindow *window,
                                     FmbFile   *current_directory)
{
  GType       type;
  GtkAction  *action;
  ...
  if (G_LIKELY (window->current_directory != NULL))
    {
      ...
      g_signal_handlers_disconnect_by_func (G_OBJECT (window->current_directory), fmb_window_current_directory_changed, window);
  ...
  if (G_LIKELY (current_directory != NULL))
    {
      ...
      g_signal_connect (G_OBJECT (current_directory), "changed", G_CALLBACK (fmb_window_current_directory_changed), window);
      ...
      if (gtk_notebook_get_n_pages (GTK_NOTEBOOK (window->notebook)) == 0)
        {
          ...
          action = gtk_action_group_get_action (window->action_group, "view-as-icons");
          g_signal_handlers_block_by_func (action, fmb_window_action_view_changed, window);
          gtk_radio_action_set_current_value (GTK_RADIO_ACTION (action), view_type2index (g_type_is_a (type, FMB_TYPE_VIEW) ? type : FMB_TYPE_ICON_VIEW));
          fmb_window_action_view_changed (GTK_RADIO_ACTION (action), GTK_RADIO_ACTION (action), window);
          g_signal_handlers_unblock_by_func (action, fmb_window_action_view_changed, window);
        }

      /* update window icon and title */
      fmb_window_current_directory_changed (current_directory, window);
  ...
  fmb_gtk_action_group_set_action_sensitive (window->action_group, "new-window", (current_directory != NULL));
  fmb_gtk_action_group_set_action_sensitive (window->action_group, "new-tab", (current_directory != NULL));

  /* enable the 'Up' action if possible for the new directory */
  fmb_gtk_action_group_set_action_sensitive (window->action_group, "open-parent", (current_directory != NULL
                                                && fmb_file_has_parent (current_directory)));
 ...
 **/
void
fmb_window_scroll_to_file (FmbWindow *window,
                              FmbFile   *file,
                              ...
                              gfloat        col_align)
{
  ...
  if (G_LIKELY (window->view != NULL))
    fmb_view_scroll_to_file (FMB_VIEW (window->view), file, select_file, use_align, row_align, col_align);
}



gchar **
fmb_window_get_directories (FmbWindow *window,
                               gint         *active_page)
{
  gint         n;
  gint         n_pages;
  ...
  for (n = 0; n < n_pages; n++)
    {
      /* get the view */
      view = gtk_notebook_get_nth_page (GTK_NOTEBOOK (window->notebook), n);
      _fmb_return_val_if_fail (FMB_IS_NAVIGATOR (view), FALSE);

      /* get the directory of the view */
      directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (view));
      _fmb_return_val_if_fail (FMB_IS_FILE (directory), FALSE);

      /* add to array */
      uris[n] = fmb_file_dup_uri (directory);
    }
...
gboolean
fmb_window_set_directories (FmbWindow   *window,
                               gchar         **uris,
                               gint            active_page)
{
  FmbFile *directory;
  ...
  _fmb_return_val_if_fail (FMB_IS_WINDOW (window), FALSE);
  _fmb_return_val_if_fail (uris != NULL, FALSE);

  for (n = 0; uris[n] != NULL; n++)
    {
      /* check if the string looks like an uri */
      if (!blxo_str_looks_like_an_uri (uris[n]))
        continue;

      /* get the file for the uri */
      directory = fmb_file_get_for_uri (uris[n], NULL);
      if (G_UNLIKELY (directory == NULL))
        continue;

      /* open the directory in a new notebook */
      if (fmb_file_is_directory (directory))
        {
          if (gtk_notebook_get_n_pages (GTK_NOTEBOOK (window->notebook)) == 0)
            fmb_window_set_current_directory (window, directory);
          else
            fmb_window_notebook_insert (window, directory);
        }
