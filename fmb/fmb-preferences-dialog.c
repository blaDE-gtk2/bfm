...
static void fmb_preferences_dialog_finalize   (GObject                      *object);
static void fmb_preferences_dialog_response   (GtkDialog                    *dialog,
                                                  gint                          response);
static void fmb_preferences_dialog_configure  (FmbPreferencesDialog     *dialog);



struct _FmbPreferencesDialogClass
{
  XfceTitledDialogClass __parent__;
};

struct _FmbPreferencesDialog
{
...
G_DEFINE_TYPE (FmbPreferencesDialog, fmb_preferences_dialog, XFCE_TYPE_TITLED_DIALOG)
                              ...
                              gpointer      user_data)
{
  ...
  klass = g_type_class_ref (FMB_TYPE_ICON_SIZE);
                                ...
                                gpointer      user_data)
{
  switch (g_value_get_int (src_value))
    {
    case 0:
      g_value_set_static_string (dst_value, g_type_name (FMB_TYPE_ICON_VIEW));
      break;

    case 1:
      g_value_set_static_string (dst_value, g_type_name (FMB_TYPE_DETAILS_VIEW));
      break;

    case 2:
      g_value_set_static_string (dst_value, g_type_name (FMB_TYPE_COMPACT_VIEW));
      break;
                                   ...
                                   gpointer      user_data)
{
  ...
  klass = g_type_class_ref (FMB_TYPE_THUMBNAIL_MODE);
  for (n = 0; n < klass->n_values; ++n)
    if (klass->values[n].value == g_value_get_enum (src_value))
      g_value_set_int (dst_value, n);
  g_type_class_unref (klass);
...
static void
fmb_preferences_dialog_class_init (FmbPreferencesDialogClass *klass)
{
  GtkDialogClass *gtkdialog_class;
  GObjectClass   *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = fmb_preferences_dialog_finalize;

  gtkdialog_class = GTK_DIALOG_CLASS (klass);
  gtkdialog_class->response = fmb_preferences_dialog_response;
}



static void
fmb_preferences_dialog_init (FmbPreferencesDialog *dialog)
{
  ...
  blxo_mutual_binding_new_full (G_OBJECT (dialog->preferences), "default-view", G_OBJECT (combo), "active",
  ...
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), combo);
  ...
  blxo_mutual_binding_new_full (G_OBJECT (dialog->preferences), "misc-thumbnail-mode", G_OBJECT (combo), "active",
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-folders-first", G_OBJECT (button), "active");
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-file-size-binary", G_OBJECT (button), "active");
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-text-beside-icons", G_OBJECT (button), "active");
  ...
  combo = gtk_combo_box_text_new ();
  for (date_style = FMB_DATE_STYLE_SIMPLE; date_style <= FMB_DATE_STYLE_ISO; ++date_style)
    {
      date = fmb_util_humanize_file_time (time (NULL), date_style);
      gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), date);
      g_free (date);
    }
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-date-style", G_OBJECT (combo), "active");
  gtk_table_attach (GTK_TABLE (table), combo, 1, 2, 0, 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), combo);
  gtk_label_set_mnemonic_widget (GTK_LABEL (label), combo);
  gtk_widget_show (combo);
  ...
  blxo_mutual_binding_new_full (G_OBJECT (dialog->preferences), "shortcuts-icon-size", G_OBJECT (combo), "active",
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "shortcuts-icon-emblems", G_OBJECT (button), "active");
  ...
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Larger"));
  gtk_combo_box_text_append_text (GTK_COMBO_BOX_TEXT (combo), _("Very Large"));
  blxo_mutual_binding_new_full (G_OBJECT (dialog->preferences), "tree-icon-size", G_OBJECT (combo), "active",
                               transform_icon_size_to_index, transform_index_to_icon_size, NULL, NULL);
  gtk_table_attach (GTK_TABLE (table), combo, 1, 2, 0, 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), combo);
  gtk_label_set_mnemonic_widget (GTK_LABEL (label), combo);
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "tree-icon-emblems", G_OBJECT (button), "active");
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-single-click", G_OBJECT (button), "active");
  ...
  blxo_binding_new (G_OBJECT (button), "active", G_OBJECT (align), "sensitive");
  ...
  fmb_gtk_label_set_a11y_relation (GTK_LABEL (label), range);
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-single-click-timeout", G_OBJECT (adjustment), "value");
  ...
  blxo_mutual_binding_new_with_negation (G_OBJECT (dialog->preferences), "misc-single-click", G_OBJECT (button), "active");
  g_signal_connect (G_OBJECT (button), "toggled", G_CALLBACK (g_object_notify), "active");
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-middle-click-in-tab", G_OBJECT (button), "active");
  g_signal_connect (G_OBJECT (button), "toggled", G_CALLBACK (g_object_notify), "active");
  gtk_box_pack_start (GTK_BOX (vbox), button, FALSE, TRUE, 0);
  gtk_widget_show (button);
  ...
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-recursive-permissions", G_OBJECT (combo), "active");
  ...
  /* check if "fmb-volman" is found */
  path = g_find_program_in_path ("fmb-volman");

  /* add check button to enable/disable auto mounting */
  button = gtk_check_button_new_with_mnemonic (_("Enable _Volume Management"));
  blxo_mutual_binding_new (G_OBJECT (dialog->preferences), "misc-volume-management", G_OBJECT (button), "active");
  gtk_table_attach (GTK_TABLE (table), button, 0, 1, 0, 1, GTK_EXPAND | GTK_FILL, GTK_FILL, 0, 0);
  gtk_widget_show (button);

  label = gtk_label_new (NULL);
  gtk_misc_set_alignment (GTK_MISC (label), 0.0f, 0.5f);
  blxo_binding_new (G_OBJECT (button), "active", G_OBJECT (label), "sensitive");
  g_signal_connect_swapped (G_OBJECT (label), "activate-link", G_CALLBACK (fmb_preferences_dialog_configure), dialog);
...
static void
fmb_preferences_dialog_finalize (GObject *object)
{
  FmbPreferencesDialog *dialog = FMB_PREFERENCES_DIALOG (object);

  /* release our reference on the preferences */
  g_object_unref (G_OBJECT (dialog->preferences));

  (*G_OBJECT_CLASS (fmb_preferences_dialog_parent_class)->finalize) (object);
}



static void
fmb_preferences_dialog_response (GtkDialog *dialog,
                                    gint       response)
{
...
static void
fmb_preferences_dialog_configure (FmbPreferencesDialog *dialog)
{
  GError *err = NULL;
  gchar  *argv[3];

  _fmb_return_if_fail (FMB_IS_PREFERENCES_DIALOG (dialog));

  /* prepare the argument vector */
  argv[0] = (gchar *) "fmb-volman";
  argv[1] = (gchar *) "--configure";
  argv[2] = NULL;

  /* invoke the configuration interface of fmb-volman */
  if (!gdk_spawn_on_screen (gtk_widget_get_screen (GTK_WIDGET (dialog)), NULL, argv, NULL, G_SPAWN_SEARCH_PATH, NULL, NULL, NULL, &err))
    {
      /* tell the user that we failed to come up with the fmb-volman configuration dialog */
      fmb_dialogs_show_error (dialog, err, _("Failed to display the volume management settings"));
      g_error_free (err);
    }
}
...
/**
 * fmb_preferences_dialog_new:
 * @parent : a #GtkWindow or %NULL.
 *
 * Allocates a new #FmbPreferencesDialog widget.
 *
 * Return value: the newly allocated #FmbPreferencesDialog.
 **/
GtkWidget*
fmb_preferences_dialog_new (GtkWindow *parent)
{
  GtkWidget    *dialog;
  gint          root_x, root_y;
  ...
  dialog = g_object_new (FMB_TYPE_PREFERENCES_DIALOG, NULL);
