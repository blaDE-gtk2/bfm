...
#include <fmb/fmb-thumbnail-cache-proxy.h>
#endif
...
static void fmb_thumbnail_cache_finalize (GObject *object);



struct _FmbThumbnailCacheClass
{
  GObjectClass __parent__;
};

struct _FmbThumbnailCache
{
  GObject     __parent__;
...
G_DEFINE_TYPE (FmbThumbnailCache, fmb_thumbnail_cache, G_TYPE_OBJECT)



static void
fmb_thumbnail_cache_class_init (FmbThumbnailCacheClass *klass)
{
  GObjectClass *gobject_class;

  /* Determine the parent type class */
  fmb_thumbnail_cache_parent_class = g_type_class_peek_parent (klass);

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = fmb_thumbnail_cache_finalize;
}



static void
fmb_thumbnail_cache_init (FmbThumbnailCache *cache)
{
#ifdef HAVE_DBUS
...
static void
fmb_thumbnail_cache_finalize (GObject *object)
{
#ifdef HAVE_DBUS
  FmbThumbnailCache *cache = FMB_THUMBNAIL_CACHE (object);
  ...
  (*G_OBJECT_CLASS (fmb_thumbnail_cache_parent_class)->finalize) (object);
}
...
#ifdef HAVE_DBUS
static void
fmb_thumbnail_cache_move_copy_async_reply (DBusGProxy *proxy,
                                              GError     *error,
                                              gpointer    user_data)
{
  GList      *li;
  ...
  for (li = user_data; li != NULL; li = li->next)
    {
      file = fmb_file_cache_lookup (G_FILE (li->data));
...
static void
fmb_thumbnail_cache_move_async (FmbThumbnailCache *cache,
                                   const gchar         **source_uris,
                                   const gchar         **target_uris,
                                   gpointer              user_data)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (source_uris != NULL);
  _fmb_return_if_fail (target_uris != NULL);

  /* request a thumbnail cache update asynchronously */
  fmb_thumbnail_cache_proxy_move_async (cache->cache_proxy,
                                           source_uris, target_uris,
                                           fmb_thumbnail_cache_move_copy_async_reply,
                                           user_data);
}
...
static void
fmb_thumbnail_cache_copy_async (FmbThumbnailCache *cache,
                                   const gchar         **source_uris,
                                   const gchar         **target_uris,
                                   gpointer              user_data)
{
  ...
  /* request a thumbnail cache update asynchronously */
  fmb_thumbnail_cache_proxy_copy_async (cache->cache_proxy,
                                           source_uris, target_uris,
                                           fmb_thumbnail_cache_move_copy_async_reply,
                                           user_data);
}
...
static void
fmb_thumbnail_cache_delete_async_reply (DBusGProxy *proxy,
                                           GError     *error,
                                           gpointer    user_data)
{
  _fmb_return_if_fail (DBUS_IS_G_PROXY (proxy));
...
static void
fmb_thumbnail_cache_delete_async (FmbThumbnailCache *cache,
                                     const gchar         **uris)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (uris != NULL);

  /* request a thumbnail cache update asynchronously */
  fmb_thumbnail_cache_proxy_delete_async (cache->cache_proxy, uris,
                                             fmb_thumbnail_cache_delete_async_reply,
                                             NULL);
}
...
static void
fmb_thumbnail_cache_cleanup_async_reply (DBusGProxy *proxy,
                                            GError     *error,
                                            gpointer    user_data)
{
  _fmb_return_if_fail (DBUS_IS_G_PROXY (proxy));
...
static void
fmb_thumbnail_cache_cleanup_async (FmbThumbnailCache *cache,
                                      const gchar *const    *base_uris)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (base_uris != NULL);

  /* request a thumbnail cache update asynchronously */
  fmb_thumbnail_cache_proxy_cleanup_async (cache->cache_proxy,
                                              (const gchar **)base_uris, 0,
                                              fmb_thumbnail_cache_cleanup_async_reply,
                                              NULL);
}
...
static gboolean
fmb_thumbnail_cache_process_queue (FmbThumbnailCache *cache,
                                      gboolean              copy_async)
{
  GList  *sp;
  GList  *tp;
  ...
  _fmb_return_val_if_fail (FMB_IS_THUMBNAIL_CACHE (cache), FALSE);
  ...
  if (copy_async)
    {
      ...
      fmb_thumbnail_cache_copy_async (cache,
                                         (const gchar **)source_uris,
                                         (const gchar **)target_uris,
                                         target_queue);
    }
  else
    {
      ...
      fmb_thumbnail_cache_move_async (cache,
                                         (const gchar **)source_uris,
                                         (const gchar **)target_uris,
                                         target_queue);
    }
...
static gboolean
fmb_thumbnail_cache_process_move_queue (gpointer user_data)
{
  return fmb_thumbnail_cache_process_queue (user_data, FALSE);
}



static void
fmb_thumbnail_cache_process_move_queue_destroy (gpointer user_data)
{
  FMB_THUMBNAIL_CACHE (user_data)->move_queue_idle_id = 0;
}



static gboolean
fmb_thumbnail_cache_process_copy_queue (gpointer user_data)
{
  return fmb_thumbnail_cache_process_queue (user_data, TRUE);
}



static void
fmb_thumbnail_cache_process_copy_queue_destroy (gpointer user_data)
{
  FMB_THUMBNAIL_CACHE (user_data)->copy_queue_idle_id = 0;
}



static gboolean
fmb_thumbnail_cache_process_delete_queue (FmbThumbnailCache *cache)
{
  GList  *lp;
  gchar **uris;
  guint   n_uris;
  ...
  fmb_thumbnail_cache_delete_async (cache, (const gchar **)uris);
...
static gboolean
fmb_thumbnail_cache_process_cleanup_queue (FmbThumbnailCache *cache)
{
  GList  *lp;
  gchar **uris;
  guint   n_uris;
  ...
  fmb_thumbnail_cache_cleanup_async (cache, (const gchar *const *)uris);
...
FmbThumbnailCache *
fmb_thumbnail_cache_new (void)
{
  return g_object_new (FMB_TYPE_THUMBNAIL_CACHE, NULL);
}



void
fmb_thumbnail_cache_move_file (FmbThumbnailCache *cache,
                                  GFile                *source_file,
                                  GFile                *target_file)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (G_IS_FILE (source_file));
  ...
  if (cache->cache_proxy != NULL)
    {
      ...
      cache->move_queue_idle_id =
        g_timeout_add_full (G_PRIORITY_DEFAULT_IDLE, 250, fmb_thumbnail_cache_process_move_queue,
                            cache, fmb_thumbnail_cache_process_move_queue_destroy);
    }
...
void
fmb_thumbnail_cache_copy_file (FmbThumbnailCache *cache,
                                  GFile                *source_file,
                                  GFile                *target_file)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  ...
  if (cache->cache_proxy != NULL)
    {
      ...
      cache->copy_queue_idle_id =
        g_timeout_add_full (G_PRIORITY_DEFAULT_IDLE, 500, fmb_thumbnail_cache_process_copy_queue,
                            cache, fmb_thumbnail_cache_process_copy_queue_destroy);
    }
...
void
fmb_thumbnail_cache_delete_file (FmbThumbnailCache *cache,
                                    GFile                *file)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (G_IS_FILE (file));
  ...
  if (cache->cache_proxy)
    {
      ...
      cache->delete_queue_idle_id =
        g_timeout_add (500, (GSourceFunc) fmb_thumbnail_cache_process_delete_queue,
                       cache);
    }
...
void
fmb_thumbnail_cache_cleanup_file (FmbThumbnailCache *cache,
                                     GFile                *file)
{
  _fmb_return_if_fail (FMB_IS_THUMBNAIL_CACHE (cache));
  _fmb_return_if_fail (G_IS_FILE (file));
  ...
  if (cache->cache_proxy)
    {
      ...
      cache->cleanup_queue_idle_id =
        g_timeout_add (1000, (GSourceFunc) fmb_thumbnail_cache_process_cleanup_queue,
                       cache);
    }
