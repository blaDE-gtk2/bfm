...
static void           fmb_location_button_finalize               (GObject                    *object);
static void           fmb_location_button_get_property           (GObject                    *object,
                                                                     guint                       prop_id,
                                                                     GValue                     *value,
                                                                     GParamSpec                 *pspec);
static void           fmb_location_button_set_property           (GObject                    *object,
                                                                     guint                       prop_id,
                                                                     const GValue               *value,
                                                                     GParamSpec                 *pspec);
static void           fmb_location_button_style_set              (GtkWidget                  *widget,
                                                                     GtkStyle                   *previous_style);
static GdkDragAction  fmb_location_button_get_dest_actions       (FmbLocationButton       *location_button,
                                                                     GdkDragContext             *context,
                                                                     GtkWidget                  *button,
                                                                     guint                       timestamp);
static void           fmb_location_button_file_changed           (FmbLocationButton       *location_button,
                                                                     FmbFile                 *file);
static void           fmb_location_button_file_destroy           (FmbLocationButton       *location_button,
                                                                     FmbFile                 *file);
static void           fmb_location_button_align_size_request     (GtkWidget                  *align,
                                                                     GtkRequisition             *requisition,
                                                                     FmbLocationButton       *location_button);
static gboolean       fmb_location_button_button_press_event     (GtkWidget                  *button,
                                                                     GdkEventButton             *event,
                                                                     FmbLocationButton       *location_button);
static gboolean       fmb_location_button_button_release_event   (GtkWidget                  *button,
                                                                     GdkEventButton             *event,
                                                                     FmbLocationButton       *location_button);
static gboolean       fmb_location_button_drag_drop              (GtkWidget                  *button,
                                                                     GdkDragContext             *context,
                                                                     gint                        x,
                                                                     gint                        y,
                                                                     guint                       timestamp,
                                                                     FmbLocationButton       *location_button);
static void           fmb_location_button_drag_data_get          (GtkWidget                  *button,
                                                                     GdkDragContext             *context,
                                                                     GtkSelectionData           *selection_data,
                                                                     guint                       info,
                                                                     guint                       timestamp,
                                                                     FmbLocationButton       *location_button);
static void           fmb_location_button_drag_data_received     (GtkWidget                  *button,
                                                                     GdkDragContext             *context,
                                                                     gint                        x,
                                                                     gint                        y,
                                                                     GtkSelectionData           *selection_data,
                                                                     ...
                                                                     guint                       timestamp,
                                                                     FmbLocationButton       *location_button);
static void           fmb_location_button_drag_leave             (GtkWidget                  *button,
                                                                     GdkDragContext             *context,
                                                                     guint                       timestamp,
                                                                     FmbLocationButton       *location_button);
static gboolean       fmb_location_button_drag_motion            (GtkWidget                  *button,
                                                                     GdkDragContext             *context,
                                                                     gint                        x,
                                                                     gint                        y,
                                                                     guint                       timestamp,
                                                                     FmbLocationButton       *location_button);
static gboolean       fmb_location_button_enter_timeout          (gpointer                    user_data);
static void           fmb_location_button_enter_timeout_destroy  (gpointer                    user_data);



struct _FmbLocationButtonClass
{
  GtkAlignmentClass __parent__;
};

struct _FmbLocationButton
{
  ...
  FmbFileIconState file_icon_state;
...
G_DEFINE_TYPE (FmbLocationButton, fmb_location_button, GTK_TYPE_ALIGNMENT)



static void
fmb_location_button_class_init (FmbLocationButtonClass *klass)
{
  GtkWidgetClass *gtkwidget_class;
  GObjectClass   *gobject_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = fmb_location_button_finalize;
  gobject_class->get_property = fmb_location_button_get_property;
  gobject_class->set_property = fmb_location_button_set_property;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->style_set = fmb_location_button_style_set;

  /**
   * FmbLocationButton:active:
   *
  ...
  /**
   * FmbLocationButton:file:
   *
   * The #FmbFile represented by this location button.
   **/
  g_object_class_install_property (gobject_class,
                                   PROP_FILE,
  ...
  /**
   * FmbLocationButton::clicked:
   * @location_button : a #FmbLocationButton.
   *
   * Emitted by @location_button when the user clicks on the
   * @location_button or fmb_location_button_clicked() is
   * called.
   **/
  ...
  /**
   * FmbLocationButton::context-menu:
   * @location_button : a #FmbLocationButton.
...
static void
fmb_location_button_init (FmbLocationButton *location_button)
{
  GtkWidget *align;
  GtkWidget *button;
  GtkWidget *hbox;
  ...
  g_signal_connect_swapped (G_OBJECT (button), "clicked", G_CALLBACK (fmb_location_button_clicked), location_button);
  blxo_mutual_binding_new (G_OBJECT (location_button), "active", G_OBJECT (button), "active");
  ...
  g_signal_connect (G_OBJECT (button), "button-press-event", G_CALLBACK (fmb_location_button_button_press_event), location_button);
  g_signal_connect (G_OBJECT (button), "button-release-event", G_CALLBACK (fmb_location_button_button_release_event), location_button);
  g_signal_connect (G_OBJECT (button), "drag-drop", G_CALLBACK (fmb_location_button_drag_drop), location_button);
  g_signal_connect (G_OBJECT (button), "drag-data-get", G_CALLBACK (fmb_location_button_drag_data_get), location_button);
  g_signal_connect (G_OBJECT (button), "drag-data-received", G_CALLBACK (fmb_location_button_drag_data_received), location_button);
  g_signal_connect (G_OBJECT (button), "drag-leave", G_CALLBACK (fmb_location_button_drag_leave), location_button);
  g_signal_connect (G_OBJECT (button), "drag-motion", G_CALLBACK (fmb_location_button_drag_motion), location_button);
  ...
  g_signal_connect (G_OBJECT (align), "size-request", G_CALLBACK (fmb_location_button_align_size_request), location_button);
...
static void
fmb_location_button_finalize (GObject *object)
{
  FmbLocationButton *location_button = FMB_LOCATION_BUTTON (object);

  /* release the drop path list (just in case the drag-leave wasn't fired before) */
  fmb_g_file_list_free (location_button->drop_file_list);
  ...
  fmb_location_button_set_file (location_button, NULL);

  (*G_OBJECT_CLASS (fmb_location_button_parent_class)->finalize) (object);
}



static void
fmb_location_button_get_property (GObject    *object,
                                     guint       prop_id,
                                     GValue     *value,
                                     GParamSpec *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_ACTIVE:
      g_value_set_boolean (value, fmb_location_button_get_active (location_button));
      break;

    case PROP_FILE:
      g_value_set_object (value, fmb_location_button_get_file (location_button));
      break;
...
static void
fmb_location_button_set_property (GObject      *object,
                                     guint         prop_id,
                                     const GValue *value,
                                     GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    {
    case PROP_ACTIVE:
      fmb_location_button_set_active (location_button, g_value_get_boolean (value));
      break;

    case PROP_FILE:
      fmb_location_button_set_file (location_button, g_value_get_object (value));
      break;
...
static void
fmb_location_button_style_set (GtkWidget *widget,
                                  GtkStyle  *previous_style)
{
  FmbLocationButton *location_button = FMB_LOCATION_BUTTON (widget);

  /* update the user interface if we have a file */
  if (G_LIKELY (location_button->file != NULL))
    fmb_location_button_file_changed (location_button, location_button->file);

  (*GTK_WIDGET_CLASS (fmb_location_button_parent_class)->style_set) (widget, previous_style);
}



static GdkDragAction
fmb_location_button_get_dest_actions (FmbLocationButton *location_button,
                                         GdkDragContext       *context,
                                         GtkWidget            *button,
                                         guint                 timestamp)
{
  ...
  if (G_LIKELY (location_button->file != NULL))
    {
      ...
      actions = fmb_file_accepts_drop (location_button->file, location_button->drop_file_list, context, &action);
    }
...
static void
fmb_location_button_file_changed (FmbLocationButton *location_button,
                                     FmbFile           *file)
{
  ...
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
  _fmb_return_if_fail (location_button->file == file);
  ...
  if (fmb_file_is_local (file) && fmb_file_is_root (file)) 
    {
  ...
  else
    {
      ...
      gtk_label_set_text (GTK_LABEL (location_button->label), fmb_file_get_display_name (file));
      gtk_widget_show (gtk_widget_get_parent (location_button->label));
    }

  /* the image is only visible for certain special paths */
  if (fmb_file_is_home (file) || fmb_file_is_desktop (file) || fmb_file_is_root (file))
    {
      ...
      icon = fmb_icon_factory_load_file_icon (icon_factory, file, location_button->file_icon_state, size);
  ...
  if (custom_icon != NULL)
    ...
    {
      icon_name = fmb_file_get_icon_name (file, location_button->file_icon_state, icon_theme);
...
static void
fmb_location_button_file_destroy (FmbLocationButton *location_button,
                                     FmbFile           *file)
{
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
  _fmb_return_if_fail (location_button->file == file);
...
static void
fmb_location_button_align_size_request (GtkWidget            *align,
                                           GtkRequisition       *requisition,
                                           FmbLocationButton *location_button)
{
  PangoLayout *layout;
  ...
  pango_layout_set_attributes (layout, fmb_pango_attr_list_bold ());
...
static gboolean
fmb_location_button_button_press_event (GtkWidget            *button,
                                           GdkEventButton       *event,
                                           FmbLocationButton *location_button)
{
  _fmb_return_val_if_fail (FMB_IS_LOCATION_BUTTON (location_button), FALSE);
  ...
  if (G_UNLIKELY (event->button == 2))
    ...
    {
      /* emit the "context-menu" signal and let the surrounding FmbLocationButtons popup a menu */
...
static gboolean
fmb_location_button_button_release_event (GtkWidget            *button,
                                             GdkEventButton       *event,
                                             FmbLocationButton *location_button)
{
      ...
      if (G_LIKELY (location_button->file != NULL))
        {
          ...
          if (open_in_tab)
          ...
          else
            {
              ...
              fmb_application_open_window (application, location_button->file, gtk_widget_get_screen (GTK_WIDGET (location_button)), NULL);
...
static gboolean
fmb_location_button_drag_drop (GtkWidget            *button,
                                  GdkDragContext       *context,
                                  gint                  x,
                                  gint                  y,
                                  guint                 timestamp,
                                  FmbLocationButton *location_button)
{
  ...
  _fmb_return_val_if_fail (GTK_IS_WIDGET (button), FALSE);
  _fmb_return_val_if_fail (FMB_IS_LOCATION_BUTTON (location_button), FALSE);
...
static void
fmb_location_button_drag_data_get (GtkWidget            *button,
                                      GdkDragContext       *context,
                                      GtkSelectionData     *selection_data,
                                      guint                 info,
                                      guint                 timestamp,
                                      FmbLocationButton *location_button)
{
  ...
  _fmb_return_if_fail (GTK_IS_WIDGET (button));
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
  ...
  if (G_LIKELY (location_button->file != NULL))
    {
      ...
      path_list.data = fmb_file_get_file (location_button->file);

      /* set the uri list for the drag selection */
      uris = fmb_g_file_list_to_stringv (&path_list);
...
static void
fmb_location_button_drag_data_received (GtkWidget            *button,
                                           GdkDragContext       *context,
                                           gint                  x,
                                           gint                  y,
                                           GtkSelectionData     *selection_data,
  ...
  if (G_LIKELY (!location_button->drop_data_ready))
    {
      ...
      if (selection_data->format == 8 && selection_data->length > 0)
        location_button->drop_file_list = fmb_g_file_list_new_from_string ((const gchar *) selection_data->data);
  ...
  if (G_UNLIKELY (location_button->drop_occurred))
    {
      ...
      actions = fmb_location_button_get_dest_actions (location_button, context, button, timestamp);
      if (G_LIKELY ((actions & (GDK_ACTION_COPY | GDK_ACTION_MOVE | GDK_ACTION_LINK)) != 0))
        {
          ...
          action = (context->action == GDK_ACTION_ASK)
                 ? fmb_dnd_ask (button, location_button->file, location_button->drop_file_list, timestamp, actions)
                 : context->action;

          /* perform the requested action */
          if (G_LIKELY (action != 0))
            succeed = fmb_dnd_perform (button, location_button->file, location_button->drop_file_list, action, NULL);
        }
      ...
      fmb_location_button_drag_leave (button, context, timestamp, location_button);
    }
}
...
static void
fmb_location_button_drag_leave (GtkWidget            *button,
                                   GdkDragContext       *context,
                                   guint                 timestamp,
                                   FmbLocationButton *location_button)
{
  ...
  if (G_LIKELY (location_button->file_icon_state != FMB_FILE_ICON_STATE_DEFAULT))
    {
      /* we may switch to "drop icon state" during drag motion */
      location_button->file_icon_state = FMB_FILE_ICON_STATE_DEFAULT;
...
static gboolean
fmb_location_button_drag_motion (GtkWidget            *button,
                                    GdkDragContext       *context,
                                    gint                  x,
                                    gint                  y,
                                    guint                 timestamp,
                                    FmbLocationButton *location_button)
{
  ...
  _fmb_return_val_if_fail (GTK_IS_BUTTON (button), FALSE);
  _fmb_return_val_if_fail (FMB_IS_LOCATION_BUTTON (location_button), FALSE);
  ...
  if (G_UNLIKELY (location_button->enter_timeout_id == 0))
    {
      ...
      location_button->enter_timeout_id = g_timeout_add_full (G_PRIORITY_DEFAULT, delay, fmb_location_button_enter_timeout,
                                                              location_button, fmb_location_button_enter_timeout_destroy);
    }
  ...
  if (G_UNLIKELY (!location_button->drop_data_ready))
  ...
  else
    {
      ...
      file_icon_state = (actions == 0) ? FMB_FILE_ICON_STATE_DEFAULT : FMB_FILE_ICON_STATE_DROP;
...
static gboolean
fmb_location_button_enter_timeout (gpointer user_data)
{
  FmbLocationButton *location_button = FMB_LOCATION_BUTTON (user_data);
   ...
   */
  fmb_location_button_clicked (location_button);
...
static void
fmb_location_button_enter_timeout_destroy (gpointer user_data)
{
  FMB_LOCATION_BUTTON (user_data)->enter_timeout_id = 0;
}



/**
 * fmb_location_button_new:
 *
 * Allocates a new #FmbLocationButton instance.
 *
 * Return value: the newly allocated #FmbLocationButton.
 **/
GtkWidget*
fmb_location_button_new (void)
{
  return g_object_new (FMB_TYPE_LOCATION_BUTTON, NULL);
}



/**
 * fmb_location_button_get_active:
 * @location_button : a #FmbLocationButton.
 *
 ...
 **/
gboolean
fmb_location_button_get_active (FmbLocationButton *location_button)
{
  _fmb_return_val_if_fail (FMB_IS_LOCATION_BUTTON (location_button), FALSE);
...
/**
 * fmb_location_button_set_active:
 * @location_button : a #FmbLocationButton.
 ...
 **/
void
fmb_location_button_set_active (FmbLocationButton *location_button,
                                   gboolean              active)
{
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
  ...
  gtk_label_set_attributes (GTK_LABEL (location_button->label), active ? fmb_pango_attr_list_bold () : NULL);
...
/**
 * fmb_location_button_get_file:
 * @location_button : a #FmbLocationButton.
 *
 * Returns the #FmbFile for @location_button.
 *
 * Return value: the #FmbFile for @location_button.
 **/
FmbFile*
fmb_location_button_get_file (FmbLocationButton *location_button)
{
  _fmb_return_val_if_fail (FMB_IS_LOCATION_BUTTON (location_button), NULL);
 ...
 **/
void
fmb_location_button_set_file (FmbLocationButton *location_button,
                                 FmbFile           *file)
{
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
  ...
  if (location_button->file != NULL)
    {
      ...
      fmb_file_unwatch (location_button->file);

      /* disconnect signals and release reference */
      g_signal_handlers_disconnect_by_func (G_OBJECT (location_button->file), fmb_location_button_file_destroy, location_button);
      g_signal_handlers_disconnect_by_func (G_OBJECT (location_button->file), fmb_location_button_file_changed, location_button);
  ...
  if (G_LIKELY (file != NULL))
    {
      ...
      g_signal_connect_swapped (G_OBJECT (file), "changed", G_CALLBACK (fmb_location_button_file_changed), location_button);
      g_signal_connect_swapped (G_OBJECT (file), "destroy", G_CALLBACK (fmb_location_button_file_destroy), location_button);

      /* update our internal state for the new file (if realized) */
      if (gtk_widget_get_realized (GTK_WIDGET (location_button)))
        fmb_location_button_file_changed (location_button, file);
    }
...
/**
 * fmb_location_button_clicked:
 * @location_button : a #FmbLocationButton.
 *
 * Emits the ::clicked signal on @location_button.
 **/
void
fmb_location_button_clicked (FmbLocationButton *location_button)
{
  _fmb_return_if_fail (FMB_IS_LOCATION_BUTTON (location_button));
