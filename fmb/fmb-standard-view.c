...
#include <fmb/fmb-standard-view-ui.h>
...
#define FMB_STANDARD_VIEW_GET_PRIVATE(obj) (G_TYPE_INSTANCE_GET_PRIVATE ((obj), FMB_TYPE_STANDARD_VIEW, FmbStandardViewPrivate))
...
static void                 fmb_standard_view_component_init             (FmbComponentIface     *iface);
static void                 fmb_standard_view_navigator_init             (FmbNavigatorIface     *iface);
static void                 fmb_standard_view_view_init                  (FmbViewIface          *iface);
static GObject             *fmb_standard_view_constructor                (GType                     type,
                                                                             guint                     n_construct_properties,
                                                                             GObjectConstructParam    *construct_properties);
static void                 fmb_standard_view_dispose                    (GObject                  *object);
static void                 fmb_standard_view_finalize                   (GObject                  *object);
static void                 fmb_standard_view_get_property               (GObject                  *object,
                                                                             guint                     prop_id,
                                                                             GValue                   *value,
                                                                             GParamSpec               *pspec);
static void                 fmb_standard_view_set_property               (GObject                  *object,
                                                                             guint                     prop_id,
                                                                             const GValue             *value,
                                                                             GParamSpec               *pspec);
static void                 fmb_standard_view_realize                    (GtkWidget                *widget);
static void                 fmb_standard_view_unrealize                  (GtkWidget                *widget);
static void                 fmb_standard_view_grab_focus                 (GtkWidget                *widget);
static gboolean             fmb_standard_view_expose_event               (GtkWidget                *widget,
                                                                             GdkEventExpose           *event);
static GList               *fmb_standard_view_get_selected_files         (FmbComponent          *component);
static void                 fmb_standard_view_set_selected_files         (FmbComponent          *component,
                                                                             GList                    *selected_files);
static GtkUIManager        *fmb_standard_view_get_ui_manager             (FmbComponent          *component);
static void                 fmb_standard_view_set_ui_manager             (FmbComponent          *component,
                                                                             GtkUIManager             *ui_manager);
static FmbFile          *fmb_standard_view_get_current_directory      (FmbNavigator          *navigator);
static void                 fmb_standard_view_set_current_directory      (FmbNavigator          *navigator,
                                                                             FmbFile               *current_directory);
static gboolean             fmb_standard_view_get_loading                (FmbView               *view);
static void                 fmb_standard_view_set_loading                (FmbStandardView       *standard_view,
                                                                             gboolean                  loading);
static const gchar         *fmb_standard_view_get_statusbar_text         (FmbView               *view);
static gboolean             fmb_standard_view_get_show_hidden            (FmbView               *view);
static void                 fmb_standard_view_set_show_hidden            (FmbView               *view,
                                                                             gboolean                  show_hidden);
static FmbZoomLevel      fmb_standard_view_get_zoom_level             (FmbView               *view);
static void                 fmb_standard_view_set_zoom_level             (FmbView               *view,
                                                                             FmbZoomLevel           zoom_level);
static void                 fmb_standard_view_reset_zoom_level           (FmbView               *view);
static void                 fmb_standard_view_reload                     (FmbView               *view,
                                                                             gboolean                  reload_info);
static gboolean             fmb_standard_view_get_visible_range          (FmbView               *view,
                                                                             FmbFile              **start_file,
                                                                             FmbFile              **end_file);
static void                 fmb_standard_view_scroll_to_file             (FmbView               *view,
                                                                             FmbFile               *file,
                                                                             gboolean                  select_file,
                                                                             gboolean                  use_align,
                                                                             gfloat                    row_align,
                                                                             gfloat                    col_align);
static gboolean             fmb_standard_view_delete_selected_files      (FmbStandardView       *standard_view);
static GdkDragAction        fmb_standard_view_get_dest_actions           (FmbStandardView       *standard_view,
                                                                             GdkDragContext           *context,
                                                                             gint                      x,
                                                                             gint                      y,
                                                                             guint                     timestamp,
                                                                             FmbFile              **file_return);
static FmbFile          *fmb_standard_view_get_drop_file              (FmbStandardView       *standard_view,
                                                                             gint                      x,
                                                                             gint                      y,
                                                                             GtkTreePath             **path_return);
static void                 fmb_standard_view_merge_custom_actions       (FmbStandardView       *standard_view,
                                                                             GList                    *selected_items);
static void                 fmb_standard_view_update_statusbar_text      (FmbStandardView       *standard_view);
static void                 fmb_standard_view_current_directory_destroy  (FmbFile               *current_directory,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_current_directory_changed  (FmbFile               *current_directory,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_create_empty_file   (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_create_folder       (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_create_template     (GtkAction                *action,
                                                                             const FmbFile         *file,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_properties          (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_cut                 (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_copy                (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_paste               (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_move_to_trash       (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_delete             (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_paste_into_folder   (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_select_all_files    (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_select_by_pattern   (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_selection_invert    (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_duplicate           (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_make_link           (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_rename              (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_action_restore             (GtkAction                *action,
                                                                             FmbStandardView       *standard_view);
static GClosure            *fmb_standard_view_new_files_closure          (FmbStandardView       *standard_view,
                                                                             GtkWidget                *source_view);
static void                 fmb_standard_view_new_files                  (FmbStandardView       *standard_view,
                                                                             GList                    *path_list);
static gboolean             fmb_standard_view_button_release_event       (GtkWidget                *view,
                                                                             GdkEventButton           *event,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_motion_notify_event        (GtkWidget                *view,
                                                                             GdkEventMotion           *event,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_key_press_event            (GtkWidget                *view,
                                                                             GdkEventKey              *event,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_scroll_event               (GtkWidget                *view,
                                                                             GdkEventScroll           *event,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_button_press_event         (GtkWidget                *view,
                                                                             GdkEventButton           *event,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_drag_drop                  (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             gint                      x,
                                                                             gint                      y,
                                                                             guint                     timestamp,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_data_received         (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             gint                      x,
                                                                             gint                      y,
                                                                             ...
                                                                             guint                     timestamp,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_leave                 (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             guint                     timestamp,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_drag_motion                (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             gint                      x,
                                                                             gint                      y,
                                                                             guint                     timestamp,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_begin                 (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_data_get              (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             GtkSelectionData         *selection_data,
                                                                             guint                     info,
                                                                             guint                     timestamp,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_data_delete           (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_drag_end                   (GtkWidget                *view,
                                                                             GdkDragContext           *context,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_row_deleted                (FmbListModel          *model,
                                                                             GtkTreePath              *path,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_select_after_row_deleted   (FmbListModel          *model,
                                                                             GtkTreePath              *path,
                                                                             FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_restore_selection_idle     (FmbStandardView       *standard_view);
static void                 fmb_standard_view_row_changed                (FmbListModel          *model,
                                                                             GtkTreePath              *path,
                                                                             GtkTreeIter              *iter,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_rows_reordered             (FmbListModel          *model,
                                                                             GtkTreePath              *path,
                                                                             GtkTreeIter              *iter,
                                                                             gpointer                  new_order,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_error                      (FmbListModel          *model,
                                                                             const GError             *error,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_sort_column_changed        (GtkTreeSortable          *tree_sortable,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_loading_unbound            (gpointer                  user_data);
static gboolean             fmb_standard_view_drag_scroll_timer          (gpointer                  user_data);
static void                 fmb_standard_view_drag_scroll_timer_destroy  (gpointer                  user_data);
static gboolean             fmb_standard_view_drag_timer                 (gpointer                  user_data);
static void                 fmb_standard_view_drag_timer_destroy         (gpointer                  user_data);
static void                 fmb_standard_view_finished_thumbnailing      (FmbThumbnailer        *thumbnailer,
                                                                             guint                     request,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_thumbnailing_destroyed     (gpointer                  data);
static void                 fmb_standard_view_cancel_thumbnailing        (FmbStandardView       *standard_view);
static void                 fmb_standard_view_schedule_thumbnail_timeout (FmbStandardView       *standard_view);
static void                 fmb_standard_view_schedule_thumbnail_idle    (FmbStandardView       *standard_view);
static gboolean             fmb_standard_view_request_thumbnails         (gpointer                  data);
static gboolean             fmb_standard_view_request_thumbnails_lazy    (gpointer                  data);
static void                 fmb_standard_view_thumbnail_mode_toggled     (FmbStandardView       *standard_view,
                                                                             GParamSpec               *pspec,
                                                                             FmbIconFactory        *icon_factory);
static void                 fmb_standard_view_scrolled                   (GtkAdjustment            *adjustment,
                                                                             FmbStandardView       *standard_view);
static void                 fmb_standard_view_size_allocate              (FmbStandardView       *standard_view,
                                                                             GtkAllocation            *allocation);



struct _FmbStandardViewPrivate
{
   ...
   * new files are created by a FmbJob associated with this view
   */
...
static const GtkActionEntry action_entries[] =
{
  ...
  { "create-folder", "folder-new", N_ ("Create _Folder..."), "<control><shift>N", N_ ("Create an empty folder within the current folder"), G_CALLBACK (fmb_standard_view_action_create_folder), },
  { "properties", GTK_STOCK_PROPERTIES, N_ ("_Properties..."), "<alt>Return", N_ ("View the properties of the selected file"), G_CALLBACK (fmb_standard_view_action_properties), },
  { "cut", GTK_STOCK_CUT, N_ ("Cu_t"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_cut), },
  { "copy", GTK_STOCK_COPY, N_ ("_Copy"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_copy), },
  { "paste", GTK_STOCK_PASTE, N_ ("_Paste"), NULL, N_ ("Move or copy files previously selected by a Cut or Copy command"), G_CALLBACK (fmb_standard_view_action_paste), },
  { "move-to-trash", FMB_STOCK_TRASH_FULL, N_ ("Mo_ve to Trash"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_move_to_trash), },
  { "delete", GTK_STOCK_DELETE, N_ ("_Delete"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_delete), },
  { "paste-into-folder", GTK_STOCK_PASTE, N_ ("Paste Into Folder"), NULL, N_ ("Move or copy files previously selected by a Cut or Copy command into the selected folder"), G_CALLBACK (fmb_standard_view_action_paste_into_folder), },
  { "select-all-files", NULL, N_ ("Select _all Files"), NULL, N_ ("Select all files in this window"), G_CALLBACK (fmb_standard_view_action_select_all_files), },
  { "select-by-pattern", NULL, N_ ("Select _by Pattern..."), "<control>S", N_ ("Select all files that match a certain pattern"), G_CALLBACK (fmb_standard_view_action_select_by_pattern), },
  { "invert-selection", NULL, N_ ("_Invert Selection"), NULL, N_ ("Select all and only the items that are not currently selected"), G_CALLBACK (fmb_standard_view_action_selection_invert), },
  { "duplicate", NULL, N_ ("Du_plicate"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_duplicate), },
  { "make-link", NULL, N_ ("Ma_ke Link"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_make_link), },
  { "rename", NULL, N_ ("_Rename..."), "F2", NULL, G_CALLBACK (fmb_standard_view_action_rename), },
  { "restore", NULL, N_ ("_Restore"), NULL, NULL, G_CALLBACK (fmb_standard_view_action_restore), },
};
...
G_DEFINE_ABSTRACT_TYPE_WITH_CODE (FmbStandardView, fmb_standard_view, GTK_TYPE_SCROLLED_WINDOW,
    G_IMPLEMENT_INTERFACE (FMB_TYPE_NAVIGATOR, fmb_standard_view_navigator_init)
    G_IMPLEMENT_INTERFACE (FMB_TYPE_COMPONENT, fmb_standard_view_component_init)
    G_IMPLEMENT_INTERFACE (FMB_TYPE_VIEW, fmb_standard_view_view_init))



static void
fmb_standard_view_class_init (FmbStandardViewClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (FmbStandardViewPrivate));

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->constructor = fmb_standard_view_constructor;
  gobject_class->dispose = fmb_standard_view_dispose;
  gobject_class->finalize = fmb_standard_view_finalize;
  gobject_class->get_property = fmb_standard_view_get_property;
  gobject_class->set_property = fmb_standard_view_set_property;

  gtkwidget_class = GTK_WIDGET_CLASS (klass);
  gtkwidget_class->realize = fmb_standard_view_realize;
  gtkwidget_class->unrealize = fmb_standard_view_unrealize;
  gtkwidget_class->grab_focus = fmb_standard_view_grab_focus;
  gtkwidget_class->expose_event = fmb_standard_view_expose_event;

  klass->delete_selected_files = fmb_standard_view_delete_selected_files;
  klass->connect_ui_manager = (gpointer) blxo_noop;
  klass->disconnect_ui_manager = (gpointer) blxo_noop;

  /**
   * FmbStandardView:loading:
   *
  ...
  /* override FmbView's properties */
  g_iface = g_type_default_interface_peek (FMB_TYPE_VIEW);
  ...
  /**
   * FmbStandardView::start-opn-location:
   * @standard_view : a #FmbStandardView.
  ...
  standard_view_signals[START_OPEN_LOCATION] =
    g_signal_new (I_("start-open-location"),
                  ...
                  G_SIGNAL_RUN_LAST,
                  G_STRUCT_OFFSET (FmbStandardViewClass, start_open_location),
                  NULL, NULL,
                  g_cclosure_marshal_VOID__STRING,
                  G_TYPE_NONE, 1, G_TYPE_STRING);

  /**
   * FmbStandardView::delete-selected-files:
   * @standard_view : a #FmbStandardView.
   *
  ...
  standard_view_signals[DELETE_SELECTED_FILES] =
    g_signal_new (I_("delete-selected-files"),
                  ...
                  G_STRUCT_OFFSET (FmbStandardViewClass, delete_selected_files),
...
static void
fmb_standard_view_component_init (FmbComponentIface *iface)
{
  iface->get_selected_files = fmb_standard_view_get_selected_files;
  iface->set_selected_files = fmb_standard_view_set_selected_files;
  iface->get_ui_manager = fmb_standard_view_get_ui_manager;
  iface->set_ui_manager = fmb_standard_view_set_ui_manager;
}



static void
fmb_standard_view_navigator_init (FmbNavigatorIface *iface)
{
  iface->get_current_directory = fmb_standard_view_get_current_directory;
  iface->set_current_directory = fmb_standard_view_set_current_directory;
}



static void
fmb_standard_view_view_init (FmbViewIface *iface)
{
  iface->get_loading = fmb_standard_view_get_loading;
  iface->get_statusbar_text = fmb_standard_view_get_statusbar_text;
  iface->get_show_hidden = fmb_standard_view_get_show_hidden;
  iface->set_show_hidden = fmb_standard_view_set_show_hidden;
  iface->get_zoom_level = fmb_standard_view_get_zoom_level;
  iface->set_zoom_level = fmb_standard_view_set_zoom_level;
  iface->reset_zoom_level = fmb_standard_view_reset_zoom_level;
  iface->reload = fmb_standard_view_reload;
  iface->get_visible_range = fmb_standard_view_get_visible_range;
  iface->scroll_to_file = fmb_standard_view_scroll_to_file;
}



static void
fmb_standard_view_init (FmbStandardView *standard_view)
{
  standard_view->priv = FMB_STANDARD_VIEW_GET_PRIVATE (standard_view);
  ...
  standard_view->preferences = fmb_preferences_get ();

  /* grab a reference on the provider factory */
  standard_view->priv->provider_factory = fmbx_provider_factory_get_default ();

  /* create a thumbnailer */
  standard_view->priv->thumbnailer = fmb_thumbnailer_get ();
  g_signal_connect (G_OBJECT (standard_view->priv->thumbnailer), "request-finished", G_CALLBACK (fmb_standard_view_finished_thumbnailing), standard_view);
  ...
  standard_view->action_group = gtk_action_group_new ("FmbStandardView");
  ...
  standard_view->priv->action_create_document = fmb_templates_action_new ("create-document", _("Create _Document"));
  g_signal_connect (G_OBJECT (standard_view->priv->action_create_document), "create-empty-file",
                    G_CALLBACK (fmb_standard_view_action_create_empty_file), standard_view);
  g_signal_connect (G_OBJECT (standard_view->priv->action_create_document), "create-template",
                    G_CALLBACK (fmb_standard_view_action_create_template), standard_view);
  ...
  standard_view->priv->history = g_object_new (FMB_TYPE_HISTORY, "action-group", standard_view->action_group, NULL);
  g_signal_connect_swapped (G_OBJECT (standard_view->priv->history), "change-directory", G_CALLBACK (fmb_navigator_change_directory), standard_view);

  /* setup the list model */
  standard_view->model = fmb_list_model_new ();
  g_signal_connect (G_OBJECT (standard_view->model), "row-deleted", G_CALLBACK (fmb_standard_view_row_deleted), standard_view);
  g_signal_connect_after (G_OBJECT (standard_view->model), "row-deleted", G_CALLBACK (fmb_standard_view_select_after_row_deleted), standard_view);
  standard_view->priv->row_changed_id = g_signal_connect (G_OBJECT (standard_view->model), "row-changed", G_CALLBACK (fmb_standard_view_row_changed), standard_view);
  g_signal_connect (G_OBJECT (standard_view->model), "rows-reordered", G_CALLBACK (fmb_standard_view_rows_reordered), standard_view);
  g_signal_connect (G_OBJECT (standard_view->model), "error", G_CALLBACK (fmb_standard_view_error), standard_view);
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-case-sensitive", G_OBJECT (standard_view->model), "case-sensitive");
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-date-style", G_OBJECT (standard_view->model), "date-style");
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-folders-first", G_OBJECT (standard_view->model), "folders-first");
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-file-size-binary", G_OBJECT (standard_view->model), "file-size-binary");

  /* setup the icon renderer */
  standard_view->icon_renderer = fmb_icon_renderer_new ();
  g_object_ref_sink (G_OBJECT (standard_view->icon_renderer));
  blxo_binding_new (G_OBJECT (standard_view), "zoom-level", G_OBJECT (standard_view->icon_renderer), "size");

  /* setup the name renderer */
  standard_view->name_renderer = fmb_text_renderer_new ();
  g_object_ref_sink (G_OBJECT (standard_view->name_renderer));
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-single-click", G_OBJECT (standard_view->name_renderer), "follow-prelit");

  /* be sure to update the selection whenever the folder changes */
  g_signal_connect_swapped (G_OBJECT (standard_view->model), "notify::folder", G_CALLBACK (fmb_standard_view_selection_changed), standard_view);

  /* be sure to update the statusbar text whenever the number of
   * files in our model changes.
   */
  g_signal_connect_swapped (G_OBJECT (standard_view->model), "notify::num-files", G_CALLBACK (fmb_standard_view_update_statusbar_text), standard_view);

  /* be sure to update the statusbar text whenever the file-size-binary property changes */
  g_signal_connect_swapped (G_OBJECT (standard_view->model), "notify::file-size-binary", G_CALLBACK (fmb_standard_view_update_statusbar_text), standard_view);
  ...
  g_signal_connect_after (G_OBJECT (standard_view), "size-allocate",
                          G_CALLBACK (fmb_standard_view_size_allocate), NULL);
}



static GObject*
fmb_standard_view_constructor (GType                  type,
                                  guint                  n_construct_properties,
                                  GObjectConstructParam *construct_properties)
{
  FmbStandardView *standard_view;
  ...
  FmbColumn        sort_column;
  GtkSortType         sort_order;
  GtkWidget          *view;
  GObject            *object;

  /* let the GObject constructor create the instance */
  object = G_OBJECT_CLASS (fmb_standard_view_parent_class)->constructor (type,
                                                                            n_construct_properties,
                                                                            construct_properties);

  /* cast to standard_view for convenience */
  standard_view = FMB_STANDARD_VIEW (object);

  /* setup the default zoom-level, determined from the "last-<view>-zoom-level" preference */
  g_object_get (G_OBJECT (standard_view->preferences), FMB_STANDARD_VIEW_GET_CLASS (standard_view)->zoom_level_property_name, &zoom_level, NULL);
  fmb_view_set_zoom_level (FMB_VIEW (standard_view), zoom_level);

  /* save the "zoom-level" as "last-<view>-zoom-level" whenever the user changes the zoom level */
  g_object_bind_property (object, "zoom-level", G_OBJECT (standard_view->preferences), FMB_STANDARD_VIEW_GET_CLASS (standard_view)->zoom_level_property_name, G_BINDING_DEFAULT);
  ...
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-single-click", G_OBJECT (view), "single-click");
  blxo_binding_new (G_OBJECT (standard_view->preferences), "misc-single-click-timeout", G_OBJECT (view), "single-click-timeout");
  ...
  g_signal_connect (G_OBJECT (standard_view->model), "sort-column-changed", G_CALLBACK (fmb_standard_view_sort_column_changed), standard_view);

  /* setup support to navigate using a horizontal mouse wheel and the back and forward buttons */
  g_signal_connect (G_OBJECT (view), "scroll-event", G_CALLBACK (fmb_standard_view_scroll_event), object);
  g_signal_connect (G_OBJECT (view), "button-press-event", G_CALLBACK (fmb_standard_view_button_press_event), object);

  /* need to catch certain keys for the internal view widget */
  g_signal_connect (G_OBJECT (view), "key-press-event", G_CALLBACK (fmb_standard_view_key_press_event), object);
  ...
  g_signal_connect (G_OBJECT (view), "drag-drop", G_CALLBACK (fmb_standard_view_drag_drop), object);
  g_signal_connect (G_OBJECT (view), "drag-data-received", G_CALLBACK (fmb_standard_view_drag_data_received), object);
  g_signal_connect (G_OBJECT (view), "drag-leave", G_CALLBACK (fmb_standard_view_drag_leave), object);
  g_signal_connect (G_OBJECT (view), "drag-motion", G_CALLBACK (fmb_standard_view_drag_motion), object);
  ...
  g_signal_connect (G_OBJECT (view), "drag-begin", G_CALLBACK (fmb_standard_view_drag_begin), object);
  g_signal_connect (G_OBJECT (view), "drag-data-get", G_CALLBACK (fmb_standard_view_drag_data_get), object);
  g_signal_connect (G_OBJECT (view), "drag-data-delete", G_CALLBACK (fmb_standard_view_drag_data_delete), object);
  g_signal_connect (G_OBJECT (view), "drag-end", G_CALLBACK (fmb_standard_view_drag_end), object);
  ...
  g_signal_connect (adjustment, "value-changed",
                    G_CALLBACK (fmb_standard_view_scrolled), object);
...
fmb_standard_view_dispose (GObject *object)
{
  ...
  fmb_component_set_ui_manager (FMB_COMPONENT (standard_view), NULL);
  ...
  (*G_OBJECT_CLASS (fmb_standard_view_parent_class)->dispose) (object);
}



static void
fmb_standard_view_finalize (GObject *object)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (object);

  /* some safety checks */
  _fmb_assert (standard_view->loading_binding == NULL);
  _fmb_assert (standard_view->icon_factory == NULL);
  _fmb_assert (standard_view->ui_manager == NULL);
  _fmb_assert (standard_view->clipboard == NULL);

  /* release the thumbnailer */
  g_signal_handlers_disconnect_by_func (standard_view->priv->thumbnailer, fmb_standard_view_finished_thumbnailing, standard_view);
  ...
  fmb_g_file_list_free (standard_view->priv->selected_files);
  ...
  fmb_g_file_list_free (standard_view->priv->drag_g_file_list);

  /* release the drop path list (just in case the drag-leave wasn't fired before) */
  fmb_g_file_list_free (standard_view->priv->drop_file_list);
  ...
  fmb_g_file_list_free (standard_view->priv->new_files_path_list);
  ...
  (*G_OBJECT_CLASS (fmb_standard_view_parent_class)->finalize) (object);
}



static void
fmb_standard_view_get_property (GObject    *object,
                                   guint       prop_id,
                                   GValue     *value,
                                   GParamSpec *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_LOADING:
      g_value_set_boolean (value, fmb_view_get_loading (FMB_VIEW (object)));
      break;

    case PROP_DISPLAY_NAME:
      current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (object));
      if (current_directory != NULL)
        g_value_set_static_string (value, fmb_file_get_display_name (current_directory));
      break;

    case PROP_TOOLTIP_TEXT:
      current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (object));
      if (current_directory != NULL)
        g_value_take_string (value, g_file_get_parse_name (fmb_file_get_file (current_directory)));
      break;
    ...
    case PROP_SHOW_HIDDEN:
      g_value_set_boolean (value, fmb_view_get_show_hidden (FMB_VIEW (object)));
      break;

    case PROP_STATUSBAR_TEXT:
      g_value_set_static_string (value, fmb_view_get_statusbar_text (FMB_VIEW (object)));
      break;
    ...
    case PROP_ZOOM_LEVEL:
      g_value_set_enum (value, fmb_view_get_zoom_level (FMB_VIEW (object)));
      break;
...
static void
fmb_standard_view_set_property (GObject      *object,
                                   guint         prop_id,
                                   const GValue *value,
                                   GParamSpec   *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_LOADING:
      fmb_standard_view_set_loading (standard_view, g_value_get_boolean (value));
      break;
    ...
    case PROP_SHOW_HIDDEN:
      fmb_view_set_show_hidden (FMB_VIEW (object), g_value_get_boolean (value));
      break;
    ...
    case PROP_ZOOM_LEVEL:
      fmb_view_set_zoom_level (FMB_VIEW (object), g_value_get_enum (value));
      break;
...
static void
fmb_standard_view_realize (GtkWidget *widget)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (widget);
  GtkIconTheme       *icon_theme;
  GdkDisplay         *display;

  /* let the GtkWidget do its work */
  GTK_WIDGET_CLASS (fmb_standard_view_parent_class)->realize (widget);

  /* query the clipboard manager for the display */
  display = gtk_widget_get_display (widget);
  standard_view->clipboard = fmb_clipboard_manager_get_for_display (display);
  ...
  g_signal_connect_swapped (G_OBJECT (standard_view->clipboard), "changed",
                            G_CALLBACK (fmb_standard_view_selection_changed), standard_view);

  /* determine the icon factory for the screen on which we are realized */
  icon_theme = gtk_icon_theme_get_for_screen (gtk_widget_get_screen (widget));
  standard_view->icon_factory = fmb_icon_factory_get_for_icon_theme (icon_theme);
  ...
  g_signal_connect_swapped (standard_view->icon_factory,
                            ...
                            G_CALLBACK (fmb_standard_view_thumbnail_mode_toggled),
                            standard_view);
}
...
static void
fmb_standard_view_unrealize (GtkWidget *widget)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (widget);

  /* disconnect the clipboard changed handler */
  g_signal_handlers_disconnect_by_func (G_OBJECT (standard_view->clipboard), fmb_standard_view_selection_changed, standard_view);
  ...
  /* let the GtkWidget do its work */
  GTK_WIDGET_CLASS (fmb_standard_view_parent_class)->unrealize (widget);
}



static void
fmb_standard_view_grab_focus (GtkWidget *widget)
{
...
static gboolean
fmb_standard_view_expose_event (GtkWidget      *widget,
                                   GdkEventExpose *event)
{
  ...
  result = (*GTK_WIDGET_CLASS (fmb_standard_view_parent_class)->expose_event) (widget, event);

  /* render the folder drop shadow */
  if (G_UNLIKELY (FMB_STANDARD_VIEW (widget)->priv->drop_highlight))
    {
...
static GList*
fmb_standard_view_get_selected_files (FmbComponent *component)
{
  return FMB_STANDARD_VIEW (component)->priv->selected_files;
}



static void
fmb_standard_view_set_selected_files (FmbComponent *component,
                                         GList           *selected_files)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (component);
  ...
  if (fmb_view_get_loading (FMB_VIEW (standard_view)))
    {
      /* remember a copy of the list for later */
      standard_view->priv->selected_files = fmb_g_file_list_copy (selected_files);
    }
  else
    {
      ...
      (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->unselect_all) (standard_view);

      /* determine the tree paths for the given files */
      paths = fmb_list_model_get_paths_for_files (standard_view->model, selected_files);
      if (G_LIKELY (paths != NULL))
        {
          ...
          (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->set_cursor) (standard_view, first_path, FALSE);

          /* select the given tree paths paths */
          for (first_path = paths->data, lp = paths; lp != NULL; lp = lp->next)
            {
              /* select the path */
              (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->select_path) (standard_view, lp->data);
            }

          /* scroll to the first path (previously determined) */
          (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->scroll_to_path) (standard_view, first_path, FALSE, 0.0f, 0.0f);
...
static GtkUIManager*
fmb_standard_view_get_ui_manager (FmbComponent *component)
{
  return FMB_STANDARD_VIEW (component)->ui_manager;
}



static void
fmb_standard_view_set_ui_manager (FmbComponent *component,
                                     GtkUIManager    *ui_manager)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (component);
  GError             *error = NULL;
  ...
  if (G_LIKELY (standard_view->ui_manager != NULL))
    {
      ...
      (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->disconnect_ui_manager) (standard_view, standard_view->ui_manager);
  ...
  if (G_LIKELY (ui_manager != NULL))
    {
      ...
      standard_view->ui_merge_id = gtk_ui_manager_add_ui_from_string (ui_manager, fmb_standard_view_ui,
                                                                      fmb_standard_view_ui_length, &error);
      if (G_UNLIKELY (standard_view->ui_merge_id == 0))
        {
          g_error ("Failed to merge FmbStandardView menus: %s", error->message);
          g_error_free (error);
        }

      /* merge the ui controls from derived classes */
      (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->connect_ui_manager) (standard_view, ui_manager);
...
static FmbFile*
fmb_standard_view_get_current_directory (FmbNavigator *navigator)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (navigator);
  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), NULL);
...
static void
fmb_standard_view_scroll_position_save (FmbStandardView *standard_view)
{
  FmbFile    *first_file;
  ...
  if (standard_view->priv->current_directory != NULL)
    {
      ...
      gfile = fmb_file_get_file (standard_view->priv->current_directory);
      ...
      else if (fmb_view_get_visible_range (FMB_VIEW (standard_view), &first_file, NULL))
        {
          ...
          g_hash_table_replace (standard_view->priv->scroll_to_files,
                                g_object_ref (gfile),
                                g_object_ref (fmb_file_get_file (first_file)));
...
static void
fmb_standard_view_restore_selection_from_history (FmbStandardView *standard_view)
{
  GList       selected_files;
  FmbFile *selected_file;

  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (FMB_IS_FILE (standard_view->priv->current_directory));
  ...
  selected_file = fmb_history_peek_forward (standard_view->priv->history);
  if (selected_file != NULL)
    {
      /* mark the file from history for selection if it is inside the new
       * directory */
      if (fmb_file_is_parent (standard_view->priv->current_directory, selected_file))
  ...
  if (selected_files.data == NULL)
    {
      selected_file = fmb_history_peek_back (standard_view->priv->history);
      if (selected_file != NULL)
        {
  ...
  if (selected_files.data != NULL)
    {
      fmb_component_set_selected_files (FMB_COMPONENT (standard_view), &selected_files);
...
static void
fmb_standard_view_set_current_directory (FmbNavigator *navigator,
                                            FmbFile      *current_directory)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (navigator);
  FmbFolder       *folder;
  ...
  if (current_directory != NULL)
    fmb_standard_view_scroll_position_save (standard_view);
  ...
  if (G_UNLIKELY (current_directory == NULL))
    {
      ...
      fmb_list_model_set_folder (standard_view->model, NULL);
  ...
  g_signal_connect (G_OBJECT (current_directory), "destroy", G_CALLBACK (fmb_standard_view_current_directory_destroy), standard_view);
  g_signal_connect (G_OBJECT (current_directory), "changed", G_CALLBACK (fmb_standard_view_current_directory_changed), standard_view);
  ...
  fmb_navigator_set_current_directory (FMB_NAVIGATOR (standard_view->priv->history), current_directory);
  ...
  folder = fmb_folder_get_for_file (current_directory);

  /* connect the "loading" binding */
  standard_view->loading_binding = blxo_binding_new_full (G_OBJECT (folder), "loading",
                                                         G_OBJECT (standard_view), "loading",
                                                         NULL, fmb_standard_view_loading_unbound,
                                                         standard_view);

  /* apply the new folder */
  fmb_list_model_set_folder (standard_view->model, folder);
  ...
  trashed = fmb_file_is_trashed (current_directory);
  ...
  fmb_standard_view_restore_selection_from_history (standard_view);
}



static gboolean
fmb_standard_view_get_loading (FmbView *view)
{
  return FMB_STANDARD_VIEW (view)->loading;
}



static void
fmb_standard_view_set_loading (FmbStandardView *standard_view,
                                  gboolean            loading)
{
  FmbFile *file;
  GList      *new_files_path_list;
      ...
      if (standard_view->priv->scroll_to_file != NULL)
        {
          ...
          /* and try again */
          fmb_view_scroll_to_file (FMB_VIEW (standard_view), file,
      ...
      else
        {
          ...
          current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (standard_view));
          if (G_LIKELY (current_directory != NULL))
            {
              first_file = g_hash_table_lookup (standard_view->priv->scroll_to_files, fmb_file_get_file (current_directory));
              if (G_LIKELY (first_file != NULL))
                {
                  file = fmb_file_cache_lookup (first_file);
                  if (G_LIKELY (file != NULL))
                    {
                      fmb_view_scroll_to_file (FMB_VIEW (standard_view), file, FALSE, TRUE, 0.0f, 0.0f);
                      g_object_unref (file);
                    }
                }
            }
  ...
  if (G_UNLIKELY (!loading && standard_view->priv->new_files_path_list != NULL))
    {
      ...
      /* and try again */
      fmb_standard_view_new_files (standard_view, new_files_path_list);

      /* cleanup */
      fmb_g_file_list_free (new_files_path_list);
    }
  ...
  if (!loading && standard_view->priv->thumbnailing_scheduled)
    {
       ...
       * of a timeout. */
      fmb_standard_view_schedule_thumbnail_idle (standard_view);
      standard_view->priv->thumbnailing_scheduled = FALSE;
    }
  ...
  fmb_standard_view_update_statusbar_text (standard_view);
...
static const gchar*
fmb_standard_view_get_statusbar_text (FmbView *view)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (view);
  GList              *items;
  ...
  if (standard_view->priv->statusbar_text == NULL)
    {
      ...
      items = FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_selected_items (standard_view);
      ...
      standard_view->priv->statusbar_text = fmb_list_model_get_statusbar_text (standard_view->model, items);
...
static gboolean
fmb_standard_view_get_show_hidden (FmbView *view)
{
  return fmb_list_model_get_show_hidden (FMB_STANDARD_VIEW (view)->model);
}



static void
fmb_standard_view_set_show_hidden (FmbView *view,
                                      gboolean    show_hidden)
{
  fmb_list_model_set_show_hidden (FMB_STANDARD_VIEW (view)->model, show_hidden);
}



static FmbZoomLevel
fmb_standard_view_get_zoom_level (FmbView *view)
{
  return FMB_STANDARD_VIEW (view)->priv->zoom_level;
}



static void
fmb_standard_view_set_zoom_level (FmbView     *view,
                                     FmbZoomLevel zoom_level)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (view);
...
static void
fmb_standard_view_reset_zoom_level (FmbView *view)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (view);
  ...
  property_name = FMB_STANDARD_VIEW_GET_CLASS (standard_view)->zoom_level_property_name;
  pspec = g_object_class_find_property (G_OBJECT_GET_CLASS (standard_view->preferences), property_name);
  g_value_init (&value, FMB_TYPE_ZOOM_LEVEL);
...
static void
fmb_standard_view_reload (FmbView *view,
                             gboolean    reload_info)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (view);
  FmbFolder       *folder;
  ...
  folder = fmb_list_model_get_folder (standard_view->model);
  if (G_LIKELY (folder != NULL))
    fmb_folder_reload (folder, reload_info);
...
static gboolean
fmb_standard_view_get_visible_range (FmbView  *view,
                                        FmbFile **start_file,
                                        FmbFile **end_file)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (view);
  ...
  if ((*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_visible_range) (standard_view, &start_path, &end_path))
    {
      ...
      if (G_LIKELY (start_file != NULL))
        {
          ...
          *start_file = fmb_list_model_get_file (standard_view->model, &iter);
        }
      ...
      if (G_LIKELY (end_file != NULL))
        {
          ...
          *end_file = fmb_list_model_get_file (standard_view->model, &iter);
        }
...
static void
fmb_standard_view_scroll_to_file (FmbView *view,
                                     FmbFile *file,
                                     gboolean    select_file,
                                     gboolean    use_align,
                                     gfloat      row_align,
                                     gfloat      col_align)
{
  ...
  if (fmb_view_get_loading (view))
  ...
  else
    {
      ...
      paths = fmb_list_model_get_paths_for_files (standard_view->model, &files);
      if (G_LIKELY (paths != NULL))
        {
          /* scroll to the path */
          (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->scroll_to_path) (standard_view, paths->data, use_align, row_align, col_align);
          ...
          if (G_UNLIKELY (select_file))
            {
              ...
              (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->unselect_all) (standard_view);
              (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->select_path) (standard_view, paths->data);
            }
...
static gboolean
fmb_standard_view_delete_selected_files (FmbStandardView *standard_view)
{
  GtkAction       *action = GTK_ACTION (standard_view->priv->action_move_to_trash);
  const gchar     *accel_path;
  GtkAccelKey      key;

  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), FALSE);
...
fmb_standard_view_get_dest_actions (FmbStandardView *standard_view,
                                       GdkDragContext     *context,
                                       gint                x,
                                       gint                y,
                                       guint               timestamp,
                                       FmbFile        **file_return)
{
  ...
  file = fmb_standard_view_get_drop_file (standard_view, x, y, &path);

  /* check if we can drop there */
  if (G_LIKELY (file != NULL))
    {
      /* determine the possible drop actions for the file (and the suggested action if any) */
      actions = fmb_file_accepts_drop (file, standard_view->priv->drop_file_list, context, &action);
  ...
  (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->highlight_path) (standard_view, path);
...
static FmbFile*
fmb_standard_view_get_drop_file (FmbStandardView *standard_view,
                                    gint                x,
                                    gint                y,
                                    GtkTreePath       **path_return)
{
  ...
  path = (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_path_at_pos) (standard_view, x, y);
  if (G_LIKELY (path != NULL))
    {
      /* determine the file for the path */
      gtk_tree_model_get_iter (GTK_TREE_MODEL (standard_view->model), &iter, path);
      file = fmb_list_model_get_file (standard_view->model, &iter);

      /* we can only drop to directories and executable files */
      if (!fmb_file_is_directory (file) && !fmb_file_is_executable (file))
        {
  ...
  if (G_UNLIKELY (path == NULL))
    {
      ...
      file = fmb_navigator_get_current_directory (FMB_NAVIGATOR (standard_view));
      if (G_LIKELY (file != NULL))
...
static void
fmb_standard_view_merge_custom_actions (FmbStandardView *standard_view,
                                           GList              *selected_items)
{
  GtkTreeIter iter;
  FmbFile *file = NULL;
  ...
  providers = fmbx_provider_factory_list_providers (standard_view->priv->provider_factory, FMBX_TYPE_MENU_PROVIDER);
      ...
      for (lp = providers; lp != NULL; lp = lp->next)
        {
          if (G_LIKELY (files != NULL))
            tmp = fmbx_menu_provider_get_file_actions (lp->data, window, files);
  ...
  if (G_LIKELY (actions != NULL))
    {
      ...
      standard_view->priv->custom_actions = gtk_action_group_new ("fmb-standard-view-custom-actions");
...
static gboolean
fmb_standard_view_update_statusbar_text_idle (gpointer data)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (data);
...
static void
fmb_standard_view_update_statusbar_text (FmbStandardView *standard_view)
{
  ...
  standard_view->priv->statusbar_text_idle_id =
      g_timeout_add_full (G_PRIORITY_LOW, 50, fmb_standard_view_update_statusbar_text_idle,
                          standard_view, NULL);
}
 ...
 */
static FmbFile *
fmb_standard_view_get_fallback_directory (FmbFile *directory,
                                             GError     *error)
{
  FmbFile *new_directory = NULL;
  GFile      *path;
  GFile      *tmp;

  _fmb_return_val_if_fail (FMB_IS_FILE (directory), NULL);

  /* determine the path of the directory */
  path = g_object_ref (fmb_file_get_file (directory));
      ...
      if (g_file_query_exists (path, NULL))
        {
          ...
          new_directory = fmb_file_get (path, NULL);
  ...
  if (new_directory == NULL)
    {
      ...
      path = fmb_g_file_new_for_home ();
      new_directory = fmb_file_get (path, &error);
      g_object_unref (path);
    }
...
static void
fmb_standard_view_current_directory_destroy (FmbFile         *current_directory,
                                                FmbStandardView *standard_view)
{
  GtkWidget  *window;
  FmbFile *new_directory = NULL;
  ...
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (FMB_IS_FILE (current_directory));
  _fmb_return_if_fail (standard_view->priv->current_directory == current_directory);

  /* get a fallback directory (parents or home) we can navigate to */
  new_directory = fmb_standard_view_get_fallback_directory (current_directory, error);
  if (G_UNLIKELY (new_directory == NULL))
    {
      /* display an error to the user */
      fmb_dialogs_show_error (GTK_WIDGET (standard_view), error, _("Failed to open the home folder"));
      g_error_free (error);
      return;
    }
  ...
  window = gtk_widget_get_toplevel (GTK_WIDGET (standard_view));
  fmb_window_update_directories (FMB_WINDOW (window),
                                    current_directory,
                                    new_directory);
...
static void
fmb_standard_view_current_directory_changed (FmbFile         *current_directory,
                                                FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (FMB_IS_FILE (current_directory));
  ...
  fmb_standard_view_schedule_thumbnail_timeout (standard_view);
}



static void
fmb_standard_view_action_create_empty_file (GtkAction          *action,
                                               FmbStandardView *standard_view)
{
  ...
  name = fmb_show_create_dialog (GTK_WIDGET (standard_view),
                                    "text/plain",
                                    _("New Empty File"),
                                    _("New Empty File..."));
  if (G_LIKELY (name != NULL))
    {
      /* determine the FmbFile for the current directory */
      current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (standard_view));
      if (G_LIKELY (current_directory != NULL))
        {
          /* fake the path list */
          path_list.data = g_file_resolve_relative_path (fmb_file_get_file (current_directory), name);
          path_list.next = path_list.prev = NULL;

          /* launch the operation */
          application = fmb_application_get ();
          fmb_application_creat (application, GTK_WIDGET (standard_view), &path_list, NULL,
                                    fmb_standard_view_new_files_closure (standard_view, NULL));
...
static void
fmb_standard_view_action_create_folder (GtkAction          *action,
                                           FmbStandardView *standard_view)
{
  FmbApplication *application;
  FmbFile        *current_directory;
      ...
      if (G_LIKELY (current_directory != NULL))
        {
          ...
          /* launch the operation */
          application = fmb_application_get ();
          fmb_application_mkdir (application, GTK_WIDGET (standard_view), &path_list,
                                    fmb_standard_view_new_files_closure (standard_view, NULL));
...
static void
fmb_standard_view_action_create_template (GtkAction           *action,
                                             const FmbFile    *file,
                                             FmbStandardView  *standard_view)
{
  FmbApplication *application;
  ...
  name = fmb_show_create_dialog (GTK_WIDGET (standard_view),
                                    fmb_file_get_content_type (FMB_FILE (file)),
                                    fmb_file_get_display_name (file),
                                    title);
  if (G_LIKELY (name != NULL))
    {
      ...
      if (G_LIKELY (current_directory != NULL))
        {
          ...
          target_path_list.data = g_file_get_child (fmb_file_get_file (current_directory), name);
          target_path_list.next = NULL;
          target_path_list.prev = NULL;

          /* launch the operation */
          application = fmb_application_get ();
          fmb_application_creat (application, GTK_WIDGET (standard_view), &target_path_list,
                                    fmb_file_get_file (file),
                                    fmb_standard_view_new_files_closure (standard_view, NULL));
          g_object_unref (G_OBJECT (application));
...
static void
fmb_standard_view_action_properties (GtkAction          *action,
                                        FmbStandardView *standard_view)
{
  FmbFile *directory;
  GtkWidget  *toplevel;
      ...
      if (standard_view->priv->selected_files == NULL)
        {
           ...
           */
          directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (standard_view));
          fmb_properties_dialog_set_file (FMB_PROPERTIES_DIALOG (dialog), directory);
        }
      else
        {
          /* popup the properties dialog for all file(s) */
          fmb_properties_dialog_set_files (FMB_PROPERTIES_DIALOG (dialog),
...
static void
fmb_standard_view_action_cut (GtkAction          *action,
                                 FmbStandardView *standard_view)
{
  _fmb_return_if_fail (GTK_IS_ACTION (action));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (FMB_IS_CLIPBOARD_MANAGER (standard_view->clipboard));

  fmb_clipboard_manager_cut_files (standard_view->clipboard, standard_view->priv->selected_files);
}



static void
fmb_standard_view_action_copy (GtkAction          *action,
                                  FmbStandardView *standard_view)
{
  _fmb_return_if_fail (GTK_IS_ACTION (action));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  fmb_clipboard_manager_copy_files (standard_view->clipboard, standard_view->priv->selected_files);
}



static void
fmb_standard_view_action_paste (GtkAction          *action,
                                   FmbStandardView *standard_view)
{
  FmbFile *current_directory;
  ...
  if (G_LIKELY (current_directory != NULL))
    {
      fmb_clipboard_manager_paste_files (standard_view->clipboard, fmb_file_get_file (current_directory),
                                            GTK_WIDGET (standard_view), fmb_standard_view_new_files_closure (standard_view, NULL));
    }
}
...
static void
fmb_standard_view_unlink_selection (FmbStandardView *standard_view,
                                       gboolean            permanently)
{
  ...
  application = fmb_application_get ();
  fmb_application_unlink_files (application, GTK_WIDGET (standard_view),
                                   standard_view->priv->selected_files,
                                   permanently);
  g_object_unref (G_OBJECT (application));

  /* do not select new files */
  fmb_component_set_selected_files (FMB_COMPONENT (standard_view), NULL);
}



static void
fmb_standard_view_action_move_to_trash (GtkAction          *action,
                                           FmbStandardView *standard_view)
{
  gboolean           permanently;
  ...
  fmb_standard_view_unlink_selection (standard_view, permanently);
}



static void
fmb_standard_view_action_delete (GtkAction          *action,
                                    FmbStandardView *standard_view)
{
  fmb_standard_view_unlink_selection (standard_view, TRUE);
}



static void
fmb_standard_view_action_paste_into_folder (GtkAction          *action,
                                               FmbStandardView *standard_view)
{
  FmbFile *file;
  ...
  if (G_LIKELY (file != NULL && fmb_file_is_directory (file)))
    fmb_clipboard_manager_paste_files (standard_view->clipboard, fmb_file_get_file (file), GTK_WIDGET (standard_view), NULL);
}



static void
fmb_standard_view_action_select_all_files (GtkAction          *action,
                                              FmbStandardView *standard_view)
{
  _fmb_return_if_fail (GTK_IS_ACTION (action));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->select_all) (standard_view);
}



static void
fmb_standard_view_action_select_by_pattern (GtkAction          *action,
                                               FmbStandardView *standard_view)
{
  GtkWidget   *window;
  GtkWidget   *dialog;
  ...
  if (response == GTK_RESPONSE_OK)
    {
      ...
      paths = fmb_list_model_get_paths_for_pattern (standard_view->model, pattern);
      FMB_STANDARD_VIEW_GET_CLASS (standard_view)->unselect_all (standard_view);

      /* set the cursor and scroll to the first selected item */
      if (paths != NULL)
        FMB_STANDARD_VIEW_GET_CLASS (standard_view)->set_cursor (standard_view, g_list_last (paths)->data, FALSE);
...
static void
fmb_standard_view_action_selection_invert (GtkAction          *action,
                                              FmbStandardView *standard_view)
{
  _fmb_return_if_fail (GTK_IS_ACTION (action));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->selection_invert) (standard_view);
}



static void
fmb_standard_view_action_duplicate (GtkAction          *action,
                                       FmbStandardView *standard_view)
{
  FmbApplication *application;
  FmbFile        *current_directory;
  ...
  if (G_LIKELY (current_directory != NULL))
    {
      ...
      selected_files = fmb_file_list_to_fmb_g_file_list (standard_view->priv->selected_files);
      if (G_LIKELY (selected_files != NULL))
        {
           ...
           */
          application = fmb_application_get ();
          new_files_closure = fmb_standard_view_new_files_closure (standard_view, NULL);
          fmb_application_copy_into (application, GTK_WIDGET (standard_view), selected_files,
                                        fmb_file_get_file (current_directory), new_files_closure);
          g_object_unref (G_OBJECT (application));
...
static void
fmb_standard_view_action_make_link (GtkAction          *action,
                                       FmbStandardView *standard_view)
{
  FmbApplication *application;
  FmbFile        *current_directory;
      ...
      if (G_LIKELY (selected_files != NULL))
        {
          ...
          application = fmb_application_get ();
          new_files_closure = fmb_standard_view_new_files_closure (standard_view, NULL);
          fmb_application_link_into (application, GTK_WIDGET (standard_view), selected_files,
                                        fmb_file_get_file (current_directory), new_files_closure);
          g_object_unref (G_OBJECT (application));
...
static void
fmb_standard_view_rename_error (BlxoJob             *job,
                                   GError             *error,
                                   FmbStandardView *standard_view)
{
  GArray     *param_values;
  ...
  fmb_dialogs_show_error (GTK_WIDGET (standard_view), error,
...
static void
fmb_standard_view_rename_finished (BlxoJob             *job,
                                      FmbStandardView *standard_view)
{
  GArray     *param_values;
  FmbFile *file;
  ...
  fmb_view_scroll_to_file (FMB_VIEW (standard_view), file, TRUE, FALSE, 0.0f, 0.0f);

  /* update the selection, so we get updated actions, statusbar,
   * etc. with the new file name and probably new mime type.
   */
  fmb_standard_view_selection_changed (standard_view);
...
static void
fmb_standard_view_action_rename (GtkAction          *action,
                                    FmbStandardView *standard_view)
{
  FmbFile      *file;
  GtkWidget       *window;
  ...
  if (!force_bulk_renamer
      && standard_view->priv->selected_files->next == NULL)
    {
      ...
      /* get the file */
      file = FMB_FILE (standard_view->priv->selected_files->data);

      /* run the rename dialog */
      job = fmb_dialogs_show_rename_file (GTK_WINDOW (window), file);
      if (G_LIKELY (job != NULL))
        {
          g_signal_connect (job, "error", G_CALLBACK (fmb_standard_view_rename_error), standard_view);
          g_signal_connect (job, "finished", G_CALLBACK (fmb_standard_view_rename_finished), standard_view);
        }
    }
  else
    {
      ...
      fmb_show_renamer_dialog (GTK_WIDGET (standard_view), file, standard_view->priv->selected_files, FALSE, NULL);
    }
}
...
static void
fmb_standard_view_action_restore (GtkAction          *action,
                                     FmbStandardView *standard_view)
{
  FmbApplication *application;
  ...
  application = fmb_application_get ();
  fmb_application_restore_files (application, GTK_WIDGET (standard_view), standard_view->priv->selected_files,
                                    fmb_standard_view_new_files_closure (standard_view, NULL));
  g_object_unref (G_OBJECT (application));
}
...
static GClosure*
fmb_standard_view_new_files_closure (FmbStandardView *standard_view,
                                        GtkWidget          *source_view)
{
  _fmb_return_val_if_fail (source_view == NULL || FMB_IS_VIEW (source_view), NULL);
  ...
  standard_view->priv->new_files_closure = g_cclosure_new_swap (G_CALLBACK (fmb_standard_view_new_files), standard_view, NULL);
...
static void
fmb_standard_view_new_files (FmbStandardView *standard_view,
                                GList              *path_list)
{
  FmbFile*file;
  ...
  if (G_UNLIKELY (standard_view->loading))
    {
      ...
      standard_view->priv->new_files_path_list = fmb_g_file_list_copy (path_list);
    }
  else if (G_LIKELY (path_list != NULL))
    {
      /* to check if we should reload */
      parent_file = fmb_file_get_file (standard_view->priv->current_directory);
      belongs_here = FALSE;
      ...
      if (G_LIKELY (file_list != NULL))
        {
          /* select the files */
          fmb_component_set_selected_files (FMB_COMPONENT (standard_view), file_list);
        ...
        {
          /* fmb files are not created yet, try again later because we know
  ...
  if (FMB_IS_VIEW (source_view))
    fmb_view_reload (FMB_VIEW (source_view), FALSE);
}



static gboolean
fmb_standard_view_button_release_event (GtkWidget          *view,
                                           GdkEventButton     *event,
                                           FmbStandardView *standard_view)
{
  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), FALSE);
  _fmb_return_val_if_fail (standard_view->priv->drag_timer_id != 0, FALSE);

  /* cancel the pending drag timer */
  g_source_remove (standard_view->priv->drag_timer_id);

  /* fire up the context menu */
  fmb_standard_view_context_menu (standard_view, 0, event->time);
...
static gboolean
fmb_standard_view_motion_notify_event (GtkWidget          *view,
                                          GdkEventMotion     *event,
                                          FmbStandardView *standard_view)
{
  GdkDragContext *context;
...
static gboolean
fmb_standard_view_scroll_event (GtkWidget          *view,
                                   GdkEventScroll     *event,
                                   FmbStandardView *standard_view)
{
      ...
      if (G_UNLIKELY (misc_horizontal_wheel_navigates))
        {
          ...
          return fmb_standard_view_button_press_event (view, &fake_event, standard_view);
        }
    }
  ...
  if ((event->state & GDK_CONTROL_MASK) != 0 && (event->direction == GDK_SCROLL_UP || event->direction == GDK_SCROLL_DOWN))
    {
      fmb_view_set_zoom_level (FMB_VIEW (standard_view),
          (event->direction == GDK_SCROLL_UP)
          ? MIN (standard_view->priv->zoom_level + 1, FMB_ZOOM_N_LEVELS - 1)
...
static gboolean
fmb_standard_view_button_press_event (GtkWidget          *view,
                                         GdkEventButton     *event,
                                         FmbStandardView *standard_view)
{
...
static gboolean
fmb_standard_view_key_press_event (GtkWidget          *view,
                                      GdkEventKey        *event,
                                      FmbStandardView *standard_view)
{
  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), FALSE);
...
static gboolean
fmb_standard_view_drag_drop (GtkWidget          *view,
                                GdkDragContext     *context,
                                gint                x,
                                gint                y,
                                guint               timestamp,
                                FmbStandardView *standard_view)
{
  ...
  if (G_UNLIKELY (target == GDK_NONE))
  ...
  else if (G_UNLIKELY (target == gdk_atom_intern_static_string ("XdndDirectSave0")))
    {
      ...
      file = fmb_standard_view_get_drop_file (standard_view, x, y, NULL);
      if (G_LIKELY (file != NULL))
        {
              ...
              if (G_LIKELY (*prop_text != '\0' && strchr ((const gchar *) prop_text, G_DIR_SEPARATOR) == NULL))
                {
                  ...
                  path = g_file_resolve_relative_path (fmb_file_get_file (file),
              ...
              else
                {
                  ...
                  fmb_dialogs_show_error (GTK_WIDGET (standard_view), NULL, _("Invalid filename provided by XDS drag site"));
                }
...
static void
fmb_standard_view_drag_data_received (GtkWidget          *view,
                                         GdkDragContext     *context,
                                         gint                x,
                                         gint                y,
                                         GtkSelectionData   *selection_data,
  ...
  if (G_LIKELY (!standard_view->priv->drop_data_ready))
    {
      ...
      if (info == TARGET_TEXT_URI_LIST && selection_data->format == 8 && selection_data->length > 0)
        standard_view->priv->drop_file_list = fmb_g_file_list_new_from_string ((gchar *) selection_data->data);
  ...
  if (G_UNLIKELY (standard_view->priv->drop_occurred))
    {
      ...
      if (G_UNLIKELY (info == TARGET_XDND_DIRECT_SAVE0))
                  ...
                  if (fmb_file_is_directory (file))
                    {
                      ...
                      folder = fmb_folder_get_for_file (file);
                  ...
                  if (G_LIKELY (file != NULL))
                    {
                      ...
                      working_directory = g_file_get_path (fmb_file_get_file (file));
                      if (G_LIKELY (working_directory != NULL))
                        {
                          /* prepare the basic part of the command */
                          argv[n++] = "blxo-desktop-item-edit";
                          argv[n++] = "--type=Link";
                          argv[n++] = "--url";
                          argv[n++] = bits[0];
                          argv[n++] = "--name";
                          ...
                          /* try to run blxo-desktop-item-edit */
                          ...
                          if (G_UNLIKELY (!succeed))
                            {
                              ...
                              fmb_dialogs_show_error (standard_view, error, _("Failed to create a link for the URL \"%s\""), bits[0]);
      ...
      else if (G_LIKELY (info == TARGET_TEXT_URI_LIST))
        {
          ...
          actions = fmb_standard_view_get_dest_actions (standard_view, context, x, y, timestamp, &file);
          if (G_LIKELY ((actions & (GDK_ACTION_COPY | GDK_ACTION_MOVE | GDK_ACTION_LINK)) != 0))
            {
              /* ask the user what to do with the drop data */
              action = (context->action == GDK_ACTION_ASK)
                     ? fmb_dnd_ask (GTK_WIDGET (standard_view), file, standard_view->priv->drop_file_list, timestamp, actions)
                     : context->action;
                  ...
                  if (source_widget != NULL)
                    {
                       ...
                       * the data, see fmb_standard_view_new_files */
                      source_view = gtk_widget_get_parent (source_widget);
                      if (!FMB_IS_VIEW (source_view))
                        source_view = NULL;
                    }

                  succeed = fmb_dnd_perform (GTK_WIDGET (standard_view), file, standard_view->priv->drop_file_list,
                                                action, fmb_standard_view_new_files_closure (standard_view, source_view));
                }
            }
      ...
      fmb_standard_view_drag_leave (view, context, timestamp, standard_view);
    }
}
...
static void
fmb_standard_view_drag_leave (GtkWidget          *widget,
                                 GdkDragContext     *context,
                                 guint               timestamp,
                                 FmbStandardView *standard_view)
{
  ...
  (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->highlight_path) (standard_view, NULL);
}



static gboolean
fmb_standard_view_drag_motion (GtkWidget          *view,
                                  GdkDragContext     *context,
                                  gint                x,
                                  gint                y,
                                  guint               timestamp,
                                  FmbStandardView *standard_view)
{
  ...
  if (G_UNLIKELY (!standard_view->priv->drop_data_ready))
      ...
      if ((target == gdk_atom_intern_static_string ("XdndDirectSave0")) || (target == gdk_atom_intern_static_string ("_NETSCAPE_URL")))
        {
          ...
          if (G_LIKELY (file != NULL
                        && fmb_file_is_local (file)
                        && fmb_file_is_directory (file)
                        && fmb_file_is_writable (file)))
            {
  ...
  else
    {
      ...
      fmb_standard_view_get_dest_actions (standard_view, context, x, y, timestamp, NULL);
    }
  ...
  if (G_UNLIKELY (standard_view->priv->drag_scroll_timer_id == 0))
    {
      ...
      standard_view->priv->drag_scroll_timer_id = g_timeout_add_full (G_PRIORITY_LOW, 50, fmb_standard_view_drag_scroll_timer,
                                                                      standard_view, fmb_standard_view_drag_scroll_timer_destroy);
    }
...
static void
fmb_standard_view_drag_begin (GtkWidget          *view,
                                 GdkDragContext     *context,
                                 FmbStandardView *standard_view)
{
  FmbFile *file;
  ...
  standard_view->priv->drag_g_file_list = fmb_file_list_to_fmb_g_file_list (standard_view->priv->selected_files);
  if (G_LIKELY (standard_view->priv->drag_g_file_list != NULL))
    {
      /* determine the first selected file */
      file = fmb_file_get (standard_view->priv->drag_g_file_list->data, NULL);
      if (G_LIKELY (file != NULL))
        {
          /* generate an icon based on that file */
          g_object_get (G_OBJECT (standard_view->icon_renderer), "size", &size, NULL);
          icon = fmb_icon_factory_load_file_icon (standard_view->icon_factory, file, FMB_FILE_ICON_STATE_DEFAULT, size);
...
static void
fmb_standard_view_drag_data_get (GtkWidget          *view,
                                    GdkDragContext     *context,
                                    GtkSelectionData   *selection_data,
                                    guint               info,
                                    guint               timestamp,
                                    FmbStandardView *standard_view)
{
  ...
  if (standard_view->priv->drag_g_file_list != NULL)
    {
      uris = fmb_g_file_list_to_stringv (standard_view->priv->drag_g_file_list);
...
static void
fmb_standard_view_drag_data_delete (GtkWidget          *view,
                                       GdkDragContext     *context,
                                       FmbStandardView *standard_view)
{
  /* make sure the default handler of BlxoIconView/GtkTreeView is never run */
...
static void
fmb_standard_view_drag_end (GtkWidget          *view,
                               GdkDragContext     *context,
                               FmbStandardView *standard_view)
{
  /* stop any running drag autoscroll timer */
...
static void
fmb_standard_view_row_deleted (FmbListModel    *model,
                                  GtkTreePath        *path,
                                  FmbStandardView *standard_view)
{
  ...
  _fmb_return_if_fail (path != NULL);
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (standard_view->model == model);

  /* Get tree paths of selected files */
  selected_items = (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_selected_items) (standard_view);
...
static gboolean
fmb_standard_view_restore_selection_idle (FmbStandardView *standard_view)
{
  GtkAdjustment *hadjustment;
  GtkAdjustment *vadjustment;
  ...
  fmb_component_restore_selection (FMB_COMPONENT (standard_view));
...
static void
fmb_standard_view_rows_reordered (FmbListModel    *model,
                                     GtkTreePath        *path,
                                     GtkTreeIter        *iter,
                                     gpointer            new_order,
                                     FmbStandardView *standard_view)
{
  ...
  if (standard_view->priv->restore_selection_idle_id == 0)
    standard_view->priv->restore_selection_idle_id =
      g_timeout_add (50,
                     (GSourceFunc) fmb_standard_view_restore_selection_idle,
                     standard_view);
}
...
static void
fmb_standard_view_row_changed (FmbListModel    *model,
                                  GtkTreePath        *path,
                                  GtkTreeIter        *iter,
                                  FmbStandardView *standard_view)
{
  ...
  if (!fmb_icon_factory_get_show_thumbnail (standard_view->icon_factory,
                                               standard_view->priv->current_directory))
    return;

  /* queue a thumbnail request */
  file = fmb_list_model_get_file (standard_view->model, iter);
  if (fmb_file_get_thumb_state (file) == FMB_FILE_THUMB_STATE_UNKNOWN)
    {
      fmb_standard_view_cancel_thumbnailing (standard_view);
      fmb_thumbnailer_queue_file (standard_view->priv->thumbnailer, file,
...
static void
fmb_standard_view_select_after_row_deleted (FmbListModel    *model,
                                               GtkTreePath        *path,
                                               FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_LIST_MODEL (model));
   ...
   * path is set by fmb_standard_view_row_deleted() if this is the case */
  if (G_LIKELY (standard_view->priv->selection_before_delete != NULL))
    {
      ...
      (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->select_path) (standard_view, standard_view->priv->selection_before_delete);

      /* place the cursor on the selected path */
      (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->set_cursor) (standard_view, standard_view->priv->selection_before_delete, FALSE);
...
static void
fmb_standard_view_error (FmbListModel    *model,
                            const GError       *error,
                            FmbStandardView *standard_view)
{
  FmbFile *file;
...
static void
fmb_standard_view_sort_column_changed (GtkTreeSortable    *tree_sortable,
                                          FmbStandardView *standard_view)
{
  GtkSortType      sort_order;
  gint             sort_column;

  _fmb_return_if_fail (GTK_IS_TREE_SORTABLE (tree_sortable));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
...
static void
fmb_standard_view_loading_unbound (gpointer user_data)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (user_data);
...
static gboolean
fmb_standard_view_drag_scroll_timer (gpointer user_data)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (user_data);
  GtkAdjustment      *adjustment;
  gfloat              value;
...
static void
fmb_standard_view_drag_scroll_timer_destroy (gpointer user_data)
{
  FMB_STANDARD_VIEW (user_data)->priv->drag_scroll_timer_id = 0;
}



static gboolean
fmb_standard_view_drag_timer (gpointer user_data)
{
  FmbStandardView *standard_view = FMB_STANDARD_VIEW (user_data);

  /* fire up the context menu */
  GDK_THREADS_ENTER ();
  fmb_standard_view_context_menu (standard_view, 3, gtk_get_current_event_time ());
  GDK_THREADS_LEAVE ();
...
static void
fmb_standard_view_drag_timer_destroy (gpointer user_data)
{
  /* unregister the motion notify and button release event handlers (thread-safe) */
  g_signal_handlers_disconnect_by_func (GTK_BIN (user_data)->child, fmb_standard_view_button_release_event, user_data);
  g_signal_handlers_disconnect_by_func (GTK_BIN (user_data)->child, fmb_standard_view_motion_notify_event, user_data);

  /* reset the drag timer source id */
  FMB_STANDARD_VIEW (user_data)->priv->drag_timer_id = 0;
}



static void
fmb_standard_view_finished_thumbnailing (FmbThumbnailer  *thumbnailer,
                                            guint               request,
                                            FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
...
static void
fmb_standard_view_thumbnailing_destroyed (gpointer data)
{
  FmbStandardView *standard_view = data;
...
static void
fmb_standard_view_cancel_thumbnailing (FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  if (standard_view->priv->thumbnail_request > 0)
    {
      /* cancel the request */
      fmb_thumbnailer_dequeue (standard_view->priv->thumbnailer,
                                  standard_view->priv->thumbnail_request);
      standard_view->priv->thumbnail_request = 0;
    }
}
...
static void
fmb_standard_view_schedule_thumbnail_timeout (FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  standard_view->priv->thumbnail_source_id =
    g_timeout_add_full (G_PRIORITY_DEFAULT, 175, fmb_standard_view_request_thumbnails_lazy,
                        standard_view, fmb_standard_view_thumbnailing_destroyed);
}



static void
fmb_standard_view_schedule_thumbnail_idle (FmbStandardView *standard_view)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  ...
  g_assert (standard_view->priv->thumbnail_source_id == 0);
  standard_view->priv->thumbnail_source_id =
    g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, fmb_standard_view_request_thumbnails,
                     standard_view, fmb_standard_view_thumbnailing_destroyed);
}
...
static gboolean
fmb_standard_view_request_thumbnails_real (FmbStandardView *standard_view,
                                              gboolean            lazy_request)
{
  ...
  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), FALSE);
  _fmb_return_val_if_fail (FMB_IS_ICON_FACTORY (standard_view->icon_factory), FALSE);
  ...
  if ((*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_visible_range) (standard_view,
                                                                            &start_path,
                                                                            &end_path))
    {
      ...
      /* queue a thumbnail request */
      fmb_thumbnailer_queue_files (standard_view->priv->thumbnailer,
...
static gboolean
fmb_standard_view_request_thumbnails (gpointer data)
{
  return fmb_standard_view_request_thumbnails_real (data, FALSE);
}



static gboolean
fmb_standard_view_request_thumbnails_lazy (gpointer data)
{
  return fmb_standard_view_request_thumbnails_real (data, TRUE);
}



static void
fmb_standard_view_thumbnail_mode_toggled (FmbStandardView *standard_view,
                                             GParamSpec         *pspec,
                                             FmbIconFactory  *icon_factory)
{
  GtkAdjustment *vadjustment;
  ...
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (FMB_IS_ICON_FACTORY (icon_factory));
  _fmb_return_if_fail (standard_view->icon_factory == icon_factory);

  /* check whether the user wants us to generate thumbnails */
  if (fmb_icon_factory_get_show_thumbnail (icon_factory,
                                              standard_view->priv->current_directory))
    {
      ...
      fmb_standard_view_scrolled (vadjustment, standard_view);
    }
  else
    {
...
static void
fmb_standard_view_scrolled (GtkAdjustment      *adjustment,
                               FmbStandardView *standard_view)
{
  _fmb_return_if_fail (GTK_IS_ADJUSTMENT (adjustment));
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
...
static void
fmb_standard_view_size_allocate (FmbStandardView *standard_view,
                                    GtkAllocation      *allocation)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
...
/**
 * fmb_standard_view_context_menu:
 * @standard_view : a #FmbStandardView instance.
 ...
 **/
void
fmb_standard_view_context_menu (FmbStandardView *standard_view,
                                   guint               button,
                                   guint32             timestamp)
{
  GtkWidget *menu;
  ...
  selected_items = (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_selected_items) (standard_view);
  fmb_standard_view_merge_custom_actions (standard_view, selected_items);
  g_list_free_full (selected_items, (GDestroyNotify) gtk_tree_path_free);
  ...
  fmb_gtk_menu_run (GTK_MENU (menu), GTK_WIDGET (standard_view), NULL, NULL, button, timestamp);
 ...
 **/
void
fmb_standard_view_queue_popup (FmbStandardView *standard_view,
                                  GdkEventButton     *event)
{
  ...
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (event != NULL);
  ...
  if (G_LIKELY (standard_view->priv->drag_timer_id == 0))
    {
      ...
      /* schedule the timer */
      standard_view->priv->drag_timer_id = g_timeout_add_full (G_PRIORITY_LOW, MAX (225, delay), fmb_standard_view_drag_timer,
                                                               standard_view, fmb_standard_view_drag_timer_destroy);

      /* register the motion notify and the button release events on the real view */
      g_signal_connect (G_OBJECT (view), "button-release-event", G_CALLBACK (fmb_standard_view_button_release_event), standard_view);
      g_signal_connect (G_OBJECT (view), "motion-notify-event", G_CALLBACK (fmb_standard_view_motion_notify_event), standard_view);
    }
}
...
/**
 * fmb_standard_view_selection_changed:
 * @standard_view : a #FmbStandardView instance.
 *
 ...
 **/
void
fmb_standard_view_selection_changed (FmbStandardView *standard_view)
{
  GtkTreeIter iter;
  FmbFile *current_directory;
  ...
  /* determine the new list of selected files (replacing GtkTreePath's with FmbFile's) */
  selected_files = (*FMB_STANDARD_VIEW_GET_CLASS (standard_view)->get_selected_items) (standard_view);
  ...
  for (lp = selected_files; lp != NULL; lp = lp->next, ++n_selected_files)
    {
      ...
      lp->data = fmb_list_model_get_file (standard_view->model, &iter);

      /* enable "Restore" if we have only trashed files (atleast one file) */
      if (!fmb_file_is_trashed (lp->data))
        restorable = FALSE;
    }
  ...
  current_directory = fmb_navigator_get_current_directory (FMB_NAVIGATOR (standard_view));
  writable = (current_directory != NULL && fmb_file_is_writable (current_directory));
  trashed = (current_directory != NULL && fmb_file_is_trashed (current_directory));

  /* check whether the clipboard contains data that can be pasted here */
  pastable = (standard_view->clipboard != NULL && fmb_clipboard_manager_get_can_paste (standard_view->clipboard));

  /* check whether the only selected file is
   * folder to which we can paste to */
  can_paste_into_folder = (n_selected_files == 1)
                       && fmb_file_is_directory (selected_files->data)
                       && fmb_file_is_writable (selected_files->data);
  ...
  g_object_set (G_OBJECT (standard_view->priv->action_move_to_trash),
                "sensitive", (n_selected_files > 0) && writable,
                "visible", !trashed && fmb_g_vfs_is_uri_scheme_supported ("trash"),
...
void
fmb_standard_view_set_history (FmbStandardView *standard_view,
                                  FmbHistory      *history)
{
  _fmb_return_if_fail (FMB_IS_STANDARD_VIEW (standard_view));
  _fmb_return_if_fail (history == NULL || FMB_IS_HISTORY (history));
  ...
  /* connect callback */
  g_signal_connect_swapped (G_OBJECT (history), "change-directory", G_CALLBACK (fmb_navigator_change_directory), standard_view);
...
FmbHistory *
fmb_standard_view_copy_history (FmbStandardView *standard_view)
{
  _fmb_return_val_if_fail (FMB_IS_STANDARD_VIEW (standard_view), NULL);

  return fmb_history_copy (standard_view->priv->history, NULL);
}
